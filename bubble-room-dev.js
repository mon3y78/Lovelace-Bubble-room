      ...
      <div class="card" style="height: ${t.cardHeight};">
        <div class="grid-container">
          ...
          <div class="icon-area">
            <div class="bubble-icon-container"
              ...
              <ha-icon class="bubble-icon"
                       icon="${s}"
                       style="color: ${c}; --mdc-icon-size: ${t.iconSize}; width: ${t.iconSize}; height: ${t.iconSize};">
              </ha-icon>
            </div>
  
            <!-- Mushroom templates -->
            <div class="mushroom-container">
              ${d.map(((e,n)=>{if(!e)return i``;const o=t.mushroomPositions[n]||this._defaultMushroomStyle(n),s="on"===(a.states[e.entity]?.state||"off")?e.icon_color?.on||"orange":e.icon_color?.off||"#80808055";return i`
          ...
          <div class="bubble-sub-button-container">
            ${p.map((e=>{if(!e)return i``;const o="on"===(a.states[e.entity]?.state||"off")?n.active:n.inactive;return i`
                <div class="bubble-sub-button"
                     style="background-color: ${o}; padding: ${t.subButtonPadding};"
                     @pointerdown="${t=>this._startHold(t,e)}"
                     @pointerup="${t=>this._endHold(t,e,(()=>this._handleSubButtonTap(e)))}"
                     @pointerleave="${t=>this._cancelHold(t)}">
                  <ha-icon icon="${e.icon}"
                           style="--mdc-icon-size: ${t.mushroomSize}; width: ${t.mushroomSize}; height: ${t.mushroomSize};">
                  </ha-icon>
                </div>
              `}))}
          </div>
