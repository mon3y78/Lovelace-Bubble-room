...
class ot extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const n=i?.renderBefore??e;let o=n._$litPart$;if(void 0===o){const t=i?.renderBefore??null;n._$litPart$=o=new G(e.insertBefore(T(),t),t,void 0,i??{})}return o._$AI(t),o})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return D}}ot._$litElement$=!0,ot.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:ot});const st=globalThis.litElementPolyfillSupport;st?.({LitElement:ot}),(globalThis.litElementVersions??=[]).push("4.1.1");var rt=function(t){if(t){var e=function(t){return[].slice.call(t)},i=3,n=[],o=null,s="requestAnimationFrame"in t?function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{sync:!1};t.cancelAnimationFrame(o);var i=function(){return a(n.filter((function(t){return t.dirty&&t.active})))};if(e.sync)return i();o=t.requestAnimationFrame(i)}:function(){},r=function(t){return function(e){n.forEach((function(e){return e.dirty=t})),s(e)}},a=function(t){t.filter((function(t){return!t.styleComputed})).forEach((function(t){t.styleComputed=h(t)})),t.filter(d).forEach(p);var e=t.filter(u);e.forEach(l),e.forEach((function(t){p(t),c(t)})),e.forEach(m)},c=function(t){return t.dirty=0},l=function(t){t.availableWidth=t.element.parentNode.clientWidth,t.currentWidth=t.element.scrollWidth,t.previousFontSize=t.currentFontSize,t.currentFontSize=Math.min(Math.max(t.minSize,t.availableWidth/t.currentWidth*t.previousFontSize),t.maxSize),t.whiteSpace=t.multiLine&&t.currentFontSize===t.minSize?"normal":"nowrap"},u=function(t){return 2!==t.dirty||2===t.dirty&&t.element.parentNode.clientWidth!==t.availableWidth},h=function(e){var i=t.getComputedStyle(e.element,null);return e.currentFontSize=parseFloat(i.getPropertyValue("font-size")),e.display=i.getPropertyValue("display"),e.whiteSpace=i.getPropertyValue("white-space"),!0},d=function(t){var e=!1;return!t.preStyleTestCompleted&&(/inline-/.test(t.display)||(e=!0,t.display="inline-block"),"nowrap"!==t.whiteSpace&&(e=!0,t.whiteSpace="nowrap"),t.preStyleTestCompleted=!0,e)},p=function(t){t.element.style.whiteSpace=t.whiteSpace,t.element.style.display=t.display,t.element.style.fontSize=t.currentFontSize+"px"},m=function(t){t.element.dispatchEvent(new CustomEvent("fit",{detail:{oldValue:t.previousFontSize,newValue:t.currentFontSize,scaleFactor:t.currentFontSize/t.previousFontSize}}))},g=function(t,e){return function(i){t.dirty=e,t.active&&s(i)}},_=function(t){return function(){n=n.filter((function(e){return e.element!==t.element})),t.observeMutations&&t.observer.disconnect(),t.element.style.whiteSpace=t.originalStyle.whiteSpace,t.element.style.display=t.originalStyle.display,t.element.style.fontSize=t.originalStyle.fontSize}},v=function(t){return function(){t.active||(t.active=!0,s())}},f=function(t){return function(){return t.active=!1}},b=function(t){t.observeMutations&&(t.observer=new MutationObserver(g(t,1)),t.observer.observe(t.element,t.observeMutations))},y={minSize:16,maxSize:512,multiLine:!0,observeMutations:"MutationObserver"in t&&{subtree:!0,childList:!0,characterData:!0}},$=null,S=function(){t.clearTimeout($),$=t.setTimeout(r(2),E.observeWindowDelay)},A=["resize","orientationchange"];return Object.defineProperty(E,"observeWindow",{set:function(e){var i="".concat(e?"add":"remove","EventListener");A.forEach((function(e){t[i](e,S)}))}}),E.observeWindow=!0,E.observeWindowDelay=100,E.fitAll=r(i),E}function w(t,e){var o=Object.assign({},y,e),r=t.map((function(t){var e=Object.assign({},o,{element:t,active:!0});return function(t){t.originalStyle={whiteSpace:t.element.style.whiteSpace,display:t.element.style.display,fontSize:t.element.style.fontSize},b(t),t.newbie=!0,t.dirty=!0,n.push(t)}(e),{element:t,fit:g(e,i),unfreeze:v(e),freeze:f(e),unsubscribe:_(e)}}));return s(),r}function E(t){var i=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return"string"==typeof t?w(e(document.querySelectorAll(t)),i):w([t],i)[0]}}("undefined"==typeof window?null:window);customElements.define("bubble-room",class extends ot{static get properties(){return{config:{type:Object},hass:{type:Object}}}firstUpdated(){const t=this.shadowRoot.querySelectorAll(".mushroom-primary");if(!t.length)return;rt(t,{maxSize:20,multiLine:!1}).forEach((t=>t.unsubscribe()))}static async getConfigElement(){return await Promise.resolve().then((function(){return at})),document.createElement("bubble-room-editor")}static getStubConfig(){return{entities:{presence:{entity:"binary_sensor.aqara_fp1_presence"},"sub-button1":{entity:"light.luce_ventola",icon:"",tap_action:{action:"toggle"},hold_action:{action:"more-info"}},"sub-button2":{entity:"fan.sonoff_1000f6e5c7",icon:"",tap_action:{action:"toggle"},hold_action:{action:"more-info"}},"sub-button3":{entity:"media_player.google_nest_1",icon:"",tap_action:{action:"toggle"},hold_action:{action:"more-info"}},"sub-button4":{entity:"vacuum.slider",icon:"",tap_action:{action:"toggle"},hold_action:{action:"more-info"}},climate:{entity:"climate.termostato_salotto",icon:"",tap_action:{action:"more-info"}},camera:{entity:"camera.front_door",icon:"",tap_action:{action:"more-info"},preview_url:""},entities1:{entity:"sensor.some_sensor1",icon:""},entities2:{entity:"sensor.some_sensor2",icon:""},entities3:{entity:"sensor.some_sensor3",icon:""},entities4:{entity:"sensor.some_sensor4",icon:""},entities5:{entity:"sensor.some_sensor5",icon:""},temperature:{temperature_sensor:"sensor.vindstyrka_salotto_temperature",humidity_sensor:"sensor.vindstyrka_salotto_humidity",tap_action:{action:"more-info"}}},colors:{active:"var(--primary-color)",inactive:"color-mix(in srgb, var(--primary-color) 40%, transparent)",backgroundActive:"color-mix(in srgb, var(--primary-color) 20%, transparent)",backgroundInactive:"color-mix(in srgb, var(--primary-color) 10%, transparent)"},icon:"",name:"Salotto",tap_action:{action:"navigate",navigation_path:"/lovelace/sala"}}}_getFallbackIcon(t,e){if((e="string"==typeof e?e:"").trim())return e;if(this.hass?.entities?.[t]?.icon)return this.hass.entities[t].icon;const i=this.hass?.states?.[t];if(i?.attributes?.icon)return i.attributes.icon;if(i?.attributes?.device_class)return this._getDeviceClassIcon(i.attributes.device_class,i.state);if(!t||"string"!=typeof t)return"";const n=t.split(".")[0];return this._getDomainDefaultIcon(n,i?.state)}_getDeviceClassIcon(t,e){switch(t){case"door":return"on"===e?"mdi:door-open":"mdi:door-closed";case"window":return"on"===e?"mdi:window-open":"mdi:window-closed";case"motion":return"on"===e?"mdi:motion-sensor":"mdi:motion-sensor-off";case"moisture":return"on"===e?"mdi:water-alert":"mdi:water-off";case"smoke":return"on"===e?"mdi:smoke":"mdi:smoke-detector-off";case"gas":return"on"===e?"mdi:gas-cylinder":"mdi:gas-off";case"problem":return"mdi:alert";case"connectivity":return"mdi:connection";case"occupancy":case"presence":return"on"===e?"mdi:account-voice":"mdi:account-voice-off";case"tamper":return"mdi:lock-open-alert";case"vibration":return"on"===e?"mdi:vibrate":"mdi:vibrate-off";case"running":return"on"===e?"mdi:server-network":"mdi:server-network-off";case"shutter":return"on"===e?"mdi:window-shutter-open":"mdi:window-shutter";case"blind":return"on"===e?"mdi:blinds-horizontal":"mdi:blinds-horizontal-closed";default:return""}}_getDomainDefaultIcon(t,e){switch(t){case"light":return"mdi:lightbulb";case"switch":case"input_boolean":return"mdi:toggle-switch";case"fan":return"mdi:fan";case"climate":return"mdi:thermostat";case"media_player":return"mdi:speaker";case"vacuum":return"mdi:robot-vacuum";case"binary_sensor":return"on"===e?"mdi:motion-sensor":"mdi:motion-sensor-off";case"sensor":return"mdi:information-outline";case"cover":return"open"===e?"mdi:blinds-open":"mdi:blinds-closed";case"lock":return"locked"===e?"mdi:lock":"mdi:lock-open";case"door":return"open"===e?"mdi:door-open":"mdi:door-closed";case"window":return"open"===e?"mdi:window-open":"mdi:window-closed";default:return""}}_renderMushroom(t,e,i){const n=this._defaultMushroomStyle(e);if(t.temperature_sensor||t.humidity_sensor){const e=this._buildTemperatureText(t);return B`
    ...
    `}_buildTemperatureText(t){const e=this.hass,i=t.temperature_sensor?e.states[t.temperature_sensor]?.state:null,n=t.humidity_sensor?e.states[t.humidity_sensor]?.state:null;let o="";if(null!=i&&""!==i){o+=`🌡️${i}°${this.config.entities.temperature.unit||"C"}`}return null!=n&&""!==n&&(o+=(o?" ":"")+`💦${n}%`),o}setConfig(t){if(!t)throw new Error("Configurazione mancante");if("object"!=typeof(t=JSON.parse(JSON.stringify(t)))||Array.isArray(t))throw new Error("La configurazione deve essere un oggetto valido.");if(!t.entities||"object"!=typeof t.entities)throw new Error("Devi definire almeno la proprietà 'entities' nella configurazione.");const e=["presence","sub-button1","sub-button2","sub-button3","sub-button4","entities1","entities2","entities3","entities4","entities5","climate","camera","temperature"],i={tap_action:{action:"toggle"},hold_action:{action:"more-info"}},n={};for(const o in t.entities){let s=t.entities[o];if(s){if(["entities1","entities2","entities3","entities4","entities5"].includes(o)&&"object"==typeof s){const t={},e=Object.keys(s).filter((t=>/^\d+$/.test(t)));Object.entries(s).forEach((([e,i])=>{/^\d+$/.test(e)||(t[e]=i)})),e.length&&(t.entity=e.sort(((t,e)=>t-e)).map((t=>s[t])).join("")),s=t}if("climate"===o&&"string"==typeof s&&(s={entity:s,...i}),"string"==typeof s)n[o]=e.includes(o)?"presence"===o?{entity:s}:{entity:s,...i}:s;else if("object"==typeof s)if(e.includes(o)){if(!s.style&&o.startsWith("entities")){const t=Number(o.replace("entities",""))-1;s.style=this._defaultMushroomStyle(t)}n[o]="presence"===o?{...s}:{...i,...s}}else n[o]=s}}const o=t.colors||{};this.config={entities:n,colors:{active:o.active??"var(--primary-color)",inactive:o.inactive??"var(--primary-color-faded)",backgroundActive:o.backgroundActive??"color-mix(in srgb, var(--primary-color) 85%, transparent)",backgroundInactive:o.backgroundInactive??"color-mix(in srgb, var(--primary-color) 15%, transparent)"},icon:t.icon||"",name:t.name||"Salotto",tap_action:t.tap_action||{action:"navigate",navigation_path:""}},this.config.entities.temperature&&!this.config.entities.temperature.unit&&(this.config.entities.temperature.unit="C"),!this.config.entity&&this.config.entities.presence&&(this.config.entity=this.config.entities.presence.entity)}getConfig(){if(!this.config)return{};const t=JSON.parse(JSON.stringify(this.config)),e={};return Object.entries(t.entities).forEach((([t,i])=>{i&&(t.startsWith("sub-button")||i.entity&&i.entity.trim())&&(e[t]=i)})),t.entities=e,t}static get styles(){return s`
    ...
    `}_defaultMushroomStyle(t){switch(t){case 0:return"top: -77px; left: 0px;";case 1:return"top: -85px; left: 38px;";case 2:return"top: -64px; left: 77px;";case 3:return"bottom: 39px; left: 96px;";case 4:return"bottom: -1px; left: 85px;";case 5:return"bottom: -2px; left: -2px;";case 6:return"top: -140px; left: 5px;";case 7:return"top: -95px; right: 5px;";default:return""}}_startHold(t,e){t.stopPropagation(),this._holdTriggered=!1,this._holdTimeout=setTimeout((()=>{this._holdTriggered=!0,this._handleHoldAction(e)}),500)}_endHold(t,e,i){t.stopPropagation(),clearTimeout(this._holdTimeout),this._holdTriggered||i(),this._holdTriggered=!1}_cancelHold(){clearTimeout(this._holdTimeout),this._holdTriggered=!1}_handleHoldAction(t){if(!t?.hold_action)return void this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:t.entity},bubbles:!0,composed:!0}));const{action:e,service:i,service_data:n,navigation_path:o}=t.hold_action;switch(e){case"more-info":this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:t.entity},bubbles:!0,composed:!0}));break;case"toggle":this._toggleEntity(t.entity);break;case"call-service":if(i){const[e,o]=i.split("."),s={...n,entity_id:n?.entity_id||t.entity};this.hass.callService(e,o,s)}break;case"navigate":o&&(window.history.pushState({},"",o),window.dispatchEvent(new Event("location-changed")))}}_handleMainIconTap(){if(!this.config?.tap_action)return;const{action:t,service:e,service_data:i,navigation_path:n}=this.config.tap_action;switch(t){case"toggle":this.config.entity&&this._toggleEntity(this.config.entity);break;case"more-info":this.config.entity&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:this.config.entity},bubbles:!0,composed:!0}));break;case"call-service":if(e){const[t,n]=e.split("."),o={...i,entity_id:i?.entity_id||this.config.entity};this.hass.callService(t,n,o)}break;case"navigate":n&&(window.history.pushState({},"",n),window.dispatchEvent(new Event("location-changed")))}}_toggleEntity(t){this.hass&&t&&this.hass.callService("homeassistant","toggle",{entity_id:t})}_handleSubButtonTap(t){if(!t?.tap_action)return;const{action:e,service:i,service_data:n,navigation_path:o}=t.tap_action;switch(e){case"toggle":t.entity&&this._toggleEntity(t.entity);break;case"more-info":t.entity&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:t.entity},bubbles:!0,composed:!0}));break;case"call-service":if(i){const[e,o]=i.split("."),s={...n,entity_id:n?.entity_id||t.entity};this.hass.callService(e,o,s)}break;case"navigate":o&&(window.history.pushState({},"",o),window.dispatchEvent(new Event("location-changed")))}}_handleMushroomTap(t){this._handleSubButtonTap(t)}render(){if(!this.config||!this.hass)return B`<div>Loading…</div>`;const{entities:t,name:e,icon:i,background:n,border_radius:o}=this.config,s=this.config.colors,r=this.hass,a=t.presence?.entity&&"on"===r.states[t.presence.entity]?.state,c=s.active,l=s.inactive,u=s.backgroundActive,h=s.backgroundInactive,d=a?c:l,p=[n?`--bubble-room-background: ${n}`:"",o?`--bubble-room-border-radius: ${o}`:"",`--bubble-room-icon-bg: ${a?u:h}`,`--bubble-room-icon-color: ${d}`,`--bubble-room-name-color: ${d}`].filter((t=>t)).join(";"),m=i?.trim()?i:t.presence?.entity?this._getFallbackIcon(t.presence.entity):"",g=[t["sub-button1"],t["sub-button2"],t["sub-button3"],t["sub-button4"]].filter((t=>t&&t.entity)),_=["entities1","entities2","entities3","entities4","entities5","climate","temperature","camera"].map(((e,i)=>{const n=t[e];if(!n)return{item:null,idx:i,color:null};if(n.temperature_sensor||n.humidity_sensor)return{item:n,idx:i,color:d};const o=n.entity;if(!o)return{item:null,idx:i,color:null};return{item:n,idx:i,color:"on"===r.states[o]?.state?c:l}}));return B`
      <ha-card style="${p}">
        <div class="card">
          <div class="grid-container">
            <div class="name-area" style="color: ${d};">${e}</div>
            <div class="icon-area">
              <div class="bubble-icon-container"
                   @pointerdown=${t=>this._startHold(t,this.config)}
                   @pointerup=${t=>this._endHold(t,this.config,(()=>this._handleMainIconTap()))}
                   @pointerleave=${()=>this._cancelHold()}>
                ${m?B`<ha-icon class="bubble-icon" icon="${m}" style="color: ${d};"></ha-icon>`:L}
              </div>
              <div class="mushroom-container">
                ${_.map((({item:t,idx:e,color:i})=>t?this._renderMushroom(t,e,i):B`<div class="mushroom-item" style="${this._defaultMushroomStyle(e)}"></div>`))}
              </div>
            </div>
            <div class="bubble-sub-button-container">
              ${g.map((t=>{if(!t.entity)return L;const e="on"===r.states[t.entity]?.state,i=e?this.config.colors.backgroundActive??"color-mix(in srgb, var(--primary-color) 20%, transparent)":this.config.colors.backgroundInactive??"var(--card-background-color)",n=e?this.config.colors.active??"var(--primary-color)":this.config.colors.inactive??"var(--secondary-text-color)",o=this._getFallbackIcon(t.entity,t.icon||"");return B`
    ...
    `}render(){return this._config?B`
      ...
      <datalist id="entity-list">
        ${this.hass?Object.keys(this.hass.entities).map((t=>B`<option value="${t}"></option>`)):""}
      </datalist>
      <datalist id="icon-list">
        ${this._defaultIconList().map((t=>B`<option value="${t}"></option>`))}
      </datalist>

      <p class="note">
        For advanced configurations, modify the YAML directly.
      </p>
    `:B`<div>Caricamento configurazione...</div>`}_renderMushroomEntityPanel(t,e){const i=`${t}Panel`;return B`
      <ha-expansion-panel id="${i}">
        <div slot="header" @click="${()=>this._togglePanel(i)}">
          ${e}
        </div>
    ...
    `}_renderEntityInput(t,e,i="entity"){const n=this._config.entities&&this._config.entities[e]&&this._config.entities[e][i]||"";return B`
      <label>${t}:</label>
      <input
        type="text"
        .value="${n}"
      ...
      />
    `}_renderIconInput(t,e,i="icon"){let n=this._config.entities&&this._config.entities[e]&&this._config.entities[e][i]||"";if(!n&&this.hass&&this._config.entities&&this._config.entities[e]?.entity){const t=this._config.entities[e].entity;n=this.hass.states[t]?.attributes?.icon||""}return B`
      <label>${t}:</label>
      <input
        type="text"
        .value="${n}"
        ...
        @input="${this._updateEntity(e,i)}"
      />
    `}_renderRoomAction(){const t=this._config.tap_action||{action:"navigate",navigation_path:""},e=this._config.hold_action||{action:"more-info",navigation_path:""};return B`
      <div class="input-group">
        <label>Tap:</label>
    ...
    `}_renderSubButtonAction(t){const e=this._config.entities[t]?.tap_action||{action:"toggle",navigation_path:""},i=this._config.entities[t]?.hold_action||{action:"more-info",navigation_path:""};return B`
      <div class="input-group">
        <label>Tap:</label>
