          ...
          <div class="grid-container">
            ...
            <div class="icon-area">
              <div class="bubble-icon-container"
                   ...
                   @pointerleave=${()=>this._cancelHold()}>
                ${g?D`<ha-icon class="bubble-icon" icon="${g}" style="color: ${u};"></ha-icon>`:L}
              </div>
            ...
            <div class="bubble-sub-button-container">
              ${m.map((t=>{const e="on"===a.states[t.entity]?.state,i=e?this.config.colors.backgroundActive??"rgba(var(--rgb-primary-color),0.1)":this.config.colors.backgroundInactive??"var(--divider-color, rgba(0,0,0,0.12))",n=e?this.config.colors.active??"var(--primary-color)":this.config.colors.inactive??"var(--secondary-text-color)",o=this._getFallbackIcon(t.entity);return D`
