...
var te,ie;class oe extends g{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return null!==(e=(t=this.renderOptions).renderBefore)&&void 0!==e||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,i)=>{var o,s;const n=null!==(o=null==i?void 0:i.renderBefore)&&void 0!==o?o:t;let a=n._$litPart$;if(void 0===a){const e=null!==(s=null==i?void 0:i.renderBefore)&&void 0!==s?s:null;n._$litPart$=a=new J(t.insertBefore(S(),e),e,void 0,null!=i?i:{})}return a._$AI(e),a})(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),null===(e=this._$Do)||void 0===e||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._$Do)||void 0===e||e.setConnected(!1)}render(){return T}}oe.finalized=!0,oe._$litElement$=!0,null===(te=globalThis.litElementHydrateSupport)||void 0===te||te.call(globalThis,{LitElement:oe});const se=globalThis.litElementPolyfillSupport;null==se||se({LitElement:oe}),(null!==(ie=globalThis.litElementVersions)&&void 0!==ie?ie:globalThis.litElementVersions=[]).push("3.3.3");const ne={alarm_control_panel:"Alarms",binary_sensor:"Binary Sensors",camera:"Cameras",climate:"Climate",cover:"Covers",fan:"Fan",light:"Light",lock:"Lock",media_player:"Media Player",scene:"Scenes",script:"Scripts",siren:"Siren",vacuum:"Vacuum",motion:"Motion",occupancy:"Occupancy",presence:"Presence",moving:"Moving",door:"Door",window:"Window",opening:"Opening",garage_door:"Garage Door",vibration:"Vibration",sound:"Sound",moisture:"Moisture/Leak",water:"Water/Leak",smoke:"Smoke",gas:"Gas",carbon_monoxide:"Carbon Monoxide",cold:"Cold",heat:"Heat",light_level:"Light Level",connectivity:"Connectivity",lock_dc:"Lock (status)",plug:"Plug",power:"Power",problem:"Problem",running:"Running",safety:"Safety",tamper:"Tamper",update:"Update",switch:"Switch",input_boolean:"Boolean Switch"},ae=["alarm_control_panel","binary_sensor","camera","climate","cover","fan","input_boolean","light","lock","media_player","scene","script","siren","switch","vacuum"],re=["motion","occupancy","presence","moving","door","window","opening","garage_door","vibration","sound","moisture","water","smoke","gas","carbon_monoxide","cold","heat","light_level","connectivity","plug","power","problem","running","safety","tamper","update"],le=(e=[])=>({includeDomains:ae,entityFilter:(t,i)=>{if(!e.length)return!1;const[o]=t.split(".");if("binary_sensor"===o){const o=i.states[t]?.attributes?.device_class??"";return e.includes(o)}return e.includes(o)}}),ce=(e=[])=>({includeDomains:["sensor"],entityFilter:(t,i)=>{if(!e.length)return!0;const o=i.states[t]?.attributes?.device_class??"";return e.includes(o)}}),de=(e=[])=>({includeDomains:ae,entityFilter:(t,i)=>{if(!e.length)return"binary_sensor"===t.split(".")[0];const[o]=t.split(".");if("binary_sensor"===o){const o=i.states[t]?.attributes?.device_class??"";return e.includes(o)}return e.includes(o)}}),ue=(e=[])=>({includeDomains:ae,entityFilter:(t,i)=>{const[o]=t.split(".");if(!e.length)return ae.includes(o);if("binary_sensor"===o){const o=i.states[t]?.attributes?.device_class??"";return e.includes(o)}return e.includes(o)}}),pe=(e=[])=>({includeDomains:["camera"],entityFilter:(t,i)=>{if(!e.length)return!0;const o=i.states[t]?.attributes?.device_class??"";return e.includes(o)}}),he=(e=[])=>({includeDomains:["climate"],entityFilter:(e,t)=>!0});function be(e){return"string"==typeof e&&e.trim().length>0}function me(e,t,i){if(!be(i))return!0;const o=function(e){if(!e)return{};if(!Array.isArray(e))return e;const t={};for(const i of e){const e=i?.entity_id||i?.id;e&&(t[e]=i)}return t}(e?.entities),s=function(e){if(!e)return{};if(!Array.isArray(e))return e;const t={};for(const i of e){const e=i?.id||i?.device_id;e&&(t[e]=i)}return t}(e?.devices),n=o[t];if(n?.area_id===i)return!0;const a=n?.device_id||n?.deviceId;if(a&&s[a]?.area_id===i)return!0;const r=e?.states?.[t]?.attributes?.area_id;return r===i}function ge(e,t,i,o=[]){if(!e?.states)return[];let s;if("presence"===i?s=le(o):"sensor"===i?s=ce(o):"mushroom"===i?s=de(o):"subbutton"===i?s=ue(o):"camera"===i?s=pe(o):"climate"===i&&(s=he(o)),!s)return[];const n=Object.keys(e.states).filter(e=>s.includeDomains.includes(e.split(".")[0])).filter(t=>s.entityFilter(t,e));let a=n;const r="string"==typeof t?.area_id?t.area_id:t?.area;if(be(r)){const t=function(e,t){return e?.states&&be(t)?Object.keys(e.states).filter(i=>me(e,i,t)):[]}(e,r),i=n.filter(e=>t.includes(e));i.length&&(a=i)}const l=function(e){const t=new Set,i=e=>{e&&("string"==typeof e&&e.includes(".")?t.add(e):Array.isArray(e)?e.forEach(i):"object"==typeof e&&Object.values(e).forEach(i))};return i(e),Array.from(t)}("subbutton"===i?t?.subbuttons:t?.entities?.[i]);return function(e,t){const i=Array.from(new Set(e)),o=Array.isArray(t)?t:t?[t]:[];for(let e=o.length-1;e>=0;e--){const t=o[e];t&&!i.includes(t)&&i.unshift(t)}return i}(a,l)}const fe=!!window.__BUBBLE_DEBUG__;function _e(e,t,i,o=!1){if(!e||!t)return t;const s=t.auto_discovery_sections||{},n="area"===i,a=i&&String(i).startsWith("auto_discovery_sections.");return(o||fe)&&"undefined"!=typeof window&&console.info("[AutoDiscovery] (no-op) after",i,{sections:s,isAreaChange:n,isADChange:a}),t}const ve=new Map,ye="mdi:bookmark",xe={light:"mdi:lightbulb",switch:"mdi:toggle-switch",fan:"mdi:fan",climate:"mdi:thermostat",media_player:"mdi:play-circle",script:"mdi:script-text",scene:"mdi:palette",lock:"mdi:lock",camera:"mdi:video",binary_sensor:"mdi:checkbox-marked-circle-outline",sensor:"mdi:eye",alarm_control_panel:"mdi:shield-home",vacuum:"mdi:robot-vacuum",siren:"mdi:bullhorn",input_boolean:"mdi:toggle-switch",humidifier:"mdi:air-humidifier"},$e={door:{on:"mdi:door-open",off:"mdi:door-closed"},window:{on:"mdi:window-open",off:"mdi:window-closed"},motion:{on:"mdi:motion-sensor",off:"mdi:motion-sensor-off"},moisture:{on:"mdi:water-alert",off:"mdi:water-off"},smoke:{on:"mdi:smoke",off:"mdi:smoke-detector-off"},gas:{on:"mdi:gas-cylinder",off:"mdi:gas-off"},lock:{on:"mdi:lock-open-variant",off:"mdi:lock"},garage:{on:"mdi:garage-open",off:"mdi:garage"},light:{on:"mdi:lightbulb-on",off:"mdi:lightbulb-off"},plug:{on:"mdi:power-plug",off:"mdi:power-plug-off"},presence:{on:"mdi:account",off:"mdi:account-off"},vibration:{on:"mdi:vibrate",off:"mdi:vibrate-off"},opening:{on:"mdi:door-open",off:"mdi:door-closed"},battery:{on:"mdi:battery",off:"mdi:battery-outline"},connectivity:{on:"mdi:wifi",off:"mdi:wifi-off"},safety:{on:"mdi:shield-check",off:"mdi:shield-off"},cold:{on:"mdi:snowflake",off:"mdi:snowflake-off"},blind:{on:"mdi:blinds-open",off:"mdi:blinds"},curtain:{on:"mdi:curtains-open",off:"mdi:curtains-closed"},shutter:{on:"mdi:window-shutter-open",off:"mdi:window-shutter"},awning:{on:"mdi:awning-open",off:"mdi:awning"},shade:{on:"mdi:blinds-open",off:"mdi:blinds"},gate:{on:"mdi:gate-open",off:"mdi:gate"},damper:{on:"mdi:air-filter",off:"mdi:air-filter-alert"},garage_door:{on:"mdi:garage-open",off:"mdi:garage"},occupancy:{on:"mdi:account-group",off:"mdi:account-off"},running:{on:"mdi:play",off:"mdi:stop"},problem:{on:"mdi:alert",off:"mdi:check-circle"},sound:{on:"mdi:volume-high",off:"mdi:volume-off"},tamper:{on:"mdi:cellphone-alert",off:"mdi:cellphone-check"},update:{on:"mdi:update-alert",off:"mdi:update"},carbon_monoxide:{on:"mdi:cloud-alert",off:"mdi:cloud-check"},heat:{on:"mdi:thermometer-high",off:"mdi:thermometer-low"},moving:{on:"mdi:arrow-up-down-bold",off:"mdi:ray-vertex"},power:{on:"mdi:flash",off:"mdi:flash-off"}};function we(e){return["on","open","unlocked","playing","active"].includes(e)}function ke(e,t){const{entityId:i,hass:o}=function(e,t){return e&&"object"==typeof e&&e.states&&"string"==typeof t?{entityId:t,hass:e}:{entityId:e,hass:t}}(e,t);if(!i)return ye;const s=ve.get(i);if(s)return s;const n=o?.states?.[i],a=n?.attributes||{},r=function(e){return(e||"").split(".")[0]||""}(i),l=n?.state;if(a.icon)return ve.set(i,a.icon),a.icon;const c=a.device_class;if(c&&$e[c]){const e=we(l)?$e[c].on:$e[c].off;return ve.set(i,e),e}const d={light:["mdi:lightbulb-on","mdi:lightbulb-off"],switch:["mdi:toggle-switch","mdi:toggle-switch-off"],fan:["mdi:fan","mdi:fan-off"],lock:["mdi:lock-open-variant","mdi:lock"],media_player:["mdi:play-circle","mdi:stop-circle"],humidifier:["mdi:air-humidifier","mdi:air-humidifier-off"],siren:["mdi:bullhorn-variant","mdi:bullhorn-outline"],vacuum:["mdi:robot-vacuum","mdi:robot-vacuum-off"],input_boolean:["mdi:toggle-switch","mdi:toggle-switch-off"],scene:["mdi:palette","mdi:palette-outline"],script:["mdi:script-text-play-outline","mdi:script-text-outline"],alarm_control_panel:["mdi:shield-lock","mdi:shield-outline"],camera:["mdi:cctv","mdi:cctv-off"]};if(d[r]){const[e,t]=d[r],o=we(l)?e:t;return ve.set(i,o),o}const u=xe[r]||ye;return ve.set(i,u),u}const Ce={_list:null,get(e){if(this._list)return this._list;const t=e?.mdiIcons||null;return this._list=t?Object.keys(t).sort():[],this._list},warm(e){return this.get(e)}},Se={en:{"panel.room.title":"🛋️ Room Settings","panel.room.auto_discover_presence":"🪄 Auto-discover Presence","panel.room.area":"🏷️ Area:","panel.room.name":"🏠 Room name:","panel.room.icon_presence":"🎭 Icon & Presence","panel.room.icon":"Icon:","panel.room.filter_categories":"Filter categories:","panel.room.presence_id":"Presence (ID):","panel.room.tap_action":"Tap Action","panel.room.hold_action":"Hold Action","panel.room.path":"Path","panel.room.service":"Service","panel.room.service_with_example":"Service (e.g. light.turn_on)","panel.room.service_data":"Service Data (JSON)","panel.room.layout":"📐 Layout:","panel.room.layout_tall":"Tall","panel.room.layout_wide":"Wide","panel.room.reset":"🧹 Reset Room","panel.camera.title":"📷 Camera","panel.camera.auto_discover":"🪄 Auto-discover","panel.camera.entity":"Camera (ID):","panel.camera.icon":"Camera Icon:","panel.camera.presence":"Presence/Motion Entity:","panel.camera.reset":"🧹 Reset Camera","panel.climate.title":"🌡️ Climate","panel.climate.auto_discover":"🪄 Auto-discover","panel.climate.entity":"Climate (ID):","panel.climate.icon":"Climate Icon:","panel.climate.reset":"🧹 Reset Climate","panel.sensor.title":"🧭 Sensors","panel.sensor.auto_discover":"🪄 Auto-discover Sensors","panel.sensor.sensor_item":"Sensor {index}","panel.sensor.filter_category":"Filter category:","panel.sensor.clear_filter":"Clear filter category","panel.sensor.clear":"Clear","panel.sensor.entity":"Entity:","panel.sensor.reset":"🧹 Reset Sensors","panel.mushroom.title":"🍄 Mushroom Entities","panel.mushroom.auto_discover":"🪄 Auto-discover Mushroom","panel.mushroom.item":"Mushroom {index}","panel.mushroom.filter_category":"Filter category:","panel.mushroom.clear_filter":"Clear filter category","panel.mushroom.clear":"Clear","panel.mushroom.entity":"Entity:","panel.mushroom.icon":"Icon:","panel.mushroom.tap_action":"Tap Action:","panel.mushroom.hold_action":"Hold Action:","panel.mushroom.path":"Path","panel.mushroom.service_with_example":"Service (e.g. light.turn_on)","panel.mushroom.service_data":"Service Data (JSON)","panel.mushroom.reset":"🧹 Reset Mushrooms","panel.subbutton.title":"🎛️ Sub-buttons","panel.subbutton.auto_discover":"🪄 Auto-discover Subbuttons","panel.subbutton.item":"Sub-button {index}","panel.subbutton.filter_category":"Filter category:","panel.subbutton.clear_filter":"Clear filter category","panel.subbutton.clear":"Clear","panel.subbutton.entity":"Entity:","panel.subbutton.icon":"Icon:","panel.subbutton.tap_action":"Tap Action:","panel.subbutton.hold_action":"Hold Action:","panel.subbutton.path":"Path","panel.subbutton.service":"Service","panel.subbutton.service_data":"Service Data (JSON)","panel.subbutton.reset":"🧹 Reset Sub-buttons","panel.colors.title":"🎨 Colors & Presets","panel.colors.room_section":"Room Colors","panel.colors.subbutton_section":"Subbutton Colors","panel.colors.mushroom_section":"Mushroom Colors","panel.colors.reset":"🧹 Reset Colors","panel.colors.apply_preset":"Apply Preset","panel.colors.on":"On","panel.colors.off":"Off","panel.colors.subbutton_style":"Subbutton Style","panel.colors.style.standard":"Standard (v5.0.6)","panel.colors.style.standard_desc":"Classic look with solid, high-contrast pills.","panel.colors.style.liquid_glass":"Liquid Glass","panel.colors.style.liquid_glass_desc":"Liquid glass effect with soft transparency.","panel.colors.room.background_active":"Background Active","panel.colors.room.background_inactive":"Background Inactive","panel.colors.room.icon_active":"Icon Active","panel.colors.room.icon_inactive":"Icon Inactive","panel.colors.room.text_active":"Text Active","panel.colors.room.text_inactive":"Text Inactive","panel.colors.subbutton.background_on":"Background On","panel.colors.subbutton.background_off":"Background Off","panel.colors.subbutton.icon_on":"Icon On","panel.colors.subbutton.icon_off":"Icon Off","panel.colors.mushroom.active":"Active","panel.colors.mushroom.inactive":"Inactive","actions.toggle":"toggle","actions.more-info":"more-info","actions.navigate":"navigate","actions.call-service":"call-service","actions.none":"none","presets.green":"Green","presets.blue":"Blue","presets.amber":"Amber","presets.purple":"Purple","presets.red":"Red","presets.yellow":"Yellow","presets.teal":"Teal","presets.gray":"Gray"},it:{"panel.room.title":"🛋️ Impostazioni stanza","panel.room.auto_discover_presence":"🪄 Autodiscovery presenza","panel.room.area":"🏷️ Area:","panel.room.name":"🏠 Nome stanza:","panel.room.icon_presence":"🎭 Icona e presenza","panel.room.icon":"Icona:","panel.room.filter_categories":"Categorie filtro:","panel.room.presence_id":"Presenza (ID):","panel.room.tap_action":"Azione tap","panel.room.hold_action":"Azione hold","panel.room.path":"Percorso","panel.room.service":"Servizio","panel.room.service_with_example":"Servizio (es. light.turn_on)","panel.room.service_data":"Dati servizio (JSON)","panel.room.layout":"📐 Layout:","panel.room.layout_tall":"Alto","panel.room.layout_wide":"Largo","panel.room.reset":"🧹 Reset stanza","panel.camera.title":"📷 Camera","panel.camera.auto_discover":"🪄 Autodiscovery","panel.camera.entity":"Camera (ID):","panel.camera.icon":"Icona camera:","panel.camera.presence":"Entità presenza/movimento:","panel.camera.reset":"🧹 Reset camera","panel.climate.title":"🌡️ Clima","panel.climate.auto_discover":"🪄 Autodiscovery","panel.climate.entity":"Clima (ID):","panel.climate.icon":"Icona clima:","panel.climate.reset":"🧹 Reset clima","panel.sensor.title":"🧭 Sensori","panel.sensor.auto_discover":"🪄 Autodiscovery sensori","panel.sensor.sensor_item":"Sensore {index}","panel.sensor.filter_category":"Categoria filtro:","panel.sensor.clear_filter":"Pulisci categoria filtro","panel.sensor.clear":"Pulisci","panel.sensor.entity":"Entità:","panel.sensor.reset":"🧹 Reset sensori","panel.mushroom.title":"🍄 Entità mushroom","panel.mushroom.auto_discover":"🪄 Autodiscovery mushroom","panel.mushroom.item":"Mushroom {index}","panel.mushroom.filter_category":"Categoria filtro:","panel.mushroom.clear_filter":"Pulisci categoria filtro","panel.mushroom.clear":"Pulisci","panel.mushroom.entity":"Entità:","panel.mushroom.icon":"Icona:","panel.mushroom.tap_action":"Azione tap:","panel.mushroom.hold_action":"Azione hold:","panel.mushroom.path":"Percorso","panel.mushroom.service_with_example":"Servizio (es. light.turn_on)","panel.mushroom.service_data":"Dati servizio (JSON)","panel.mushroom.reset":"🧹 Reset mushroom","panel.subbutton.title":"🎛️ Sub-button","panel.subbutton.auto_discover":"🪄 Autodiscovery subbutton","panel.subbutton.item":"Sub-button {index}","panel.subbutton.filter_category":"Categoria filtro:","panel.subbutton.clear_filter":"Pulisci categoria filtro","panel.subbutton.clear":"Pulisci","panel.subbutton.entity":"Entità:","panel.subbutton.icon":"Icona:","panel.subbutton.tap_action":"Azione tap:","panel.subbutton.hold_action":"Azione hold:","panel.subbutton.path":"Percorso","panel.subbutton.service":"Servizio","panel.subbutton.service_data":"Dati servizio (JSON)","panel.subbutton.reset":"🧹 Reset sub-button","panel.colors.title":"🎨 Colori e preset","panel.colors.room_section":"Colori stanza","panel.colors.subbutton_section":"Colori subbutton","panel.colors.mushroom_section":"Colori mushroom","panel.colors.reset":"🧹 Reset colori","panel.colors.apply_preset":"Applica preset","panel.colors.on":"On","panel.colors.off":"Off","panel.colors.subbutton_style":"Stile subbutton","panel.colors.style.standard":"Standard (v5.0.6)","panel.colors.style.standard_desc":"Aspetto classico con pillole solide e contrastate.","panel.colors.style.liquid_glass":"Liquid Glass","panel.colors.style.liquid_glass_desc":"Effetto vetro liquido con trasparenze morbide.","panel.colors.room.background_active":"Sfondo attivo","panel.colors.room.background_inactive":"Sfondo inattivo","panel.colors.room.icon_active":"Icona attiva","panel.colors.room.icon_inactive":"Icona inattiva","panel.colors.room.text_active":"Testo attivo","panel.colors.room.text_inactive":"Testo inattivo","panel.colors.subbutton.background_on":"Sfondo on","panel.colors.subbutton.background_off":"Sfondo off","panel.colors.subbutton.icon_on":"Icona on","panel.colors.subbutton.icon_off":"Icona off","panel.colors.mushroom.active":"Attivo","panel.colors.mushroom.inactive":"Inattivo","actions.toggle":"toggle","actions.more-info":"more-info","actions.navigate":"navigate","actions.call-service":"call-service","actions.none":"none","presets.green":"Verde","presets.blue":"Blu","presets.amber":"Ambra","presets.purple":"Viola","presets.red":"Rosso","presets.yellow":"Giallo","presets.teal":"Teal","presets.gray":"Grigio"},es:{"panel.room.title":"🛋️ Configuración de la habitación","panel.room.auto_discover_presence":"🪄 Autodescubrimiento de presencia","panel.room.area":"🏷️ Área:","panel.room.name":"🏠 Nombre de la habitación:","panel.room.icon_presence":"🎭 Icono y presencia","panel.room.icon":"Icono:","panel.room.filter_categories":"Categorías de filtro:","panel.room.presence_id":"Presencia (ID):","panel.room.tap_action":"Acción tap","panel.room.hold_action":"Acción hold","panel.room.path":"Ruta","panel.room.service":"Servicio","panel.room.service_with_example":"Servicio (p. ej. light.turn_on)","panel.room.service_data":"Datos del servicio (JSON)","panel.room.layout":"📐 Diseño:","panel.room.layout_tall":"Alto","panel.room.layout_wide":"Ancho","panel.room.reset":"🧹 Reiniciar habitación","panel.camera.title":"📷 Cámara","panel.camera.auto_discover":"🪄 Autodescubrimiento","panel.camera.entity":"Cámara (ID):","panel.camera.icon":"Icono de cámara:","panel.camera.presence":"Entidad de presencia/movimiento:","panel.camera.reset":"🧹 Reiniciar cámara","panel.climate.title":"🌡️ Clima","panel.climate.auto_discover":"🪄 Autodescubrimiento","panel.climate.entity":"Clima (ID):","panel.climate.icon":"Icono de clima:","panel.climate.reset":"🧹 Reiniciar clima","panel.sensor.title":"🧭 Sensores","panel.sensor.auto_discover":"🪄 Autodescubrimiento de sensores","panel.sensor.sensor_item":"Sensor {index}","panel.sensor.filter_category":"Categoría de filtro:","panel.sensor.clear_filter":"Limpiar categoría de filtro","panel.sensor.clear":"Limpiar","panel.sensor.entity":"Entidad:","panel.sensor.reset":"🧹 Reiniciar sensores","panel.mushroom.title":"🍄 Entidades mushroom","panel.mushroom.auto_discover":"🪄 Autodescubrimiento mushroom","panel.mushroom.item":"Mushroom {index}","panel.mushroom.filter_category":"Categoría de filtro:","panel.mushroom.clear_filter":"Limpiar categoría de filtro","panel.mushroom.clear":"Limpiar","panel.mushroom.entity":"Entidad:","panel.mushroom.icon":"Icono:","panel.mushroom.tap_action":"Acción tap:","panel.mushroom.hold_action":"Acción hold:","panel.mushroom.path":"Ruta","panel.mushroom.service_with_example":"Servicio (p. ej. light.turn_on)","panel.mushroom.service_data":"Datos del servicio (JSON)","panel.mushroom.reset":"🧹 Reiniciar mushroom","panel.subbutton.title":"🎛️ Sub-botones","panel.subbutton.auto_discover":"🪄 Autodescubrimiento subbuttons","panel.subbutton.item":"Sub-botón {index}","panel.subbutton.filter_category":"Categoría de filtro:","panel.subbutton.clear_filter":"Limpiar categoría de filtro","panel.subbutton.clear":"Limpiar","panel.subbutton.entity":"Entidad:","panel.subbutton.icon":"Icono:","panel.subbutton.tap_action":"Acción tap:","panel.subbutton.hold_action":"Acción hold:","panel.subbutton.path":"Ruta","panel.subbutton.service":"Servicio","panel.subbutton.service_data":"Datos del servicio (JSON)","panel.subbutton.reset":"🧹 Reiniciar sub-botones","panel.colors.title":"🎨 Colores y presets","panel.colors.room_section":"Colores de la habitación","panel.colors.subbutton_section":"Colores de subbutton","panel.colors.mushroom_section":"Colores de mushroom","panel.colors.reset":"🧹 Reiniciar colores","panel.colors.apply_preset":"Aplicar preset","panel.colors.on":"On","panel.colors.off":"Off","panel.colors.subbutton_style":"Estilo de subbutton","panel.colors.style.standard":"Estándar (v5.0.6)","panel.colors.style.standard_desc":"Aspecto clásico con píldoras sólidas y de alto contraste.","panel.colors.style.liquid_glass":"Cristal líquido","panel.colors.style.liquid_glass_desc":"Efecto de cristal líquido con transparencias suaves.","panel.colors.room.background_active":"Fondo activo","panel.colors.room.background_inactive":"Fondo inactivo","panel.colors.room.icon_active":"Icono activo","panel.colors.room.icon_inactive":"Icono inactivo","panel.colors.room.text_active":"Texto activo","panel.colors.room.text_inactive":"Texto inactivo","panel.colors.subbutton.background_on":"Fondo on","panel.colors.subbutton.background_off":"Fondo off","panel.colors.subbutton.icon_on":"Icono on","panel.colors.subbutton.icon_off":"Icono off","panel.colors.mushroom.active":"Activo","panel.colors.mushroom.inactive":"Inactivo","actions.toggle":"toggle","actions.more-info":"more-info","actions.navigate":"navigate","actions.call-service":"call-service","actions.none":"none","presets.green":"Verde","presets.blue":"Azul","presets.amber":"Ámbar","presets.purple":"Morado","presets.red":"Rojo","presets.yellow":"Amarillo","presets.teal":"Teal","presets.gray":"Gris"},fr:{"panel.room.title":"🛋️ Paramètres de la pièce","panel.room.auto_discover_presence":"🪄 Découverte automatique de présence","panel.room.area":"🏷️ Zone :","panel.room.name":"🏠 Nom de la pièce :","panel.room.icon_presence":"🎭 Icône et présence","panel.room.icon":"Icône :","panel.room.filter_categories":"Catégories de filtre :","panel.room.presence_id":"Présence (ID) :","panel.room.tap_action":"Action tap","panel.room.hold_action":"Action hold","panel.room.path":"Chemin","panel.room.service":"Service","panel.room.service_with_example":"Service (ex. light.turn_on)","panel.room.service_data":"Données du service (JSON)","panel.room.layout":"📐 Mise en page :","panel.room.layout_tall":"Haute","panel.room.layout_wide":"Large","panel.room.reset":"🧹 Réinitialiser la pièce","panel.camera.title":"📷 Caméra","panel.camera.auto_discover":"🪄 Découverte automatique","panel.camera.entity":"Caméra (ID) :","panel.camera.icon":"Icône de caméra :","panel.camera.presence":"Entité de présence/mouvement :","panel.camera.reset":"🧹 Réinitialiser la caméra","panel.climate.title":"🌡️ Climat","panel.climate.auto_discover":"🪄 Découverte automatique","panel.climate.entity":"Climat (ID) :","panel.climate.icon":"Icône de climat :","panel.climate.reset":"🧹 Réinitialiser le climat","panel.sensor.title":"🧭 Capteurs","panel.sensor.auto_discover":"🪄 Découverte automatique des capteurs","panel.sensor.sensor_item":"Capteur {index}","panel.sensor.filter_category":"Catégorie de filtre :","panel.sensor.clear_filter":"Effacer la catégorie de filtre","panel.sensor.clear":"Effacer","panel.sensor.entity":"Entité :","panel.sensor.reset":"🧹 Réinitialiser les capteurs","panel.mushroom.title":"🍄 Entités mushroom","panel.mushroom.auto_discover":"🪄 Découverte automatique mushroom","panel.mushroom.item":"Mushroom {index}","panel.mushroom.filter_category":"Catégorie de filtre :","panel.mushroom.clear_filter":"Effacer la catégorie de filtre","panel.mushroom.clear":"Effacer","panel.mushroom.entity":"Entité :","panel.mushroom.icon":"Icône :","panel.mushroom.tap_action":"Action tap :","panel.mushroom.hold_action":"Action hold :","panel.mushroom.path":"Chemin","panel.mushroom.service_with_example":"Service (ex. light.turn_on)","panel.mushroom.service_data":"Données du service (JSON)","panel.mushroom.reset":"🧹 Réinitialiser les mushroom","panel.subbutton.title":"🎛️ Sous-boutons","panel.subbutton.auto_discover":"🪄 Découverte automatique subbuttons","panel.subbutton.item":"Sous-bouton {index}","panel.subbutton.filter_category":"Catégorie de filtre :","panel.subbutton.clear_filter":"Effacer la catégorie de filtre","panel.subbutton.clear":"Effacer","panel.subbutton.entity":"Entité :","panel.subbutton.icon":"Icône :","panel.subbutton.tap_action":"Action tap :","panel.subbutton.hold_action":"Action hold :","panel.subbutton.path":"Chemin","panel.subbutton.service":"Service","panel.subbutton.service_data":"Données du service (JSON)","panel.subbutton.reset":"🧹 Réinitialiser les sous-boutons","panel.colors.title":"🎨 Couleurs et préréglages","panel.colors.room_section":"Couleurs de la pièce","panel.colors.subbutton_section":"Couleurs subbutton","panel.colors.mushroom_section":"Couleurs mushroom","panel.colors.reset":"🧹 Réinitialiser les couleurs","panel.colors.apply_preset":"Appliquer le préréglage","panel.colors.on":"On","panel.colors.off":"Off","panel.colors.subbutton_style":"Style de subbutton","panel.colors.style.standard":"Standard (v5.0.6)","panel.colors.style.standard_desc":"Style classique avec des pilules solides et contrastées.","panel.colors.style.liquid_glass":"Verre liquide","panel.colors.style.liquid_glass_desc":"Effet verre liquide avec des transparences douces.","panel.colors.room.background_active":"Fond actif","panel.colors.room.background_inactive":"Fond inactif","panel.colors.room.icon_active":"Icône active","panel.colors.room.icon_inactive":"Icône inactive","panel.colors.room.text_active":"Texte actif","panel.colors.room.text_inactive":"Texte inactif","panel.colors.subbutton.background_on":"Fond on","panel.colors.subbutton.background_off":"Fond off","panel.colors.subbutton.icon_on":"Icône on","panel.colors.subbutton.icon_off":"Icône off","panel.colors.mushroom.active":"Actif","panel.colors.mushroom.inactive":"Inactif","actions.toggle":"toggle","actions.more-info":"more-info","actions.navigate":"navigate","actions.call-service":"call-service","actions.none":"none","presets.green":"Vert","presets.blue":"Bleu","presets.amber":"Ambre","presets.purple":"Violet","presets.red":"Rouge","presets.yellow":"Jaune","presets.teal":"Sarcelle","presets.gray":"Gris"},de:{"panel.room.title":"🛋️ Raumeinstellungen","panel.room.auto_discover_presence":"🪄 Präsenz automatisch erkennen","panel.room.area":"🏷️ Bereich:","panel.room.name":"🏠 Raumname:","panel.room.icon_presence":"🎭 Symbol und Präsenz","panel.room.icon":"Symbol:","panel.room.filter_categories":"Filterkategorien:","panel.room.presence_id":"Präsenz (ID):","panel.room.tap_action":"Tap-Aktion","panel.room.hold_action":"Hold-Aktion","panel.room.path":"Pfad","panel.room.service":"Dienst","panel.room.service_with_example":"Dienst (z. B. light.turn_on)","panel.room.service_data":"Dienst-Daten (JSON)","panel.room.layout":"📐 Layout:","panel.room.layout_tall":"Hoch","panel.room.layout_wide":"Breit","panel.room.reset":"🧹 Raum zurücksetzen","panel.camera.title":"📷 Kamera","panel.camera.auto_discover":"🪄 Automatische Erkennung","panel.camera.entity":"Kamera (ID):","panel.camera.icon":"Kamera-Symbol:","panel.camera.presence":"Präsenz-/Bewegungs-Entität:","panel.camera.reset":"🧹 Kamera zurücksetzen","panel.climate.title":"🌡️ Klima","panel.climate.auto_discover":"🪄 Automatische Erkennung","panel.climate.entity":"Klima (ID):","panel.climate.icon":"Klima-Symbol:","panel.climate.reset":"🧹 Klima zurücksetzen","panel.sensor.title":"🧭 Sensoren","panel.sensor.auto_discover":"🪄 Automatische Sensorerkennung","panel.sensor.sensor_item":"Sensor {index}","panel.sensor.filter_category":"Filterkategorie:","panel.sensor.clear_filter":"Filterkategorie löschen","panel.sensor.clear":"Löschen","panel.sensor.entity":"Entität:","panel.sensor.reset":"🧹 Sensoren zurücksetzen","panel.mushroom.title":"🍄 Mushroom-Entitäten","panel.mushroom.auto_discover":"🪄 Automatische Mushroom-Erkennung","panel.mushroom.item":"Mushroom {index}","panel.mushroom.filter_category":"Filterkategorie:","panel.mushroom.clear_filter":"Filterkategorie löschen","panel.mushroom.clear":"Löschen","panel.mushroom.entity":"Entität:","panel.mushroom.icon":"Symbol:","panel.mushroom.tap_action":"Tap-Aktion:","panel.mushroom.hold_action":"Hold-Aktion:","panel.mushroom.path":"Pfad","panel.mushroom.service_with_example":"Dienst (z. B. light.turn_on)","panel.mushroom.service_data":"Dienst-Daten (JSON)","panel.mushroom.reset":"🧹 Mushroom zurücksetzen","panel.subbutton.title":"🎛️ Sub-Buttons","panel.subbutton.auto_discover":"🪄 Automatische Subbutton-Erkennung","panel.subbutton.item":"Sub-Button {index}","panel.subbutton.filter_category":"Filterkategorie:","panel.subbutton.clear_filter":"Filterkategorie löschen","panel.subbutton.clear":"Löschen","panel.subbutton.entity":"Entität:","panel.subbutton.icon":"Symbol:","panel.subbutton.tap_action":"Tap-Aktion:","panel.subbutton.hold_action":"Hold-Aktion:","panel.subbutton.path":"Pfad","panel.subbutton.service":"Dienst","panel.subbutton.service_data":"Dienst-Daten (JSON)","panel.subbutton.reset":"🧹 Sub-Buttons zurücksetzen","panel.colors.title":"🎨 Farben und Presets","panel.colors.room_section":"Raumfarben","panel.colors.subbutton_section":"Subbutton-Farben","panel.colors.mushroom_section":"Mushroom-Farben","panel.colors.reset":"🧹 Farben zurücksetzen","panel.colors.apply_preset":"Preset anwenden","panel.colors.on":"On","panel.colors.off":"Off","panel.colors.subbutton_style":"Subbutton-Stil","panel.colors.style.standard":"Standard (v5.0.6)","panel.colors.style.standard_desc":"Klassisches Aussehen mit soliden, kontrastreichen Pills.","panel.colors.style.liquid_glass":"Flüssigglas","panel.colors.style.liquid_glass_desc":"Flüssigglas-Effekt mit weichen Transparenzen.","panel.colors.room.background_active":"Aktiver Hintergrund","panel.colors.room.background_inactive":"Inaktiver Hintergrund","panel.colors.room.icon_active":"Aktives Symbol","panel.colors.room.icon_inactive":"Inaktives Symbol","panel.colors.room.text_active":"Aktiver Text","panel.colors.room.text_inactive":"Inaktiver Text","panel.colors.subbutton.background_on":"Hintergrund an","panel.colors.subbutton.background_off":"Hintergrund aus","panel.colors.subbutton.icon_on":"Symbol an","panel.colors.subbutton.icon_off":"Symbol aus","panel.colors.mushroom.active":"Aktiv","panel.colors.mushroom.inactive":"Inaktiv","actions.toggle":"toggle","actions.more-info":"more-info","actions.navigate":"navigate","actions.call-service":"call-service","actions.none":"none","presets.green":"Grün","presets.blue":"Blau","presets.amber":"Bernstein","presets.purple":"Lila","presets.red":"Rot","presets.yellow":"Gelb","presets.teal":"Türkis","presets.gray":"Grau"},pt:{"panel.room.title":"🛋️ Configurações do cômodo","panel.room.auto_discover_presence":"🪄 Autodescoberta de presença","panel.room.area":"🏷️ Área:","panel.room.name":"🏠 Nome do cômodo:","panel.room.icon_presence":"🎭 Ícone e presença","panel.room.icon":"Ícone:","panel.room.filter_categories":"Categorias de filtro:","panel.room.presence_id":"Presença (ID):","panel.room.tap_action":"Ação tap","panel.room.hold_action":"Ação hold","panel.room.path":"Caminho","panel.room.service":"Serviço","panel.room.service_with_example":"Serviço (ex. light.turn_on)","panel.room.service_data":"Dados do serviço (JSON)","panel.room.layout":"📐 Layout:","panel.room.layout_tall":"Alto","panel.room.layout_wide":"Largo","panel.room.reset":"🧹 Redefinir cômodo","panel.camera.title":"📷 Câmera","panel.camera.auto_discover":"🪄 Autodescoberta","panel.camera.entity":"Câmera (ID):","panel.camera.icon":"Ícone da câmera:","panel.camera.presence":"Entidade de presença/movimento:","panel.camera.reset":"🧹 Redefinir câmera","panel.climate.title":"🌡️ Clima","panel.climate.auto_discover":"🪄 Autodescoberta","panel.climate.entity":"Clima (ID):","panel.climate.icon":"Ícone do clima:","panel.climate.reset":"🧹 Redefinir clima","panel.sensor.title":"🧭 Sensores","panel.sensor.auto_discover":"🪄 Autodescoberta de sensores","panel.sensor.sensor_item":"Sensor {index}","panel.sensor.filter_category":"Categoria de filtro:","panel.sensor.clear_filter":"Limpar categoria de filtro","panel.sensor.clear":"Limpar","panel.sensor.entity":"Entidade:","panel.sensor.reset":"🧹 Redefinir sensores","panel.mushroom.title":"🍄 Entidades mushroom","panel.mushroom.auto_discover":"🪄 Autodescoberta mushroom","panel.mushroom.item":"Mushroom {index}","panel.mushroom.filter_category":"Categoria de filtro:","panel.mushroom.clear_filter":"Limpar categoria de filtro","panel.mushroom.clear":"Limpar","panel.mushroom.entity":"Entidade:","panel.mushroom.icon":"Ícone:","panel.mushroom.tap_action":"Ação tap:","panel.mushroom.hold_action":"Ação hold:","panel.mushroom.path":"Caminho","panel.mushroom.service_with_example":"Serviço (ex. light.turn_on)","panel.mushroom.service_data":"Dados do serviço (JSON)","panel.mushroom.reset":"🧹 Redefinir mushroom","panel.subbutton.title":"🎛️ Sub-botões","panel.subbutton.auto_discover":"🪄 Autodescoberta subbuttons","panel.subbutton.item":"Sub-botão {index}","panel.subbutton.filter_category":"Categoria de filtro:","panel.subbutton.clear_filter":"Limpar categoria de filtro","panel.subbutton.clear":"Limpar","panel.subbutton.entity":"Entidade:","panel.subbutton.icon":"Ícone:","panel.subbutton.tap_action":"Ação tap:","panel.subbutton.hold_action":"Ação hold:","panel.subbutton.path":"Caminho","panel.subbutton.service":"Serviço","panel.subbutton.service_data":"Dados do serviço (JSON)","panel.subbutton.reset":"🧹 Redefinir sub-botões","panel.colors.title":"🎨 Cores e presets","panel.colors.room_section":"Cores do cômodo","panel.colors.subbutton_section":"Cores de subbutton","panel.colors.mushroom_section":"Cores de mushroom","panel.colors.reset":"🧹 Redefinir cores","panel.colors.apply_preset":"Aplicar preset","panel.colors.on":"On","panel.colors.off":"Off","panel.colors.subbutton_style":"Estilo de subbutton","panel.colors.style.standard":"Padrão (v5.0.6)","panel.colors.style.standard_desc":"Visual clássico com pílulas sólidas e contrastantes.","panel.colors.style.liquid_glass":"Vidro líquido","panel.colors.style.liquid_glass_desc":"Efeito de vidro líquido com transparências suaves.","panel.colors.room.background_active":"Fundo ativo","panel.colors.room.background_inactive":"Fundo inativo","panel.colors.room.icon_active":"Ícone ativo","panel.colors.room.icon_inactive":"Ícone inativo","panel.colors.room.text_active":"Texto ativo","panel.colors.room.text_inactive":"Texto inativo","panel.colors.subbutton.background_on":"Fundo on","panel.colors.subbutton.background_off":"Fundo off","panel.colors.subbutton.icon_on":"Ícone on","panel.colors.subbutton.icon_off":"Ícone off","panel.colors.mushroom.active":"Ativo","panel.colors.mushroom.inactive":"Inativo","actions.toggle":"toggle","actions.more-info":"more-info","actions.navigate":"navigate","actions.call-service":"call-service","actions.none":"none","presets.green":"Verde","presets.blue":"Azul","presets.amber":"Âmbar","presets.purple":"Roxo","presets.red":"Vermelho","presets.yellow":"Amarelo","presets.teal":"Teal","presets.gray":"Cinza"}};function Ae(e,t,i={},o){const s=(e?.language||e?.selectedLanguage||"en").toLowerCase().split("-")[0];return((Se[s]||Se.en)[t]??Se.en[t]??o??t).replace(/\{(\w+)\}/g,(e,t)=>{const o=i[t];return null==o?`{${t}}`:String(o)})}const Ee=["presence","motion","occupancy","light","switch","fan"];class ze extends oe{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},activeFilters:{type:Array,state:!0},layout:{type:String}};static styles=n`
  ...
  `;constructor(){super(),this.hass={},this.config={},this.expanded=!1,this.activeFilters=[],this.layout="wide",this._syncingFromConfig=!1}updated(e){if(!e.has("config")&&!e.has("hass"))return;if(this._syncingFromConfig=!0,(this.config?.area||this.config?.area_id)&&_e(this.hass,this.config,"area",!1),Ce.warm(this.hass),e.has("config")){Array.isArray(this.config?.presence_filters)&&(this.activeFilters=[...this.config.presence_filters]);const e=this.config?.layout;e&&e!==this.layout&&(this.layout=e)}this._syncingFromConfig=!1;const t=this.config?.entities?.presence?.entity,i=this.config?.icon||"";if(t&&!i){const e=this.hass?.states?.[t],i=e?.attributes?.icon||ke(t,this.hass);i&&this._fire("icon",i)}}_onLayoutClick(e){this.layout=e,this._fire("layout",e);const t="tall"===e?{columns:6,rows:4}:{columns:12,rows:4};this._fire("grid_options",t)}_fire(e,t){this._syncingFromConfig||this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:e,val:t},bubbles:!0,composed:!0}))}_onPresenceEntityChange=e=>{this._fire("entities.presence.entity",e);const t=this.config?.icon||"";if(e&&!t){const t=this.hass?.states?.[e],i=t?.attributes?.icon||ke(e,this.hass);i&&this._fire("icon",i)}};_onAreaChange(e){const t=this.config||{},i={...t.auto_discovery_sections||{}};e&&!t.area&&(i.camera=!0,i.climate=!0,i.sensor=!0,i.mushroom=!0,i.subbutton=!0,i.presence=!0);const o={...t,area:e,area_id:e,auto_discovery_sections:i};e&&(o.name=e.toUpperCase()),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:o},bubbles:!0,composed:!0}))}_presenceCandidatesNoArea(e,t=[],i){if(!e?.states)return[];const o=new Set(["person","device_tracker","binary_sensor","light","switch","media_player","fan","humidifier","lock","input_boolean","scene"]);let s=Object.keys(e.states).filter(e=>o.has(e.split(".")[0]));const n=new Set(t||[]);return n.size&&(s=s.filter(t=>{const[i]=t.split(".");if("binary_sensor"!==i)return!0;const o=e.states[t]?.attributes?.device_class||"";return n.has("motion")&&"motion"===o||n.has("occupancy")&&"occupancy"===o||n.has("presence")&&"presence"===o})),i&&!s.includes(i)&&s.unshift(i),s}render(){const e=this.config,t=(e,t,i)=>Ae(this.hass,e,t,i),i=e.auto_discovery_sections?.presence??!1,o=e.area??"",s=e.name??"",n=e.icon??"",a=e.entities?.presence?.entity??"",r=this.activeFilters.length?this.activeFilters:e.presence_filters??[...Ee],l=Ee.map(e=>({value:e,label:e.charAt(0).toUpperCase()+e.slice(1)})),c=i?ge(this.hass,this.config,"presence",r):this._presenceCandidatesNoArea(this.hass,r,a),d=["toggle","more-info","navigate","call-service","none"],u={toggle:t("actions.toggle"),"more-info":t("actions.more-info"),navigate:t("actions.navigate"),"call-service":t("actions.call-service"),none:t("actions.none")},p=this.config?.tap_action||{},h=this.config?.hold_action||{};return j`
      <ha-expansion-panel
        class="glass-panel"
...
`;class Oe extends oe{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_expanded:{type:Array,state:!0},_filters:{type:Array,state:!0},_entities:{type:Array,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._expanded=Array(5).fill(!1);const e=Object.keys(Pe);this._filters=Array(5).fill().map(()=>[...e]),this._entities=Array(5).fill(""),this._ignoreNextFilterChange=new Set}updated(e){if(e.has("config")||e.has("hass")){const e=_e(this.hass,this.config,"auto_discovery_sections.sensor");e&&e!==this.config&&this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}));for(let e=0;e<5;e++){const t=`sensor${e+1}`,i=this.config?.sensor_filters?.[e],o=this.config?.entities?.[t]?.entity;Array.isArray(i)&&(this._filters[e]=[...i]),o&&(this._entities[e]=o)}}}static styles=[Me,n`
      :host {
    ...
    `];render(){const e=this.config?.auto_discovery_sections?.sensor??!1,t=(e,t,i)=>Ae(this.hass,e,t,i),i=Object.entries(Pe).filter(([e])=>"_fallback"!==e).map(([e,t])=>{const i=t.label||e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase());return{value:e,label:`${t.emoji||""} ${i}`.trim()}});return j`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
    ...
    `}_renderSensor(e,t,i){const o=(e,t,i)=>Ae(this.hass,e,t,i),s=this._filters[e],n=this._entities[e];let a;if(this.config?.auto_discovery_sections?.sensor??!1)a=ge(this.hass,this.config,"sensor",s)||[];else{const e=this.hass?.states||{},t=Object.keys(e),i=Array.isArray(s)&&s.length>0,o=i?new Set(s):null;a=t.filter(t=>{const s=t.split(".")[0];if("sensor"!==s&&"binary_sensor"!==s)return!1;if(!i)return!0;const n=e[t]?.attributes?.device_class;return!!n&&o.has(n)})}return n&&!a.includes(n)&&(a=[n,...a]),j`
      <div class="mini-pill ${t?"expanded":""}">
        <div class="mini-pill-header" @click=${()=>this._togglePill(e)}>
          ${o("panel.sensor.sensor_item",{index:e+1})}
          ...
          <div class="mini-pill-content">
            <div class="input-group">
              <div class="filter-row">
                <label for="filter-${e}">${o("panel.sensor.filter_category")}</label>
                <button
                  class="clear-chip"
                  type="button"
                  @click=${()=>this._clearFilter(e)}
                  title=${o("panel.sensor.clear_filter")}>
                  ${o("panel.sensor.clear")}
                </button>
              </div>
              <ha-selector
                id="filter-${e}"
            ...
            <div class="input-group">
              <label>${o("panel.sensor.entity")}</label>
              <ha-selector
                .hass=${this.hass}
                .value=${n}
            ...
            ${n?(()=>{const e=this.hass.states[n],t=e?.attributes?.device_class,i=Pe[t]||{},o=i.emoji||"❓",s=e?.attributes?.unit_of_measurement||(i.units?.[0]??"");return j`
                <div class="preview">
    ...
    `}_toggleAuto(e){this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"auto_discovery_sections.sensor",val:e},bubbles:!0,composed:!0}))}_togglePill(e){this._expanded=this._expanded.map((t,i)=>i===e&&!t),this.requestUpdate()}_onFilter(e,t){const i=Object.keys(Pe);if(this._ignoreNextFilterChange.has(e))this._ignoreNextFilterChange.delete(e),this._filters[e]=[];else{const o=Array.isArray(t)&&t.length?t.filter(Boolean):i;this._filters[e]=[...o]}this.requestUpdate("_filters");const o=this.renderRoot?.querySelector(`#filter-${e}`);o&&(o.value=[...this._filters[e]])}_clearFilter(e){this._filters[e]=[],this.requestUpdate("_filters");const t=this.renderRoot?.querySelector(`#filter-${e}`);t&&(this._ignoreNextFilterChange.add(e),t.value=[],t.dispatchEvent(new CustomEvent("value-changed",{detail:{value:[]},bubbles:!0,composed:!0})))}_onEntity(e,t){this._entities[e]=t,this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.sensor${e+1}.entity`,val:t},bubbles:!0,composed:!0}))}_reset(){this._expanded=Array(5).fill(!1);const e=Object.keys(Pe);this._filters=Array(5).fill().map(()=>[...e]),this._entities=Array(5).fill("");for(let e=1;e<=5;e++)this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.sensor${e}.entity`,val:""},bubbles:!0,composed:!0}))}}customElements.define("sensor-panel",Oe);class Fe extends oe{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_expanded:{type:Array,state:!0},_filters:{type:Array,state:!0},_entities:{type:Array,state:!0},_icons:{type:Array,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._ALL_CATS=Array.from(new Set([...ae,...re])),this._expanded=Array(5).fill(!1),this._filters=Array(5).fill().map(()=>[...this._ALL_CATS]),this._entities=Array(5).fill(""),this._icons=Array(5).fill(""),this._syncingFromConfig=!1,this._ignoreNextFilterChange=new Set}updated(e){if(!e.has("config")&&!e.has("hass"))return;if(this._syncingFromConfig=!0,this.config?.area||this.config?.area_id){const e=_e(this.hass,this.config,"area",!1);e&&e!==this.config&&this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}const t=this.config?.mushroom_filters;Array.isArray(t)&&5===t.length?this._filters=t.map(e=>Array.isArray(e)?[...e]:[...this._ALL_CATS]):this._filters=Array(5).fill().map(()=>[...this._ALL_CATS]);const i=this.config?.entities||{};for(let e=0;e<5;e++){const t=i[`mushroom${e+1}`]||{};t.entity&&(this._entities[e]=t.entity),"string"==typeof t.icon&&(this._icons[e]=t.icon)}this._syncingFromConfig=!1;const o=[];for(let e=0;e<5;e++){const t=`mushroom${e+1}`,i=this._entities[e],s=this.config?.entities?.[t]?.icon;if(i&&!s){const s=this.hass?.states?.[i],n=s?.attributes?.icon,a=n||ke(i,this.hass);a&&o.push({i:e,key:t,icon:a})}}if(o.length)for(const{i:e,key:t,icon:i}of o)this._icons[e]=i,this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.${t}.icon`,val:i},bubbles:!0,composed:!0}))}static styles=[Me,n`
      :host {
    ...
    `];render(){const e=this.config?.auto_discovery_sections?.mushroom??!1,t=(e,t,i)=>Ae(this.hass,e,t,i),i=this._ALL_CATS.map(e=>({value:e,label:ne[e]||e.charAt(0).toUpperCase()+e.slice(1)}));return j`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
        @expanded-changed=${e=>{this.expanded=e.detail.expanded,this.expanded&&(this._expanded=Array(5).fill(!1))}}
    ...
    `}_renderMushroom(e,t,i){const o=(e,t,i)=>Ae(this.hass,e,t,i),s=`mushroom${e+1}`,n=this._filters[e],a=this._entities[e],r=this._icons[e],l=this.config.entities&&this.config.entities[s]?this.config.entities[s]:{};let c;if(this.config?.auto_discovery_sections?.mushroom??!1)c=ge(this.hass,this.config,"mushroom",n)||[];else{const e={...this.config,area:void 0,area_id:void 0};c=ge(this.hass,e,"mushroom",n)||[]}a&&!c.includes(a)&&(c=[a,...c]);const d=["toggle","more-info","navigate","call-service","none"],u={toggle:o("actions.toggle"),"more-info":o("actions.more-info"),navigate:o("actions.navigate"),"call-service":o("actions.call-service"),none:o("actions.none")};return j`
      <div class="mini-pill ${t?"expanded":""}">
        <div class="mini-pill-header" @click=${()=>this._togglePill(e)}>
          ${o("panel.mushroom.item",{index:e+1})}
          <span class="chevron">${t?"▼":"▶"}</span>
        </div>
        ...
        ${t?j`
          <div class="mini-pill-content">
            ...
            <div class="input-group">
              <div class="filter-row">
                <label for="filter-${e}">${o("panel.mushroom.filter_category")}</label>
                <button
                  class="clear-chip"
                  type="button"
                  @click=${()=>this._clearFilter(e)}
                  title=${o("panel.mushroom.clear_filter")}>
                  ${o("panel.mushroom.clear")}
                </button>
              </div>
              <ha-selector
                id="filter-${e}"
            ...
            <!-- Entity -->
            <div class="input-group">
              <label>${o("panel.mushroom.entity")}</label>
              <ha-selector
                .hass=${this.hass}
                .value=${a}
                .selector=${{entity:{include_entities:c,multiple:!1}}}
            ...
            <!-- Icon -->
            <div class="input-group">
              <label>${o("panel.mushroom.icon")}</label>
              <ha-icon-picker
                .hass=${this.hass}
                .value=${r}
                allow-custom-icon
            ...
            <!-- Tap Action -->
            <div class="input-group">
              <label>${o("panel.mushroom.tap_action")}</label>
              <div class="pill-group">
                ${d.map(t=>j`
                  <button
            ...
            <!-- Hold Action -->
            <div class="input-group">
              <label>${o("panel.mushroom.hold_action")}</label>
              <div class="pill-group">
                ${d.map(t=>j`
                  <button
    ...
    `}_extraFields(e,t,i){const o=(e,t,i)=>Ae(this.hass,e,t,i),s=i?.[`${t}_action`]?.action;return"navigate"===s?j`
        <input type="text" placeholder=${o("panel.mushroom.path")}
          .value=${i[`${t}_action`]?.navigation_path||""}
          @input=${i=>this._onAction(e,t,"navigation_path",i.target.value)}
        />
      `:"call-service"===s?j`
        <input type="text" placeholder=${o("panel.mushroom.service_with_example")}
          .value=${i[`${t}_action`]?.service||""}
          @input=${i=>this._onAction(e,t,"service",i.target.value)}
        />
        <input type="text" placeholder=${o("panel.mushroom.service_data")}
        ...
        />
      `:""}_safeJson(e){try{return JSON.parse(e)}catch{return{}}}_toggleAuto(e){this._syncingFromConfig||this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"auto_discovery_sections.mushroom",val:e},bubbles:!0,composed:!0}))}_togglePill(e){this._expanded=this._expanded.map((t,i)=>i===e&&!t),this.requestUpdate()}_onFilter(e,t){if(this._ignoreNextFilterChange.has(e))this._ignoreNextFilterChange.delete(e),this._filters[e]=[];else{const i=Array.isArray(t)&&t.length?t.filter(Boolean):[...this._ALL_CATS];this._filters[e]=[...i]}if(this.requestUpdate("_filters"),!this._syncingFromConfig){const e=this._filters.map(e=>[...e]);this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"mushroom_filters",val:e},bubbles:!0,composed:!0}))}const i=this.renderRoot?.querySelector(`#filter-${e}`);i&&(i.value=[...this._filters[e]])}_clearFilter(e){this._filters[e]=[],this.requestUpdate("_filters");const t=this.renderRoot?.querySelector(`#filter-${e}`);t&&(this._ignoreNextFilterChange.add(e),t.value=[],t.dispatchEvent(new CustomEvent("value-changed",{detail:{value:[]},bubbles:!0,composed:!0})))}_onEntity(e,t){if(this._entities[e]=t,!this._syncingFromConfig){this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.mushroom${e+1}.entity`,val:t},bubbles:!0,composed:!0}));if(!(this.config?.entities?.[`mushroom${e+1}`]?.icon||"")){const i=this.hass?.states?.[t],o=i?.attributes?.icon,s=o||ke(t,this.hass);s&&(this._icons[e]=s,this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.mushroom${e+1}.icon`,val:s},bubbles:!0,composed:!0})))}}}_onIcon(e,t){this._icons[e]=t||"",this._syncingFromConfig||this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.mushroom${e+1}.icon`,val:this._icons[e]},bubbles:!0,composed:!0}))}_onAction(e,t,i,o){if(this._syncingFromConfig)return;const s=`mushroom${e+1}`,n={...this.config?.entities?.[s]?.[`${t}_action`]||{},[i]:o};this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.${s}.${t}_action`,val:n},bubbles:!0,composed:!0}))}_reset(){this._expanded=Array(5).fill(!1),this._filters=Array(5).fill().map(()=>[...this._ALL_CATS]),this._entities=Array(5).fill(""),this._icons=Array(5).fill(""),this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"mushroom_filters",val:this._filters},bubbles:!0,composed:!0}));for(let e=1;e<=5;e++)this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.mushroom${e}.entity`,val:""},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.mushroom${e}.icon`,val:""},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.mushroom${e}.tap_action`,val:{action:"none"}},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.mushroom${e}.hold_action`,val:{action:"none"}},bubbles:!0,composed:!0}))}_autoIconFor(e){if(!e)return"";const t=this.hass?.states?.[e];return t?.attributes?.icon||ke(e,this.hass)}}customElements.define("mushroom-panel",Fe);class Ie extends oe{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_expanded:{type:Array,state:!0},_filters:{type:Array,state:!0},_entities:{type:Array,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._expanded=Array(4).fill(!1),this._filters=Array(4).fill().map(()=>[...ae]),this._entities=Array(4).fill(""),this._ignoreNextFilterChange=new Set,this._filtersHydrated=!1,this._syncingFromConfig=!1}updated(e){if(!e.has("config")&&!e.has("hass"))return;if(this._syncingFromConfig=!0,this.config?.area||this.config?.area_id){const e=_e(this.hass,this.config,"area",!1);e&&e!==this.config&&this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}const t=Array.isArray(this.config?.subbuttons)?this.config.subbuttons:[];if(t.length)for(let e=0;e<Math.min(4,t.length);e++){const i=t[e]?.entity_id||"";if(this._entities[e]=i,i){const o=t[e]?.icon;if(!o){const t=this.hass?.states?.[i],o=t?.attributes?.icon,s=o||ke(i,this.hass);s&&this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`subbuttons.${e}.icon`,val:s},bubbles:!0,composed:!0}))}}}if(!this._filtersHydrated){const e=this.config?.subbutton_filters;Array.isArray(e)&&4===e.length&&(this._filters=e.map(e=>Array.isArray(e)?[...e]:[...ae])),this._filtersHydrated=!0}this._syncingFromConfig=!1}static styles=[Me,n`
      :host {
    ...
    `];render(){const e=this.config?.auto_discovery_sections?.subbutton??!1,t=(e,t,i)=>Ae(this.hass,e,t,i),i=ae.map(e=>({value:e,label:ne[e]||e.charAt(0).toUpperCase()+e.slice(1)}));return j`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
        @expanded-changed=${e=>this.expanded=e.detail.expanded}
      >
        ...
        ${this._expanded.map((e,t)=>this._renderSubButton(t,e,i))}

        <button class="reset-button" @click=${()=>this._reset()}>
          ${t("panel.subbutton.reset")}
        </button>
      </ha-expansion-panel>
    `}_renderSubButton(e,t,i){const o=(e,t,i)=>Ae(this.hass,e,t,i),s=this._filters[e],n=this._entities[e];let a;if(this.config?.auto_discovery_sections?.subbutton??!1)a=ge(this.hass,this.config,"subbutton",s)||[];else{const e={...this.config,area:void 0,area_id:void 0};a=ge(this.hass,e,"subbutton",s)||[]}n&&!a.includes(n)&&(a=[n,...a]);const r=Array.isArray(this.config?.subbuttons)&&this.config.subbuttons[e]||{},l=["toggle","more-info","navigate","call-service","none"],c={toggle:o("actions.toggle"),"more-info":o("actions.more-info"),navigate:o("actions.navigate"),"call-service":o("actions.call-service"),none:o("actions.none")};return j`
      <div class="mini-pill ${t?"expanded":""}">
        <div class="mini-pill-header" @click=${()=>this._togglePill(e)}>
          ${o("panel.subbutton.item",{index:e+1})}
          <span class="chevron">${t?"▼":"▶"}</span>
        </div>
        ${t?j`
          <div class="mini-pill-content">
            <div class="input-group">
              <div class="filter-row">
                <label for="filter-${e}">${o("panel.subbutton.filter_category")}</label>
                <button class="clear-chip" type="button"
                        @click=${()=>this._clearFilter(e)}
                        title=${o("panel.subbutton.clear_filter")}>${o("panel.subbutton.clear")}</button>
              </div>
              <ha-selector
                id="filter-${e}"
                .hass=${this.hass}
            ...
            <div class="input-group">
              <label>${o("panel.subbutton.entity")}</label>
              <ha-selector
                .hass=${this.hass}
                .value=${n}
                .selector=${{entity:{include_entities:a,multiple:!1}}}
            ...
            <div class="input-group">
              <label>${o("panel.subbutton.icon")}</label>
              <ha-icon-picker
                .hass=${this.hass}
                .value=${r.icon||""}
                allow-custom-icon
            ...
            ${["tap","hold"].map(t=>j`
              <div class="input-group">
                <label>${o("tap"===t?"panel.subbutton.tap_action":"panel.subbutton.hold_action")}</label>
                <div class="pill-group">
                  ${l.map(i=>j`
                    <button
...
`;class je extends oe{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_room:{type:Object,state:!0},_subbutton:{type:Object,state:!0},_mushroom:{type:Object,state:!0},_sensor:{type:Object,state:!0},_selectedPreset:{type:String,state:!0},_expandedColors:{type:Array,state:!0},_subbuttonStyle:{type:String,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._room={},this._subbutton={},this._mushroom={},this._sensor={},this._selectedPreset="green",this._expandedColors=[!1,!1,!1],this._subbuttonStyle="standard"}updated(e){if(e.has("config")){const e=this.config?.colors||{};this._room={icon_active:e.room?.icon_active??"",icon_inactive:e.room?.icon_inactive??"",background_active:e.room?.background_active??"",background_inactive:e.room?.background_inactive??"",text_active:e.room?.text_active??"",text_inactive:e.room?.text_inactive??""},this._subbutton={background_on:e.subbutton?.background_on??"",background_off:e.subbutton?.background_off??"",icon_on:e.subbutton?.icon_on??"",icon_off:e.subbutton?.icon_off??""},this._mushroom={active:e.mushroom?.active??"",inactive:e.mushroom?.inactive??""},this._sensor={sensor_active:e.sensor?.sensor_active??"",sensor_inactive:e.sensor?.sensor_inactive??""},this._subbuttonStyle=this.config?.subbutton_style||"standard"}}get PRESETS(){return Re}static styles=qe;render(){const e=(e,t,i)=>Ae(this.hass,e,t,i);return j`
    ...
    `}_renderStyleChooser(){const e=(e,t,i)=>Ae(this.hass,e,t,i),t=[{key:"standard",label:e("panel.colors.style.standard"),description:e("panel.colors.style.standard_desc")},{key:"liquid-glass",label:e("panel.colors.style.liquid_glass"),description:e("panel.colors.style.liquid_glass_desc")}];return j`
    ...
    `}_renderStyleCard({key:e,label:t,description:i}){const o=this._subbuttonStyle===e;return j`
      <div
        class="style-card ${o?"selected":""}"
        role="button"
        tabindex="0"
    ...
    `}_renderPresetChooser(){const e=Object.keys(this.PRESETS);return j`
      ...
      <div class="apply-row">
        <button class="apply-btn" @click=${this._applySelectedPreset}>
          ${((e,t,i)=>Ae(this.hass,e,t,i))("panel.colors.apply_preset")}
        </button>
      </div>
    `}_renderPresetCard(e,t){const i=(e,t,i)=>Ae(this.hass,e,t,i),o=this._selectedPreset===e?"selected":"",s=t.room.background_active,n=t.room.background_inactive,a=t.room.icon_active,r=t.room.icon_inactive;return j`
      <div class="preset-card ${o}" @click=${()=>this._selectedPreset=e}>
        <div class="preset-name">${i(`presets.${e}`)}</div>
        <div class="swatches">
          <div class="swatch" style="background:${s}">
            <span class="dot" style="background:${a}"></span>
            <span class="swatch-label">${i("panel.colors.on")}</span>
          </div>
          <div class="swatch" style="background:${n}">
            <span class="dot" style="background:${r}"></span>
            <span class="swatch-label">${i("panel.colors.off")}</span>
          </div>
        </div>
      </div>
    `}_toggleColor(e){this._expandedColors=this._expandedColors.map((t,i)=>i===e&&!t)}_renderColorField(e,t,i){const o=this.config?.colors?.[e]?.[t]||"",[s,n,a,r]=this._parseRGBA(o),l=`#${[s,n,a].map(e=>e.toString(16).padStart(2,"0")).join("")}`;return j`
      <div class="input-group">
        <label>${i}</label>
        <input
          type="color"
  ...
  `;render(){const e=this.config?.auto_discovery_sections?.camera??!1,t=(e,t,i)=>Ae(this.hass,e,t,i);return j`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
        @expanded-changed=${e=>this.expanded=e.detail.expanded}
    ...
    `}_toggleAuto(e){this._syncingFromConfig||this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"auto_discovery_sections.camera",val:e},bubbles:!0,composed:!0}))}_onEntity(e){if(this._entity=e||"",this._syncingFromConfig)return;if(this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"entities.camera.entity",val:this._entity},bubbles:!0,composed:!0})),!this._entity)return this._icon="",void this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"entities.camera.icon",val:""},bubbles:!0,composed:!0}));const t=this.hass?.states?.[this._entity],i=t?.attributes?.icon,o=i||ke(this._entity,this.hass)||"";this._icon=o,this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"entities.camera.icon",val:o},bubbles:!0,composed:!0}))}_onPresence(e){this._presence=e||"",this._syncingFromConfig||this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"entities.camera.presence.entity",val:this._presence},bubbles:!0,composed:!0}))}_onIcon(e){this._icon=e||"",this._syncingFromConfig||this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"entities.camera.icon",val:this._icon},bubbles:!0,composed:!0}))}_reset(){this._entity="",this._icon="",this._presence="",this._candidates=[],this._presenceCandidates=[],this.dispatchEvent(new CustomEvent("__panel_cmd__",{detail:{cmd:"reset",section:"camera"},bubbles:!0,composed:!0}))}}customElements.define("camera-panel",Te);class Ne extends oe{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_entity:{type:String,state:!0},_icon:{type:String,state:!0},_candidates:{type:Array,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._entity="",this._icon="",this._candidates=[],this._syncingFromConfig=!1}updated(e){if(!e.has("config")&&!e.has("hass"))return;if(this._syncingFromConfig=!0,this.config?.area||this.config?.area_id){const e=_e(this.hass,this.config,"area",!1);e&&e!==this.config&&this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}const t=this.config?.entities?.climate?.entity||"",i=this.config?.entities?.climate?.icon||"";this._entity=t,this._icon=i;if(this.config?.auto_discovery_sections?.climate??!1){const e=ge(this.hass,this.config,"climate")||[];this._candidates=Array.isArray(e)?e:[]}else{let e=Object.keys(this.hass?.states||{}).filter(e=>e.startsWith("climate."));this._entity&&!e.includes(this._entity)&&e.unshift(this._entity),this._candidates=e}if(this._entity&&!this._icon){const e=this.hass?.states?.[this._entity],t=e?.attributes?.icon,i=t||ke(this._entity,this.hass);i&&(this._icon=i,this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"entities.climate.icon",val:i},bubbles:!0,composed:!0})))}this._syncingFromConfig=!1}static styles=n`
    :host { display: block; }
    .glass-panel {
      margin: 0 !important; width: 100%; box-sizing: border-box;
      border-radius: 40px; position: relative;
  ...
  `;render(){const e=this.config?.auto_discovery_sections?.climate??!1,t=(e,t,i)=>Ae(this.hass,e,t,i);return j`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
        @expanded-changed=${e=>this.expanded=e.detail.expanded}
    ...
    `}_toggleAuto(e){this._syncingFromConfig||this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"auto_discovery_sections.climate",val:e},bubbles:!0,composed:!0}))}_onEntity(e){if(this._entity=e||"",this._syncingFromConfig)return;if(this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"entities.climate.entity",val:this._entity},bubbles:!0,composed:!0})),!this._entity)return this._icon="",void this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"entities.climate.icon",val:""},bubbles:!0,composed:!0}));const t=this.hass?.states?.[this._entity],i=t?.attributes?.icon,o=i||ke(this._entity,this.hass)||"";this._icon=o,this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"entities.climate.icon",val:o},bubbles:!0,composed:!0}))}_onIcon(e){this._icon=e||"",this._syncingFromConfig||this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"entities.climate.icon",val:this._icon},bubbles:!0,composed:!0}))}}customElements.define("climate-panel",Ne);class De extends oe{static properties={hass:{type:Object},config:{type:Object},openPanel:{type:String,state:!0}};constructor(){super(),this.hass=void 0,this.config={},this.openPanel="",this._onPanelChanged=this._onPanelChanged.bind(this),this._onPanelCmd=this._onPanelCmd.bind(this),this._togglePanel=this._togglePanel.bind(this),this._onConfigChanged=this._onConfigChanged.bind(this)}setConfig(e){this.config={type:e?.type||"custom:bubble-room",...e||{}},this.requestUpdate()}set value(e){this.config=e||{}}get value(){return this.config}connectedCallback(){super.connectedCallback(),this.addEventListener("panel-changed",this._onPanelChanged),this.addEventListener("__panel_cmd__",this._onPanelCmd)}disconnectedCallback(){this.removeEventListener("panel-changed",this._onPanelChanged),this.removeEventListener("__panel_cmd__",this._onPanelCmd),super.disconnectedCallback()}_emitConfig(e){const t={type:this.config?.type||"custom:bubble-room",...e||{}};this.config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this.config},bubbles:!0,composed:!0})),this.requestUpdate()}_setConfigValue(e,t){const i=String(e).split("."),o=structuredClone(this.config||{});let s=o;for(let e=0;e<i.length-1;e++){const t=i[e];"object"==typeof s[t]&&null!==s[t]||(s[t]={}),s=s[t]}s[i[i.length-1]]=t,this._emitConfig(o)}_onPanelChanged(e){e.stopPropagation();const{prop:t,val:i}=e.detail||{};if(!t)return;const o=this.config,s=structuredClone(o||{}),n=String(t).split(".");let a=s;for(let e=0;e<n.length-1;e++){const t=n[e];"object"==typeof a[t]&&null!==a[t]||(a[t]={}),a=a[t]}a[n[n.length-1]]=i;const r="area"===t,l=t.startsWith("auto_discovery_sections."),c=r||l?_e(this.hass,s,t,!1):s;this._emitConfig(c)}_onConfigChanged(e){e.stopPropagation();const{path:t,value:i}=e.detail||{};if(!t)return;const o=this.config,s=structuredClone(o||{}),n=String(t).split(".");let a=s;for(let e=0;e<n.length-1;e++){const t=n[e];"object"==typeof a[t]&&null!==a[t]||(a[t]={}),a=a[t]}a[n[n.length-1]]=i;const r="area"===t,l=t.startsWith("auto_discovery_sections."),c=r||l?_e(this.hass,s,t,!1):s;this._emitConfig(c)}_onPanelCmd(e){e.stopPropagation();const{cmd:t,section:i}=e.detail||{};if("reset"!==t)return;let o=this.config||{};switch(i){case"room":o=function(e){const t={...e.entities||{}};delete t.presence;const i={...e,entities:t};return delete i.name,delete i.icon,delete i.area,delete i.presence_entity,i}(o);break;case"sensors":o=function(e){const t={...e.entities||{}};return["sensor1","sensor2","sensor3","sensor4","sensor5","sensor6","sensor7","sensor8"].forEach(e=>delete t[e]),{...e,entities:t}}(o);break;case"mushrooms":o=function(e){const t={...e.entities||{}};return["mushroom1","mushroom2","mushroom3","mushroom4","mushroom5","climate","camera"].forEach(e=>delete t[e]),{...e,entities:t}}(o);break;case"subbuttons":o=function(e){const t={...e.entities||{}};return["sub-button1","sub-button2","sub-button3","sub-button4","sub-button5","sub-button6"].forEach(e=>delete t[e]),{...e,entities:t}}(o);break;case"climate":o=function(e){const t={...e.entities||{}};return delete t.climate,{...e,entities:t}}(o);break;case"camera":o=function(e){const t={...e.entities||{}};return delete t.camera,{...e,entities:t}}(o);break;default:return}const s=o?.auto_discovery_sections||{};(s.sensor||s.mushroom||s.subbutton||s.presence||s.climate||s.camera)&&(o=_e(this.hass,o,void 0,!1)),this._emitConfig(o)}_togglePanel(e,t){const i=e?.detail?.expanded;this.openPanel=i?t:""}static styles=n`
    :host { display:block; }
    .editor-grid {
  ...
  `;render(){const e=this.config||{};return j`
    ...
    `}}customElements.define("bubble-room-editor",De);var He=Object.freeze({__proto__:null,BubbleRoomEditor:De});function Be({holdThreshold:e=500,onTap:t,onHold:i}={}){let o,s=null,n=!1;function a(){null!==s&&(clearTimeout(s),s=null)}return{onDown:function(t){n=!1,o=t,a(),s=setTimeout(()=>{n=!0,s=null,i?.(o)},e)},onUp:function(e){a(),n?n=!1:void 0!==e&&void 0!==o&&e!==o||t?.(void 0!==e?e:o)},onCancel:function(){a(),n=!1,o=void 0},clearTimer:a}}let Le=null,Ue=null;function We(e){if(!e||"string"!=typeof e||e.startsWith("var("))return null;const t=Ue||("undefined"==typeof document?null:(Le=document.createElement("canvas"),Le.width=Le.height=1,Ue=Le.getContext("2d",{willReadFrequently:!0})||Le.getContext("2d"),Ue));if(!t)return null;try{t.fillStyle="#000",t.fillStyle=e}catch{return null}const i=t.fillStyle;t.clearRect(0,0,1,1),t.fillStyle=i,t.fillRect(0,0,1,1);const[o,s,n,a]=t.getImageData(0,0,1,1).data;return{r:o,g:s,b:n,a:a/255}}class Ve extends oe{static properties={subbuttons:{type:Array},preset:{type:String,reflect:!0}};constructor(){super(),this.subbuttons=[],this.preset="liquid-glass",this._gesture=Be({onTap:e=>this._fireHassAction(e,"tap"),onHold:e=>this._fireHassAction(e,"hold")})}static styles=n`
    :host {
      display: block;
      height: 100%;
      width: 100%;
  ...
  `;render(){return"standard"===this.preset?this._renderStandard():this._renderLiquidGlass()}_renderStandard(){return j`
      <div class="container">
        ${this.subbuttons.map((e,t)=>{const i=e.active?e.colorOn:e.colorOff,o=e.active?e.iconOn:e.iconOff;return j`
            <div
              class="sub-button"
    ...
    `}_renderLiquidGlass(){return j`
      <div class="container">
        ${this.subbuttons.map((e,t)=>{const i=e.active?e.colorOn:e.colorOff,o=e.active?e.iconOn:e.iconOff,s=this._computeGlassColors(i,e.active),n=[],a=this._computeIconTone(o,e.active);if(a&&n.push(`--bubble-subbutton-color:${a}`),s)n.push(`--bubble-subbutton-bg:${s.surface}`),n.push(`--bubble-subbutton-glow:${s.glow}`),n.push(`--bubble-subbutton-glass-base:${s.base}`),n.push(`--bubble-subbutton-glass-highlight:${s.highlight}`),n.push(`--bubble-subbutton-glass-soft:${s.soft}`),n.push(`--bubble-subbutton-glass-sheen:${s.sheen}`),n.push(`--bubble-subbutton-glass-accent:${s.accent}`),n.push(`--bubble-subbutton-tint:${s.rgb}`),n.push(`--bubble-subbutton-glass-shadow:${s.shadow}`),n.push(`--bubble-subbutton-glass-shadow-hover:${s.shadowHover}`),n.push(`--bubble-subbutton-glass-shadow-active:${s.shadowActive}`),n.push(`--bubble-subbutton-glass-shadow-rgb:${s.shadowRgb}`);else if(i){const t=e.active?this._lightenColor(i,.35):null;n.push(`--bubble-subbutton-bg:${t||i}`)}const r=this._computeBorderColors(o,e.active);r?(n.push(`--bubble-subbutton-border:${r.base}`),n.push(`--bubble-subbutton-border-hover:${r.hover}`),n.push(`--bubble-subbutton-border-active:${r.active}`)):o&&(n.push(`--bubble-subbutton-border:${o}`),n.push(`--bubble-subbutton-border-hover:${o}`),n.push(`--bubble-subbutton-border-active:${o}`));const l=this._computeGlowPalette(o,e.active);l?(n.push(`--bubble-subbutton-glass-glow:${l.glow}`),n.push(`--bubble-subbutton-glass-rim:${l.rim}`),n.push(`--bubble-subbutton-glass-rim-soft:${l.rimSoft}`),n.push(`--bubble-subbutton-glass-rim-shadow:${l.rimShadow}`)):o&&(n.push(`--bubble-subbutton-glass-glow:${o}`),n.push(`--bubble-subbutton-glass-rim:${o}`),n.push(`--bubble-subbutton-glass-rim-soft:${o}`),n.push(`--bubble-subbutton-glass-rim-shadow:${o}`)),e.active&&(n.push("--bubble-subbutton-saturation:1.15"),n.push("--bubble-subbutton-luminance:1.04"),n.push("--bubble-subbutton-icon-brightness:1.25"),n.push("--bubble-subbutton-icon-saturation:1.15"));const c=n.join(";"),d=["sub-button"];e.active&&d.push("is-active");const u=e.active?this._getAnimClass(e.icon):"";return u&&d.push(u),j`
            <div
              class="${d.join(" ")}"
              style="${c}"
              @pointerdown=${()=>this._onDown(t)}
    ...
    `}_getAnimClass(e){const t=(e||"").toLowerCase();return t.includes("cctv")||t.includes("camera")||t.includes("webcam")||t.includes("doorbell")||t.includes("telescope")||t.includes("binoculars")?"anim-scan":t.includes("fan")||t.includes("propeller")||t.includes("turbine")||t.includes("ceiling-fan")||t.includes("wind-turbine")||t.includes("rotate")||t.includes("reload")||t.includes("refresh")||t.includes("sync")||t.includes("disc")||t.includes("record")||t.includes("vinyl")||t.includes("wheel")||t.includes("circular")?"anim-spin":t.includes("lightbulb")||t.includes("lamp")||t.includes("bulb")||t.includes("chandelier")||t.includes("led")||t.includes("ceiling-light")||t.includes("floor-lamp")||t.includes("desk-lamp")||t.includes("string-lights")||t.includes("spotlight")||t.includes("torch")||t.includes("flashlight")||t.includes("candle")||t.includes("fire")||t.includes("flame")||t.includes("lantern")||t.includes("strip-lights")||t.includes("wall-sconce")?"anim-illuminate":t.includes("bell")||t.includes("alarm")||t.includes("siren")||t.includes("alert")||t.includes("smoke")||t.includes("leak")||t.includes("vibrate")||t.includes("shield-alert")||t.includes("warning")||t.includes("flood")||t.includes("door-open")||t.includes("window-open")||t.includes("water-alert")||t.includes("hazard")?"anim-alarm":t.includes("motion")||t.includes("walk")||t.includes("run")||t.includes("human")||t.includes("account")||t.includes("presence")||t.includes("wifi")||t.includes("bluetooth")||t.includes("signal")||t.includes("broadcast")||t.includes("antenna")||t.includes("eye")||t.includes("network")||t.includes("access-point")||t.includes("blink")?"anim-blink":t.includes("speaker")||t.includes("music")||t.includes("audio")||t.includes("subwoofer")||t.includes("headphone")||t.includes("headset")||t.includes("microphone")||t.includes("heart")||t.includes("waveform")||t.includes("equalizer")||t.includes("radio")||t.includes("podcast")||t.includes("piano")||t.includes("guitar")||t.includes("drum")||t.includes("pump")||t.includes("pacemaker")?"anim-beat":t.includes("washing")||t.includes("dishwasher")||t.includes("dryer")||t.includes("tumble")||t.includes("blender")||t.includes("mixer")||t.includes("vacuum")||t.includes("robot")||t.includes("drill")||t.includes("wrench")||t.includes("hammer")||t.includes("gamepad")||t.includes("joystick")||t.includes("vibration")?"anim-shake":t.includes("dog")||t.includes("cat")||t.includes("bird")||t.includes("pet")||t.includes("paw")||t.includes("rabbit")||t.includes("fish")||t.includes("bee")||t.includes("butterfly")||t.includes("emoticon")||t.includes("balloon")||t.includes("ball")||t.includes("basketball")||t.includes("soccer")||t.includes("football")?"anim-bounce":""}_onDown(e){this._gesture.onDown(e)}_onUp(e){this._gesture.onUp(e)}_clearHoldTimer(){this._gesture.clearTimer()}_lightenColor(e,t=.3){const i=this._colorToRgb(e);if(!i)return null;const o=Math.min(Math.max(t,0),1),s=this._mixWithWhite(i,o),n="number"==typeof i.a?Math.min(Math.max(Number(i.a.toFixed(3)),0),1):1;return n<1?`rgba(${s.r}, ${s.g}, ${s.b}, ${n})`:`rgb(${s.r}, ${s.g}, ${s.b})`}_computeGlassColors(e,t=!1){const i=this._colorToRgb(e);if(!i)return null;const o=t?this._boostColorIntensity(i,.42):i,{r:s,g:n,b:a}=o,r=`${s}, ${n}, ${a}`,l=this._mixWithWhite(o,t?.14:.28),c=`${l.r}, ${l.g}, ${l.b}`,d=t?{surface:.42,base:.3,highlight:.38,soft:.26,sheen:.48,accent:.2,glow:.55,border:.42,borderHover:.52,borderActive:.48,shadow:.2,shadowHover:.28,shadowActive:.24,rim:.72,rimSoft:.34,rimShadow:.4}:{surface:.22,base:.16,highlight:.24,soft:.14,sheen:.3,accent:.1,glow:.38,border:.18,borderHover:.26,borderActive:.22,shadow:.08,shadowHover:.12,shadowActive:.1,rim:.38,rimSoft:.14,rimShadow:.26},u=`rgba(${c}, ${d.surface})`,p=`rgba(${c}, ${d.base})`,h=`rgba(${c}, ${d.highlight})`,b=`rgba(${c}, ${d.soft})`,m=`rgba(${c}, ${d.sheen})`,g=`rgba(${c}, ${d.accent})`,f=`rgba(${c}, ${d.border})`,_=`rgba(${c}, ${d.borderHover})`,v=`rgba(${c}, ${d.borderActive})`,y=`${Math.max(0,Math.round(.2*s))}, ${Math.max(0,Math.round(.2*n))}, ${Math.max(0,Math.round(.2*a))}`;return{rgb:r,surface:u,base:p,highlight:h,soft:b,sheen:m,accent:g,shadow:`rgba(${y}, ${d.shadow})`,shadowHover:`rgba(${y}, ${d.shadowHover})`,shadowActive:`rgba(${y}, ${d.shadowActive})`,shadowRgb:y,border:f,borderHover:_,borderActive:v,glow:`rgba(${c}, ${d.glow})`,rim:`rgba(${c}, ${d.rim})`,rimSoft:`rgba(${c}, ${d.rimSoft})`,rimShadow:`rgba(${y}, ${d.rimShadow})`}}_computeBorderColors(e,t=!1){const i=this._colorToRgb(e);if(!i)return null;const o=t?.78:.62,s=t?.88:.78,n=t?.82:.7;return{base:`rgba(${i.r}, ${i.g}, ${i.b}, ${o})`,hover:`rgba(${i.r}, ${i.g}, ${i.b}, ${s})`,active:`rgba(${i.r}, ${i.g}, ${i.b}, ${n})`}}_computeGlowPalette(e,t=!1){const i=this._colorToRgb(e);if(!i)return null;const o=t?this._boostColorIntensity(i,.4):i,s=this._mixWithWhite(o,t?.34:.58),n=`${s.r}, ${s.g}, ${s.b}`;return{glow:`rgba(${n}, ${t?.55:.3})`,rim:`rgba(${n}, ${t?.74:.48})`,rimSoft:`rgba(${n}, ${t?.34:.2})`,rimShadow:`rgba(${`${Math.max(0,Math.round(.2*o.r))}, ${Math.max(0,Math.round(.2*o.g))}, ${Math.max(0,Math.round(.2*o.b))}`}, ${t?.42:.26})`}}_computeIconTone(e,t=!1){if(!e)return e;const i=this._colorToRgb(e);if(!i)return e;if(!t)return this._rgbToCss({r:i.r,g:i.g,b:i.b},i.a);const o=this._boostColorIntensity(i,.35),s=this._mixWithWhite(o,.2);return this._rgbToCss(s,i.a)}_mixWithWhite({r:e,g:t,b:i},o=.5){const s=Math.min(Math.max(o,0),1),n=e=>Math.round(e+(255-e)*s);return{r:n(e),g:n(t),b:n(i)}}_boostColorIntensity({r:e,g:t,b:i,a:o},s=.18){const n=1+Math.max(s,0),a=e=>Math.min(255,Math.round(e*n)),r={r:a(e),g:a(t),b:a(i)};return"number"==typeof o&&(r.a=o),r}_rgbToCss({r:e,g:t,b:i},o=1){const s="number"==typeof o?Math.min(Math.max(Number(o.toFixed(3)),0),1):1;return s<1?`rgba(${e}, ${t}, ${i}, ${s})`:`rgb(${e}, ${t}, ${i})`}_colorToRgb(e){return We(e)}_fireHassAction(e,t){const i=this.subbuttons?.[e];if(!i||!i.entity_id)return;const o={entity:i.entity_id,tap_action:i.tap_action||{action:"toggle"},hold_action:i.hold_action||{action:"more-info"}},s=new Event("hass-action",{bubbles:!0,composed:!0});s.detail={config:o,action:t},this.dispatchEvent(s)}}Ve._colorCanvas=null,Ve._colorCtx=null,customElements.define("bubble-subbutton",Ve);class Je extends oe{static properties={hass:{type:Object},name:{type:String},area:{type:String},config:{type:Object},container:{type:Object},fitMode:{type:String},preset:{type:String,reflect:!0}};get stretchY(){return"liquid-glass"===this.preset?1.4:1.3}constructor(){super(),this.name="",this.fitMode="both",this.preset="standard",this._raf=null,this._resizeObs=null,this._lastScale=null,this._lastBox=null,this._scaling=!1}_ensureFonts(){const e=this.renderRoot||this.shadowRoot;if(!e)return;if(e.querySelector('link[data-bubble-fonts="1"]'))return;const t=document.createElement("link");t.rel="preconnect",t.href="https://fonts.gstatic.com",t.crossOrigin="anonymous",t.setAttribute("data-bubble-fonts","1"),e.appendChild(t);const i=document.createElement("link");i.rel="stylesheet",i.href="https://fonts.googleapis.com/css2?family=Big+Shoulders+Display:wght@900&family=Bebas+Neue&family=Barlow+Condensed:wght@900&family=Oswald:wght@700&display=swap",i.setAttribute("data-bubble-fonts","1"),i.addEventListener("load",()=>{requestAnimationFrame(()=>this._scheduleScale())}),e.appendChild(i)}firstUpdated(){this._ensureFonts(),this._scheduleScale(),this._resizeObs=new ResizeObserver(e=>{if(this._scaling)return;const t=e[0];let i=0,o=0;if(t?.contentBoxSize){const e=Array.isArray(t.contentBoxSize)?t.contentBoxSize[0]:t.contentBoxSize;i=Math.round(e.inlineSize),o=Math.round(e.blockSize)}else{const e=this.getBoundingClientRect();i=Math.round(e.width),o=Math.round(e.height)}(!this._lastBox||Math.abs(i-this._lastBox.w)>2||Math.abs(o-this._lastBox.h)>2)&&(this._lastBox={w:i,h:o},this._scheduleScale())}),this._resizeObs.observe(this),window.addEventListener("resize",this._scheduleScale,{passive:!0})}updated(e){(e.has("name")||e.has("config")||e.has("container")||e.has("fitMode")||e.has("preset"))&&this._scheduleScale()}disconnectedCallback(){super.disconnectedCallback(),this._resizeObs?.disconnect(),window.removeEventListener("resize",this._scheduleScale)}_scheduleScale=()=>{this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=null,this._autoScaleFont()}))};_autoScaleFont(){const e=this.renderRoot.querySelector(".bubble-name"),t=this.container||this.parentElement||this;if(!e||!t)return;const i=this.name??"",o=Math.max(0,Math.round(t.clientWidth)),s=Math.max(0,Math.round(t.clientHeight)),n=this.stretchY;if(this._lastScale&&this._lastScale.text===i&&this._lastScale.w===o&&this._lastScale.h===s&&this._lastScale.fitMode===this.fitMode&&this._lastScale.preset===this.preset)return;this._scaling=!0,e.style.fontSize="10px",e.style.transform="none";const a=300,r=n>1?Math.round(s/n):s;let l;if("height"===this.fitMode){let t=8,i=a;for(let o=0;o<10&&t<=i;o++){const o=t+i>>1;e.style.fontSize=`${o}px`,e.scrollHeight<=r?t=o+1:i=o-1}l=Math.max(8,Math.min(a,i)),e.style.fontSize=`${l}px`;const s=e.scrollWidth;s>o&&s>0&&(l=Math.floor(l*(o/s)))}else{let t=8,i=a;for(let s=0;s<10&&t<=i;s++){const s=t+i>>1;e.style.fontSize=`${s}px`,e.scrollWidth<=o&&e.scrollHeight<=r?t=s+1:i=s-1}l=Math.max(8,Math.min(a,i))}e.style.fontSize=`${l}px`,1!==n?(e.style.transform=`scaleY(${n})`,e.style.transformOrigin="center"):e.style.transform="none",this._lastScale={text:i,w:o,h:s,fitMode:this.fitMode,preset:this.preset},this._scaling=!1}render(){return j`
  ...
  `}customElements.define("bubble-name",Je);class Ye extends oe{static properties={sensors:{type:Array},preset:{type:String,reflect:!0}};constructor(){super(),this.sensors=[],this.preset="standard",this.rows=1,this.columns=1,this._resizeObserver=null,this._resizeScheduled=!1,this._autoscaleScheduled=!1,this._lastBox={w:0,h:0},this._pillCache=new WeakMap,this._pendingChanged=null,this._sharedSize=new Map}connectedCallback(){super.connectedCallback(),this._updateLayout(),this._sharedSize.clear(),this._scheduleAutoscale(),this._resizeObserver=new ResizeObserver(e=>{const t=e[0];let i=0,o=0;if(t&&t.contentBoxSize){const e=Array.isArray(t.contentBoxSize)?t.contentBoxSize[0]:t.contentBoxSize;i=Math.round(e.inlineSize),o=Math.round(e.blockSize)}else{const e=this.getBoundingClientRect();i=Math.round(e.width),o=Math.round(e.height)}(Math.abs(i-this._lastBox.w)>2||Math.abs(o-this._lastBox.h)>2)&&(this._lastBox={w:i,h:o},this._sharedSize.clear(),this._scheduleAutoscale())}),this._resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect(),this._resizeObserver=null}updated(e){if(e.has("sensors")){const t=e.get("sensors")||[];this._updateLayout(),this._sharedSize.clear();const i=this._diffChangedSensorIndices(t,this.sensors);if(0===i.size)return;this._scheduleAutoscale(i)}}_updateLayout(){const e=this.sensors?.length||0;this.rows=e>5?2:1,this.columns=e>5?5:e||1}_scheduleAutoscale(e=null){this._autoscaleScheduled?this._pendingChanged=this._mergeChanged(this._pendingChanged,e):(this._pendingChanged=this._mergeChanged(this._pendingChanged,e),this._autoscaleScheduled=!0,requestAnimationFrame(()=>{this._autoscaleScheduled=!1;const e=this._pendingChanged;this._pendingChanged=null,this._autoScaleValues(e)}))}_mergeChanged(e,t){if(!e&&!t)return null;if(!e)return t instanceof Set?new Set(t):null;if(!t)return e instanceof Set?new Set(e):null;const i=new Set(e);for(const e of t)i.add(e);return i}_keyForPill(e){return`${Math.round(e.clientWidth)||0}x${Math.round(e.clientHeight)||0}|u:${!!e.querySelector(".sensor-unit")?.textContent?.trim()?"1":"0"}|l:${!!e.querySelector(".sensor-label")?.textContent?.trim()?"1":"0"}|i:${!!e.querySelector(".sensor-icon")?"1":"0"}`}_textWeight(e){const t=t=>e.querySelector(t)?.textContent??"",i=t(".sensor-value"),o=t(".sensor-unit"),s=t(".sensor-label");return i.length+.8*o.length+1.1*s.length}_measureAndApply(e){this._fitValueAndUnit(e);const t=e.querySelector(".sensor-value"),i=e.querySelector(".sensor-unit"),o=e.querySelector(".sensor-label"),s=e.querySelector(".sensor-icon"),n=parseFloat(getComputedStyle(t).fontSize)||10;return{best:n,unit:i?parseFloat(getComputedStyle(i).fontSize)||Math.round(.5*n):0,label:o?parseFloat(getComputedStyle(o).fontSize)||Math.round(.5*n):0,icon:s?parseFloat(getComputedStyle(s).fontSize)||Math.round(.5*n):0}}_applySharedSize(e,t){const i=e.querySelector(".sensor-value"),o=e.querySelector(".sensor-unit"),s=e.querySelector(".sensor-label"),n=e.querySelector(".sensor-icon");i&&(i.style.fontSize=`${t.best}px`,o&&(o.style.fontSize=`${t.unit}px`),s&&(s.style.fontSize=`${t.label}px`),n&&(n.style.fontSize=`${t.icon}px`),this._pillCache.set(e,{text:i.textContent??"",unitText:o?o.textContent??"":"",labelTxt:s?s.textContent??"":"",iconName:n?.getAttribute("icon")||n?.icon||"",boxW:Math.round(e.clientWidth),boxH:Math.round(e.clientHeight),best:t.best}))}_autoScaleValues(e=null){const t=this.renderRoot?.querySelectorAll(".sensor-pill");if(!t?.length)return;const i=e?Array.from(e).map(e=>t[e]).filter(Boolean):Array.from(t);if(!i.length)return;const o=new Map;for(const e of i){const t=this._keyForPill(e);o.has(t)||o.set(t,[]),o.get(t).push(e)}for(const[e,t]of o.entries()){const i=this._sharedSize.get(e);if(i){for(const e of t)this._applySharedSize(e,i);continue}let o=t[0],s=this._textWeight(o);for(let e=1;e<t.length;e++){const i=this._textWeight(t[e]);i>s&&(s=i,o=t[e])}const n=this._measureAndApply(o);this._sharedSize.set(e,n);for(const e of t)e!==o&&this._applySharedSize(e,n)}}_fitValueAndUnit(e){const t=e.querySelector(".sensor-value"),i=e.querySelector(".sensor-unit"),o=e.querySelector(".sensor-label"),s=e.querySelector(".sensor-icon");if(!t)return;const n=t.textContent??"",a=i?i.textContent??"":"",r=o?o.textContent??"":"",l=s?.getAttribute("icon")||s?.icon||"",c=Math.round(e.clientWidth),d=Math.round(e.clientHeight);if(c<=0||d<=0)return;const u=this._pillCache.get(e);if(u&&u.text===n&&u.unitText===a&&u.labelTxt===r&&u.iconName===l&&u.boxW===c&&u.boxH===d)return;t.style.fontSize="",i&&(i.style.fontSize=""),o&&(o.style.fontSize=""),s&&(s.style.fontSize="");const p=Math.max(0,c-7),h=Math.max(0,d-0);if(0===p||0===h)return;let b=5,m=Math.min(40,h),g=b;for(let e=0;e<8&&b<=m;e++){const e=b+m>>1;t.style.fontSize=`${e}px`,i&&(i.style.fontSize=`${Math.max(5,Math.round(.7*e))}px`),o&&(o.style.fontSize=`${Math.max(5,Math.round(.7*e))}px`),s&&(s.style.fontSize=`${Math.max(5,Math.round(.7*e))}px`);const n=t.offsetWidth,a=t.offsetHeight,r=i?i.offsetWidth:0,l=i?i.offsetHeight:0,c=o?o.offsetWidth:0,d=o?o.offsetHeight:0,u=s?s.offsetWidth:0,f=s?s.offsetHeight:0,_=(u>0?u:0)+c+n+(r>0?1+r:0),v=Math.max(f,d,a,l);_<=p&&v<=h?(g=e,b=e+1):m=e-1}t.style.fontSize=`${g}px`,i&&(i.style.fontSize=`${Math.max(5,Math.round(.7*g))}px`),o&&(o.style.fontSize=`${Math.max(5,Math.round(.7*g))}px`),s&&(s.style.fontSize=`${Math.max(5,Math.round(.7*g))}px`),this._pillCache.set(e,{text:n,unitText:a,labelTxt:r,iconName:l,boxW:c,boxH:d,best:g})}_formatValueForCompare(e){if(null==e)return"--";let t=null;if("number"==typeof e)t=e;else if("string"==typeof e){const i=e.replace(",",".").match(/-?\d+(?:\.\d+)?/);i&&(t=Number(i[0]))}return Number.isFinite(t)?Number.isInteger(t)?String(t):t.toFixed(1):String(e).trim().replace(/\s+/g," ")}_formatValueForDisplay(e,t=1,i=!0){if(null==e)return"--";if("number"==typeof e&&Number.isFinite(e))return i&&Number.isInteger(e)?String(e):e.toFixed(t);if("string"==typeof e){const o=e.replace(",",".").match(/-?\d+(?:\.\d+)?/);if(o){const e=Number(o[0]);if(Number.isFinite(e))return i&&Number.isInteger(e)?String(e):e.toFixed(t)}return e.trim()}return String(e)}_getSensorKey(e,t){return e?.entity||e?.entity_id||`idx:${t}`}_diffChangedSensorIndices(e=[],t=[]){const i=new Set;if((e?.length||0)!==(t?.length||0)){for(let e=0;e<(t?.length||0);e++)i.add(e);return i}const o=new Map(t.map((e,t)=>[this._getSensorKey(e,t),t]));return e.forEach((e,s)=>{const n=this._getSensorKey(e,s),a=o.get(n);if(void 0===a)return void(s<t.length&&i.add(s));const r=t[a];([e?.label??"",this._formatValueForCompare(e?.value),e?.unit??""].join("|")!==[r?.label??"",this._formatValueForCompare(r?.value),r?.unit??""].join("|")||(e?.icon??"")!==(r?.icon??"")||(e?.device_class??"")!==(r?.device_class??"")||(e?.color??"")!==(r?.color??""))&&i.add(a)}),i}_openMoreInfo(e){if(!e||"string"!=typeof e)return;const t=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:e}});(document.querySelector("home-assistant")||this).dispatchEvent(t)}static styles=n`
    :host {
      display: block;
      height: 100%;
      width: 100%;
  ...
  `;render(){const e=(this.sensors||[]).map(e=>{const t=e.device_class,i=Pe[t]||{},o=i.emoji||"❓",s=e.unit||i.units?.[0]||"",n=this._formatValueForDisplay(e.value,1,!0);return{...e,value:n,label:o,unit:s}});return j`
      <div
        class="sensor-grid"
        style="
        ...
        "
      >
        ${e.map(e=>{const t=e.entity||e.entity_id||"",i=t?`Show history graph: ${t}`:"Show history graph";return j`
            <div
              class="sensor-pill"
    ...
    `}}customElements.define("bubble-sensor",Ye);class Ge extends oe{static properties={entities:{type:Array},preset:{type:String,reflect:!0}};constructor(){super(),this.entities=[],this.preset="standard",this._containerSize={width:0,height:0},this._rafSize=null,this._ripplingKeys=new Set,this._ro=new ResizeObserver(e=>{const t=e[0]?.contentRect;t&&(this._rafSize&&cancelAnimationFrame(this._rafSize),this._rafSize=requestAnimationFrame(()=>{const e=Math.round(t.width),i=Math.round(t.height);e===this._containerSize.width&&i===this._containerSize.height||(this._containerSize={width:e,height:i},this.requestUpdate())}))}),this._lastTapTs=0,this._gesture=Be({onTap:e=>this._handleTap(e),onHold:e=>this._dispatchAction(e,"hold")})}connectedCallback(){super.connectedCallback(),this._ro.observe(this)}disconnectedCallback(){this._ro.disconnect(),super.disconnectedCallback()}_getAnimClass(e){const t=(e?.icon||"").toLowerCase();return"camera"===(e?.kind||"")||t.includes("cctv")||t.includes("camera")||t.includes("webcam")||t.includes("doorbell")||t.includes("video-input")||t.includes("telescope")||t.includes("binoculars")?"anim-scan":t.includes("fan")||t.includes("propeller")||t.includes("turbine")||t.includes("ceiling-fan")||t.includes("wind-turbine")||t.includes("rotate")||t.includes("reload")||t.includes("refresh")||t.includes("sync")||t.includes("loading")||t.includes("radar")||t.includes("disc")||t.includes("record")||t.includes("vinyl")||t.includes("tire")||t.includes("wheel")||t.includes("circular")?"anim-spin":t.includes("lightbulb")||t.includes("lamp")||t.includes("bulb")||t.includes("chandelier")||t.includes("led")||t.includes("ceiling-light")||t.includes("floor-lamp")||t.includes("desk-lamp")||t.includes("string-lights")||t.includes("wall-sconce")||t.includes("spotlight")||t.includes("torch")||t.includes("flashlight")||t.includes("candle")||t.includes("fire")||t.includes("flame")||t.includes("lantern")||t.includes("lava-lamp")||t.includes("neon")||t.includes("light-recessed")||t.includes("strip-lights")?"anim-illuminate":t.includes("bell")||t.includes("alarm")||t.includes("siren")||t.includes("alert")||t.includes("smoke")||t.includes("fire-alert")||t.includes("water-alert")||t.includes("leak")||t.includes("vibrate")||t.includes("shield-alert")||t.includes("hazard")||t.includes("warning")||t.includes("flood")||t.includes("door-open")||t.includes("window-open")?"anim-alarm":t.includes("motion")||t.includes("walk")||t.includes("run")||t.includes("human")||t.includes("account")||t.includes("presence")||t.includes("radar")||t.includes("wifi")||t.includes("bluetooth")||t.includes("signal")||t.includes("broadcast")||t.includes("antenna")||t.includes("led-on")||t.includes("blink")||t.includes("eye")||t.includes("pulse")||t.includes("network")||t.includes("access-point")?"anim-blink":t.includes("speaker")||t.includes("music")||t.includes("audio")||t.includes("subwoofer")||t.includes("headphone")||t.includes("headset")||t.includes("microphone")||t.includes("heart")||t.includes("pulse")||t.includes("waveform")||t.includes("equalizer")||t.includes("radio")||t.includes("podcast")||t.includes("piano")||t.includes("guitar")||t.includes("trumpet")||t.includes("violin")||t.includes("drum")||t.includes("pump")||t.includes("hydraulic")||t.includes("pacemaker")?"anim-beat":t.includes("washing")||t.includes("dishwasher")||t.includes("dryer")||t.includes("tumble")||t.includes("blender")||t.includes("mixer")||t.includes("robot-vacuum")||t.includes("vacuum")||t.includes("robot")||t.includes("drill")||t.includes("saw")||t.includes("hammer")||t.includes("wrench")||t.includes("vibration")||t.includes("controller")||t.includes("gamepad")||t.includes("joystick")?"anim-shake":t.includes("dog")||t.includes("cat")||t.includes("bird")||t.includes("pet")||t.includes("paw")||t.includes("rabbit")||t.includes("fish")||t.includes("turtle")||t.includes("horse")||t.includes("cow")||t.includes("pig")||t.includes("bee")||t.includes("butterfly")||t.includes("bug")||t.includes("spider")||t.includes("emoticon")||t.includes("sticker")||t.includes("balloon")||t.includes("ball")||t.includes("basketball")||t.includes("soccer")||t.includes("football")||t.includes("tennis")||t.includes("volleyball")?"anim-bounce":""}_updateSize(){const e=this.getBoundingClientRect();this._containerSize={width:e.width,height:e.height},this.requestUpdate()}_handleClick(e){this.dispatchEvent(new CustomEvent("hass-action",{detail:{config:{entity:e.entity_id,tap_action:e.tap_action||{action:"toggle"},hold_action:e.hold_action||{action:"more-info"}},action:"tap"},bubbles:!0,composed:!0}))}_dispatchAction(e,t){const i={entity:e.entity_id||e.entity||e,tap_action:e.tap_action||{action:"toggle"},hold_action:e.hold_action||{action:"more-info"},double_tap_action:e.double_tap_action};this.dispatchEvent(new CustomEvent("hass-action",{detail:{config:i,action:t},bubbles:!0,composed:!0}))}_onPointerDown(e,t){e.preventDefault();const i=t.entity_id||t.kind||"unknown";this._ripplingKeys.add(i),this.requestUpdate(),setTimeout(()=>{this._ripplingKeys.delete(i),this.requestUpdate()},500),this._gesture.onDown(t)}_onPointerUp(e,t){e.preventDefault(),this._gesture.onUp(t)}_onPointerCancel(){this._gesture.onCancel()}_handleTap(e){const t=Date.now();if(e?.double_tap_action&&t-this._lastTapTs<300)return this._lastTapTs=0,void this._dispatchAction(e,"double_tap");this._lastTapTs=t,setTimeout(()=>{Date.now()-this._lastTapTs>=280&&this._dispatchAction(e,"tap")},280)}static styles=n`
    :host {
      display: block;
      width: 100%;
      height: 100%;
  ...
  `;render(){const{width:e,height:t}=this._containerSize;if(!e||!t)return j``;const i=window.innerWidth||e,o=.55;let s;if(i<=100)s=o;else if(i>=200)s=.25;else{s=o+(.25-o)*((i-100)/100)}const n=Math.min(e,1.6*t),a=.5*(t+n)*s,r=.6*e,l=.6*t,c=r*Math.min(1,e/(2*r)),d=l*Math.min(1,t/(2*l)),u=e-c,p=.5*t,h=Math.max(0,c-a/2-1),b=Math.max(0,d-a/2-1),m=e=>Math.PI*e/180,g=m(30),f=m(85),_=.75*a,v=.75*a,y=[{x:a/2+1,y:a/2+1},{x:u+h*Math.cos(-f),y:p+b*Math.sin(-f)},{x:u+h*Math.cos(-g),y:p+b*Math.sin(-g)},{x:u+h*Math.cos(+g),y:p+b*Math.sin(+g)},{x:u+h*Math.cos(+f),y:p+b*Math.sin(+f)}];let x=0;return j`
      ${this.entities.map(i=>{const o="camera"===i?.kind,s="climate"===i?.kind,n=o?_:s?v:a,r=.95*n;let l;o?l={x:e-n/2,y:n/2}:s?l={x:n/2+1,y:t-n/2-1}:(l=y[Math.min(x,y.length-1)]??{x:u,y:p},x++);const c=o||s?0:i.dx??0,d=o||s?0:i.dy??0,h=l.x+c,b=l.y+d,m=i.entity_id||i.kind||"unknown",g=this._ripplingKeys.has(m),f=i.active?this._getAnimClass(i):"",$="liquid-glass"===this.preset?i.active?`is-active ${f}`:"is-inactive":"";return j`
          <div
          ...
          >
            ...
            <ha-icon icon="${i.icon||ke(i.entity_id,this.hass)}" style="--mdc-icon-size:${r}px;"></ha-icon>
          </div>
        `})}
    `}}customElements.define("bubble-mushroom",Ge);class Ke extends oe{static properties={icon:{type:String},active:{type:Boolean},colorActive:{type:String},colorInactive:{type:String},backgroundActive:{type:String},backgroundInactive:{type:String},preset:{type:String,reflect:!0},entity_id:{type:String},tap_action:{type:Object},hold_action:{type:Object}};constructor(){super(),this.icon="",this.active=!1,this.colorActive="#21df73",this.colorInactive="#173c16",this.backgroundActive="rgba(33,223,115,0.1)",this.backgroundInactive="rgba(23,60,22,0.1)",this.preset="standard",this.entity_id="",this.tap_action={action:"more-info"},this.hold_action={action:"none"},this._gesture=Be({onTap:()=>this._fireHassAction("tap"),onHold:()=>this._fireHassAction("hold")})}static styles=n`
    :host {
      position: absolute;
      display: block;
      inset: 0;
  ...
  `;render(){const e=this.active?this.colorActive:this.colorInactive,t=this.active?this.backgroundActive:this.backgroundInactive,i="liquid-glass"===this.preset,o=i?this.active?.3:.22:.1,s=this._withOpacity(t,o)??t,n=this.active?.9:.8,a=[];s&&a.push(`--bubble-main-icon-bg:${s}`),e&&(a.push(`color:${e}`),i||a.push(`--bubble-main-icon-border:${e}`),a.push(`--bubble-main-icon-color:${e}`)),i&&this.active&&(a.push("--bubble-main-icon-saturation:1.12"),a.push("--bubble-main-icon-luminance:1.04"),a.push("--bubble-main-icon-icon-brightness:1.25"),a.push("--bubble-main-icon-icon-saturation:1.12"));const r=a.map(e=>`${e};`).join(" ");return j`
      <div
        class="container"
        style="${r}"
    ...
    `}_withOpacity(e,t){return function(e,t){const i=We(e);return i?`rgba(${i.r}, ${i.g}, ${i.b}, ${t})`:null}(e,t)}_onDown=()=>this._gesture.onDown();_onUp=()=>this._gesture.onUp();_clearHoldTimer=()=>this._gesture.clearTimer();_fireHassAction(e){const t=(("hold"===e?this.hold_action:this.tap_action)||{action:"more-info"}).action||"more-info";if(("toggle"===t||"call-service"===t||"more-info"===t)&&!this.entity_id)return;const i=new Event("hass-action",{bubbles:!0,composed:!0});i.detail={config:{entity:this.entity_id,tap_action:this.tap_action||{action:"more-info"},hold_action:this.hold_action||{action:"none"}},action:e},this.dispatchEvent(i)}}customElements.define("bubble-icon",Ke);class Xe extends oe{static properties={config:{type:Object},hass:{type:Object}};_entities={};constructor(){super(),this.config={},this.hass={}}setConfig(e){this.config={layout:"wide",...e},this._entities=structuredClone(this.config.entities||{}),this._entities.camera=this._entities.camera||{entity:"",icon:""},this._entities.camera.presence||(this._entities.camera.presence={entity:""}),this._entities.climate=this._entities.climate||{entity:"",icon:""}}get hass(){return this._hass}set hass(e){this._hass=e,e?.states&&this.requestUpdate?.()}static getStubConfig(){return{type:"custom:bubble-room",layout:"wide",name:[],area:[],sensors:[],mushrooms:[],subbuttons:[],colors:{subbutton:{background_on:"rgba(var(--color-blue),1)",background_off:"rgba(var(--color-blue),0.3)",icon_on:"yellow",icon_off:"#666"}}}}static async getConfigElement(){return await Promise.resolve().then(function(){return He}),document.createElement("bubble-room-editor")}connectedCallback(){super.connectedCallback(),this._resizeObs=new ResizeObserver(()=>this.requestUpdate())}firstUpdated(){const e=this.shadowRoot?.querySelector(".icon-mushroom-area");e&&this._resizeObs.observe(e)}disconnectedCallback(){this._resizeObs?.disconnect(),super.disconnectedCallback()}updated(e){e.has("config")&&(this._entities=structuredClone(this.config.entities||{}))}_getSubButtons(){const e=this.config.colors?.subbutton?.background_on??"#00d46d",t=this.config.colors?.subbutton?.background_off??"#999",i=this.config.colors?.subbutton?.icon_on??"yellow",o=this.config.colors?.subbutton?.icon_off??"#666";return(this.config.subbuttons||[]).map(s=>{const n=this.hass.states?.[s.entity_id];return{icon:s.icon||ke(s.entity_id,this.hass),active:"on"===n?.state,colorOn:e,colorOff:t,iconOn:i,iconOff:o,entity_id:s.entity_id,tap_action:s.tap_action,hold_action:s.hold_action}})}_isRoomActive(){const e=this.config?.entities?.presence?.entity;if(!e)return!1;const t=this.hass?.states?.[e]?.state;return["on","home","occupied","motion","detected"].includes(t)}_getMainIconSize(){const e=this.shadowRoot?.querySelector(".icon-mushroom-area");return e?Math.round(.6*Math.min(e.clientWidth,e.clientHeight)):64}_getSensors(){const e=this._entities||{},t=this.config.colors?.room?.sensor_active??this.config.colors?.room?.text_active??"#21df73",i=this.config.colors?.room?.sensor_inactive??this.config.colors?.room?.text_inactive??"#173c16",o=this._isRoomActive()?t:i,s=[];for(let t=1;t<=6;t++){const i=e[`sensor${t}`]?.entity,n=this.hass?.states?.[i];i&&n&&s.push({icon:n.attributes.icon||"",value:n.state,unit:n.attributes.unit_of_measurement,device_class:n.attributes.device_class,color:o,entity:i})}return s}_getMushrooms(){const e=this._entities||{},t=this.config.colors?.mushroom?.active??"#00e676",i=this.config.colors?.mushroom?.inactive??"#888",o=[];for(let s=1;s<=5;s++){const n=e[`mushroom${s}`]||{},a=n.entity,r=this.hass?.states?.[a];if(!a||!r)continue;const l="on"===r.state;o.push({icon:n.icon||r.attributes.icon||ke(a,this.hass)||"mdi:flash",state:r.state,active:l,color:l?t:i,dx:n.dx??0,dy:n.dy??0,angle_deg:n.angle_deg,radius_factor:n.radius_factor,entity_id:a,tap_action:n.tap_action,hold_action:n.hold_action})}const s=e.camera||{},n=s.entity;if(n&&this.hass.states?.[n]){const e=this.hass?.states?.[n],a=s.presence?.entity,r=a?this.hass?.states?.[a]?.state:void 0,l=!a||["on","home","occupied","motion","detected"].includes(r);o.push({icon:s.icon||e.attributes.icon||ke(n,this.hass)||"mdi:cctv",state:e.state,active:l,color:l?t:i,left:"calc(100% - 12px - 36px)",top:12,dx:0,dy:0,kind:"camera",angle_deg:s.angle_deg,radius_factor:s.radius_factor,entity_id:n,tap_action:{action:"more-info"},hold_action:{action:"none"}})}const a=this._entities?.climate||{},r=a.entity;if(r&&this.hass.states?.[r]){const e=this.hass?.states?.[r],s=e.state&&"off"!==e.state&&"idle"!==e.state||e.attributes?.hvac_action&&"off"!==e.attributes.hvac_action;o.push({icon:a.icon||e.attributes.icon||ke(r,this.hass)||"mdi:thermostat",state:e.state,active:s,color:s?t:i,dx:0,dy:0,angle_deg:a.angle_deg,radius_factor:a.radius_factor,kind:"climate",entity_id:r})}return o}_onMushroomClick(e){}render(){try{return this._renderCard()}catch(e){return console.error("[bubble-room] render error:",e),j`<div style="padding:12px;color:#f87;font-size:0.9rem">
        bubble-room: errore di rendering — ${e.message}
      </div>`}}_renderCard(){const e=this.config.layout||"wide",t=this._getMainIconSize(),i=this._getSubButtons(),o=this.config?.subbutton_style||"standard",s=this._isRoomActive(),n=this.config.colors?.room?.icon_active??"#21df73",a=this.config.colors?.room?.icon_inactive??"#173c16",r=this.config.colors?.room?.background_active??"rgba(33,223,115,0.12)",l=this.config.colors?.room?.background_inactive??"rgba(23,60,22,0.12)",c=this.config.colors?.room?.text_active??"#ffffff",d=this.config.colors?.room?.text_inactive??"rgba(255,255,255,0.5)",u=this.config?.entities?.presence?.entity||"",p=this.config?.tap_action||{action:"more-info"},h=this.config?.hold_action||{action:"none"};return j`
    ...
    `}_onMainIconAction=e=>{const{config:t,action:i}=e.detail||{};if(!t)return;const o="hold"===i?t.hold_action||{action:"none"}:t.tap_action||{action:"none"};this._runAction(o,t.entity)};_runAction(e,t){const i=e?.action||"none";if("none"!==i)try{switch(i){case"navigate":{const t=e.navigation_path||e.navigationPath;t&&(window.history.pushState({},"",t),window.dispatchEvent(new Event("location-changed")));break}case"more-info":{const i=e.entity||t;i&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:i},bubbles:!0,composed:!0}));break}case"toggle":{const i=e.entity||t;i&&this.hass?.callService&&this.hass.callService("homeassistant","toggle",{entity_id:i});break}case"call-service":{const i=e.service||"",[o,s]=i.split(".");if(o&&s&&this.hass?.callService){const i={...e.service_data||e.data||{}};!i.entity_id&&t&&(i.entity_id=t),this.hass.callService(o,s,i)}break}}}catch(e){console.error("[bubble-room] action error:",i,e)}}static styles=n`
  ...
  `}customElements.define("bubble-room",Xe),window.customCards.push({type:"bubble-room",name:"Bubble Room",description:"All‑in‑one room card: control entities, see sensors, and tweak colors & layout.",preview:!1,documentationURL:"https://github.com/mon3y78/Lovelace-Bubble-room"});export{Xe as BubbleRoom};
