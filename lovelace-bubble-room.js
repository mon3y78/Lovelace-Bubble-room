      ...
      <div>
        ...
        <fieldset>
          ...
          <label>
            Temperature Sensor:
            <input type="text"
                   .value="${this._config.entities?.temperatura?.temperature_sensor||""}"
                   list="entity-list"
          ...
          <label>
            Humidity Sensor:
            <input type="text"
                   .value="${this._config.entities?.temperatura?.humidity_sensor||""}"
                   list="entity-list"
        ...
        <p>
          Note: Mushroom templates have fixed positions and the default actions for entities (except for Presence) are: tap: toggle, hold: more-info.
