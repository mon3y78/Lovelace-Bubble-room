...
`;class Oe extends ie{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_expanded:{type:Array,state:!0},_filters:{type:Array,state:!0},_entities:{type:Array,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._expanded=Array(5).fill(!1);const e=Object.keys(Me);this._filters=Array(5).fill().map(()=>[...e]),this._entities=Array(5).fill(""),this._ignoreNextFilterChange=new Set}updated(e){if(e.has("config")||e.has("hass")){const e=_e(this.hass,this.config,"auto_discovery_sections.sensor");e&&e!==this.config&&this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}));for(let e=0;e<5;e++){const t=`sensor${e+1}`,o=this.config?.sensor_filters?.[e],i=this.config?.entities?.[t]?.entity;Array.isArray(o)&&(this._filters[e]=[...o]),i&&(this._entities[e]=i)}}}static styles=[Fe,n`
      :host {
...
`;class Ne extends ie{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_room:{type:Object,state:!0},_subbutton:{type:Object,state:!0},_mushroom:{type:Object,state:!0},_sensor:{type:Object,state:!0},_cardBg:{type:Object,state:!0},_selectedPreset:{type:String,state:!0},_expandedColors:{type:Array,state:!0},_subbuttonStyle:{type:String,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._room={},this._subbutton={},this._mushroom={},this._sensor={},this._cardBg={enabled:!1,color:""},this._selectedPreset="green",this._expandedColors=[!1,!1,!1,!1,!1,!1],this._subbuttonStyle="standard"}updated(e){if(e.has("config")){const e=this.config?.colors||{};this._room={icon_active:e.room?.icon_active??"",icon_inactive:e.room?.icon_inactive??"",background_active:e.room?.background_active??"",background_inactive:e.room?.background_inactive??"",text_active:e.room?.text_active??"",text_inactive:e.room?.text_inactive??""},this._subbutton={background_on:e.subbutton?.background_on??"",background_off:e.subbutton?.background_off??"",icon_on:e.subbutton?.icon_on??"",icon_off:e.subbutton?.icon_off??""},this._mushroom={active:e.mushroom?.active??"",inactive:e.mushroom?.inactive??""},this._sensor={sensor_active:e.sensor?.sensor_active??"",sensor_inactive:e.sensor?.sensor_inactive??""},this._subbuttonStyle=this.config?.subbutton_style||"standard";const t=this.config?.card_background?.enabled??!0;this._cardBg={enabled:t,color:this.config?.card_background?.color??""}}}get PRESETS(){return qe}static styles=je;render(){const e=(e,t,o)=>Ee(this.hass,e,t,o);return j`
    ...
    `}_toggleColor(e){this._expandedColors=this._expandedColors.map((t,o)=>o===e&&!t)}_readColorValue(e,t){return"card_background"===e?this.config?.card_background?.[t]||"":this.config?.colors?.[e]?.[t]||""}_colorEmitPath(e,t){return"card_background"===e?`card_background.${t}`:`colors.${e}.${t}`}_renderColorField(e,t,o){const i=this._readColorValue(e,t),s="card_background"===e,[n,a,r,l]=this._parseRGBA(i||(s?"rgba(33,223,115,0.15)":"")),c=s?i?l:.15:l,d=s?"0.35":"1",u=`#${[n,a,r].map(e=>e.toString(16).padStart(2,"0")).join("")}`;return j`
      <div class="input-group">
        <label>${o}</label>
        <input
          type="color"
  ...
  `;render(){const e=this.active?this.colorActive:this.colorInactive,t=this.active?this.backgroundActive:this.backgroundInactive,o="liquid-glass"===this.preset,i=o?this.active?.52:.38:.1,s=this._withOpacity(t,i)??t,n=this.active?.9:.8,a=[];s&&a.push(`--bubble-main-icon-bg:${s}`),e&&(a.push(`color:${e}`),o||a.push(`--bubble-main-icon-border:${e}`),a.push(`--bubble-main-icon-color:${e}`)),o&&this.active?(a.push("--bubble-main-icon-saturation:1.12"),a.push("--bubble-main-icon-luminance:1.04"),a.push("--bubble-main-icon-icon-brightness:1.25"),a.push("--bubble-main-icon-icon-saturation:1.12")):o&&!this.active&&(a.push("--bubble-main-icon-saturation:0.72"),a.push("--bubble-main-icon-luminance:0.90"),a.push("--bubble-main-icon-icon-brightness:0.92"),a.push("--bubble-main-icon-icon-saturation:0.78"));const r=a.map(e=>`${e};`).join(" ");return j`
      <div
        class="container"
        style="${r}"
