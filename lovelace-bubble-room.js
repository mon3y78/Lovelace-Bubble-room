...
var te,ie;class oe extends f{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return null!==(e=(t=this.renderOptions).renderBefore)&&void 0!==e||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,i)=>{var o,s;const r=null!==(o=null==i?void 0:i.renderBefore)&&void 0!==o?o:t;let n=r._$litPart$;if(void 0===n){const e=null!==(s=null==i?void 0:i.renderBefore)&&void 0!==s?s:null;r._$litPart$=n=new W(t.insertBefore(k(),e),e,void 0,null!=i?i:{})}return n._$AI(e),n})(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),null===(e=this._$Do)||void 0===e||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._$Do)||void 0===e||e.setConnected(!1)}render(){return M}}oe.finalized=!0,oe._$litElement$=!0,null===(te=globalThis.litElementHydrateSupport)||void 0===te||te.call(globalThis,{LitElement:oe});const se=globalThis.litElementPolyfillSupport;null==se||se({LitElement:oe}),(null!==(ie=globalThis.litElementVersions)&&void 0!==ie?ie:globalThis.litElementVersions=[]).push("3.3.3");const re=(e=[])=>({includeDomains:["binary_sensor","light","switch","fan"],entityFilter:(t,i)=>{if(!e.length)return!1;const[o]=t.split(".");if("binary_sensor"===o){const o=i.states[t]?.attributes?.device_class??"";return e.includes(o)}return e.includes(o)}});function ne(e,t,i,o=[]){if(!e?.states)return[];let s=null;if("presence"===i&&(s=re(o)),!s)return[];const r=Object.keys(e.states).filter(e=>s.includeDomains.includes(e.split(".")[0])).filter(t=>s.entityFilter(t,e));if((t?.auto_discovery_sections?.presence??!1)&&t?.area){const i=function(e,t){if(!e?.states||!t)return[];const i=e.entities??{},o=e.devices??{};return Object.keys(e.states).filter(s=>{const r=i[s];if(r?.area_id===t)return!0;const n=r?.device_id;if(n&&o[n]?.area_id===t)return!0;const a=e.states[s]?.attributes??{};return a.area_id===t||a.area===t})}(e,t.area);return r.filter(e=>i.includes(e))}return r}const ae=!!window.__BUBBLE_DEBUG__,le=(e,t)=>e.find(e=>!t.has(e))||null;function ce(e,t){const i={...t.entities||{}},o=i.presence||(i.presence={});if(!o.entity){const i=function(e,t){if(!e||!e.states)return[];const i=new Set(["person","device_tracker","binary_sensor","light","switch","media_player","fan","humidifier","lock","input_boolean","scene"]);let o=Object.keys(e.states).filter(e=>i.has(e.split(".")[0]));o=o.filter(t=>{if("binary_sensor"!==t.split(".")[0])return!0;const i=e.states[t]?.attributes?.device_class;return["motion","occupancy","presence"].includes(i||"")});const s=t?.area;if(s){const t=o.filter(t=>{const i=e.states[t],o=i?.attributes?.area_id,r=i?.attributes?.area;return o===s||r===s});t.length&&(o=t)}const r=t?.entities?.presence?.entity||t?.presence_entity;return r&&!o.includes(r)&&o.push(r),ae&&console.info("[AutoDiscovery][presence candidates]",{area:s,count:o.length,sample:o.slice(0,8)}),o}(e,t);i.length&&(o.entity=i[0])}return{...t,entities:i}}function de(e,t,i,o=!1){const s=t.auto_discovery_sections||{},r="area"===i,n=i&&i.startsWith("auto_discovery_sections.");if(!r&&!n)return t;let a=t;return s.sensor&&(a=function(e,t){const i=["sensor1","sensor2","sensor3","sensor4","sensor5","sensor6"],o={...t.entities||{}},s=new Set(i.map(e=>o[e]?.entity_id).filter(Boolean));for(const r of i){const i=o[r]||(o[r]={});if(i.entity_id)continue;const n=ne(e,t,{section:"sensor",type:i.type||""}),a=le(n,s);a&&(i.entity_id=a,s.add(a))}return{...t,entities:o}}(e,a)),s.mushroom&&(a=function(e,t){const i={...t.entities||{}},o=new Set(["climate","camera","entities1","entities2","entities3","entities4","entities5"].map(e=>i[e]?.entity).filter(Boolean)),s=ne(e,t,"mushroom"),r=i.climate||(i.climate={});if(!r.entity){const e=s.find(e=>e.startsWith("climate.")&&!o.has(e));e&&(r.entity=e,o.add(e))}const n=i.camera||(i.camera={});if(!n.entity){const e=s.find(e=>e.startsWith("camera.")&&!o.has(e));e&&(n.entity=e,o.add(e))}for(const e of["entities1","entities2","entities3","entities4","entities5"]){const t=i[e]||(i[e]={});if(t.entity)continue;const r=le(s,o);r&&(t.entity=r,o.add(r))}return{...t,entities:i}}(e,a)),s.subbutton&&(a=function(e,t){const i=["sub-button1","sub-button2","sub-button3","sub-button4","sub-button5","sub-button6"],o={...t.entities||{}},s=new Set(i.map(e=>o[e]?.entity).filter(Boolean)),r=ne(e,t,"subbutton");for(const e of i){const t=o[e]||(o[e]={});if(t.entity)continue;const i=le(r,s);i&&(t.entity=i,s.add(i))}return{...t,entities:o}}(e,a)),s.presence&&(a=ce(e,a)),o&&"undefined"!=typeof window&&window.__BUBBLE_DEBUG__&&console.info("[AutoDiscovery] applied after",i,{sections:s}),a}const he=["presence","motion","occupancy","light","switch","fan"];class pe extends oe{static properties={hass:{type:Object},config:{type:Object},_expanded:{type:Boolean},activeFilters:{type:Array,state:!0}};static styles=r`
  ...
  `;constructor(){super(),this.hass={},this.config={},this._expanded=!1,this.activeFilters=[]}connectedCallback(){super.connectedCallback(),async function(){const e=!!customElements.get("md-focus-ring"),t=!!customElements.get("md-filter-chip");e||await Promise.resolve().then(function(){return vt}),t||await Promise.resolve().then(function(){return It})}()}updated(e){(e.has("config")||e.has("hass"))&&(de(this.hass,this.config,"area"),de(this.hass,this.config,"auto_discovery_sections.presence"),e.has("config")&&Array.isArray(this.config.presence_filters)&&(this.activeFilters=[...this.config.presence_filters]))}addFilter(e){this.activeFilters.includes(e)||(this.activeFilters=[...this.activeFilters,e])}removeFilter(e){this.activeFilters=this.activeFilters.filter(t=>t!==e)}toggleFilter(e){this.activeFilters.includes(e)?this.removeFilter(e):this.addFilter(e),this._fire("presence_filters",this.activeFilters)}_fire(e,t){this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:e,val:t},bubbles:!0,composed:!0}))}_renderActions(e){const t=this.config?.[`${e}_action`]||{};return U`
    ...
    `}render(){const e=this.config,t=e.auto_discovery_sections?.presence??!1,i=e.area??"",o=e.name??"",s=e.icon??"",r=this.activeFilters.length?this.activeFilters:e.presence_filters??[...he],n=e.entities?.presence?.entity??e.presence_entity??"",a=ne(this.hass,this.config,"presence",r);return U`
      <ha-expansion-panel
        class="glass-panel"
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Te(e){return ze({...e,state:!0})}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Re=({finisher:e,descriptor:t})=>(i,o)=>{var s;if(void 0===o){const o=null!==(s=i.originalKey)&&void 0!==s?s:i.key,r=null!=t?{kind:"method",placement:"prototype",key:o,descriptor:t(i.key)}:{...i,key:o};return null!=e&&(r.finisher=function(t){e(t,o)}),r}{const s=i.constructor;void 0!==t&&Object.defineProperty(i,o,t(o)),null==e||e(s,o)}};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
