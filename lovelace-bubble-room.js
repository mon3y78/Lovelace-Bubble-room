          ...
          <div class="grid-container">
            ...
            <div class="icon-area">
              ...
              <div class="mushroom-container">
                ${$.map(((t,e)=>{if(!t)return F``;if(t.temperature_sensor||t.humidity_sensor){const i=this._buildTemperatureText(t);return i?F`
                      <div
                        class="mushroom-item"
                        style="${t.style??this._defaultMushroomStyle(e)}"
                        @pointerdown=${e=>this._startHold(e,t)}
                        @pointerup=${e=>this._endHold(e,t,(()=>this._handleMushroomTap(t)))}
                        @pointerleave=${t=>this._cancelHold(t)}
                      >
                        <div class="mushroom-primary fit-text">${i}</div>
                      </div>
                    `:F``}const i="on"===(a.states[t.entity]?.state||"off")?t.icon_color?.on??u:t.icon_color?.off??p,n=this._getFallbackIcon(t.entity),o=t.icon?.trim()?t.icon:n;return F`
                    <div
                      class="mushroom-item"
                      style="${t.style??this._defaultMushroomStyle(e)}"
                      @pointerdown=${e=>this._startHold(e,t)}
            ...
            <div class="bubble-sub-button-container">
              ${y.map((t=>{if(!t?.entity)return L;const e=a.states[t.entity]?.state||"off",i="on"===e?u:p,n=this._getFallbackIcon(t.entity),o=t.icon?.trim()?t.icon:n,s="on"===e?t.icon_color?.on??u:t.icon_color?.off??p;return F`
                  <div
                    ...
                    @pointerleave=${t=>this._cancelHold(t)}
                  >
                    ${o?F`<ha-icon icon="${o}" style="color: ${s};"></ha-icon>`:L}
                  </div>
                `}))}
            </div>
