        ...
        <div class="grid-container">
          ...
          <div class="icon-area">
            ...
            <div class="mushroom-container">
              ${d.map(((e,n)=>{if(!e)return i``;const o=t.mushroomPositions[n]||this._defaultMushroomStyle(n);if(e.sensore_temperatura&&e.sensore_umitidà){const t=a.states[e.sensore_temperatura]?.state||"N/A",n=a.states[e.sensore_umitidà]?.state||"N/A";return i`
                    <div class="mushroom-item"
                         style="${o}"
                         @pointerdown="${t=>this._startHold(t,e)}"
                         @pointerup="${t=>this._endHold(t,e,(()=>this._handleMushroomTap(e)))}"
                         @pointerleave="${t=>this._cancelHold(t)}">
                      <div class="mushroom-primary">🌡️${t}°C 💦${n}%</div>
                    </div>
