...
`;class Ve extends ie{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_expanded:{type:Array,state:!0},_filters:{type:Array,state:!0},_entities:{type:Array,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._expanded=Array(5).fill(!1);const e=Object.keys(Ue);this._filters=Array(5).fill().map(()=>[...e]),this._entities=Array(5).fill(""),this._ignoreNextFilterChange=new Set}updated(e){if(e.has("config")||e.has("hass")){const e=Me(this.hass,this.config,"auto_discovery_sections.sensor");e&&e!==this.config&&this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this._entities=Array(5).fill("");for(let e=0;e<5;e++){const t=`sensor${e+1}`,o=this.config?.sensor_filters?.[e],i=this.config?.entities?.[t]?.entity;Array.isArray(o)&&(this._filters[e]=[...o]),this._entities[e]=i||""}}}static styles=[We,s`
    ...
    `];render(){const e=this.config?.auto_discovery_sections?.sensor??!1,t=(e,t,o)=>De(this.hass,e,t,o),o=Object.entries(Ue).filter(([e])=>"_fallback"!==e).map(([e,t])=>{const o=t.label||e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase());return{value:e,label:`${t.emoji||""} ${o}`.trim()}});return q`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
      ...
      <div class="mini-pill ${t?"expanded":""}">
        ...
        ${t?q`
          <div class="mini-pill-content">
            ...
            ${s?(()=>{const e=this.hass.states[s],t=e?.attributes?.device_class,o=Ue[t]||{},i=o.emoji||"❓",n=e?.attributes?.unit_of_measurement||(o.units?.[0]??"");return q`
                <div class="preview">
    ...
    `];render(){const e=this.config?.auto_discovery_sections?.mushroom??!1,t=(e,t,o)=>De(this.hass,e,t,o),o=this._ALL_CATS.map(e=>({value:e,label:se[e]||e.charAt(0).toUpperCase()+e.slice(1)}));return q`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
        @expanded-changed=${e=>{this.expanded=e.detail.expanded,this.expanded&&(this._expanded=Array(5).fill(!1))}}
    ...
    `}_extraFields(e,t,o){const i=(e,t,o)=>De(this.hass,e,t,o),n=o?.[`${t}_action`]?.action;return"navigate"===n?q`
    ...
    `];render(){const e=this.config?.auto_discovery_sections?.subbutton??!1,t=(e,t,o)=>De(this.hass,e,t,o),o=ae.map(e=>({value:e,label:se[e]||e.charAt(0).toUpperCase()+e.slice(1)}));return q`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
        @expanded-changed=${e=>this.expanded=e.detail.expanded}
...
`;class Xe extends ie{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_room:{type:Object,state:!0},_subbutton:{type:Object,state:!0},_mushroom:{type:Object,state:!0},_sensor:{type:Object,state:!0},_cardBg:{type:Object,state:!0},_selectedPreset:{type:String,state:!0},_expandedColors:{type:Array,state:!0},_subbuttonStyle:{type:String,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._room={},this._subbutton={},this._mushroom={},this._sensor={},this._cardBg={enabled:!1,color:""},this._selectedPreset="green",this._expandedColors=[!1,!1,!1,!1,!1,!1],this._subbuttonStyle="standard"}updated(e){if(e.has("config")){const e=this.config?.colors||{};this._room={icon_active:e.room?.icon_active??"",icon_inactive:e.room?.icon_inactive??"",background_active:e.room?.background_active??"",background_inactive:e.room?.background_inactive??"",text_active:e.room?.text_active??"",text_inactive:e.room?.text_inactive??""},this._subbutton={background_on:e.subbutton?.background_on??"",background_off:e.subbutton?.background_off??"",icon_on:e.subbutton?.icon_on??"",icon_off:e.subbutton?.icon_off??""},this._mushroom={active:e.mushroom?.active??"",inactive:e.mushroom?.inactive??""},this._sensor={sensor_active:e.sensor?.sensor_active??"",sensor_inactive:e.sensor?.sensor_inactive??""},this._subbuttonStyle=this.config?.subbutton_style||"standard";const t=this.config?.card_background?.enabled??!0;this._cardBg={enabled:t,color:this.config?.card_background?.color??""}}}get PRESETS(){return Ge}static styles=Ke;render(){const e=(e,t,o)=>De(this.hass,e,t,o);return q`
    ...
    `}_renderStyleChooser(){const e=(e,t,o)=>De(this.hass,e,t,o),t=[{key:"standard",label:e("panel.colors.style.standard"),description:e("panel.colors.style.standard_desc")},{key:"liquid-glass",label:e("panel.colors.style.liquid_glass"),description:e("panel.colors.style.liquid_glass_desc")}];return q`
    ...
    `}_renderPresetCard(e,t){const o=(e,t,o)=>De(this.hass,e,t,o),i=this._selectedPreset===e?"selected":"",n=t.room.background_active,s=t.room.background_inactive,a=t.room.icon_active,r=t.room.icon_inactive;return q`
  ...
  `;render(){const e=this.config?.auto_discovery_sections?.camera??!1,t=(e,t,o)=>De(this.hass,e,t,o);return q`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
        @expanded-changed=${e=>this.expanded=e.detail.expanded}
  ...
  `;render(){const e=this.config?.auto_discovery_sections?.climate??!1,t=(e,t,o)=>De(this.hass,e,t,o);return q`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
        @expanded-changed=${e=>this.expanded=e.detail.expanded}
  ...
  `;render(){const e=(this.sensors||[]).map(e=>{const t=e.device_class,o=Ue[t]||{},i=o.emoji||"❓",n=e.unit||o.units?.[0]||"",s=this._formatValueForDisplay(e.value,1,!0);return{...e,value:s,label:i,unit:n}});return q`
      <div
        class="sensor-grid"
        style="
  ...
  `;render(){const{width:e,height:t}=this._containerSize;if(!e||!t)return q``;const o=window.innerWidth||e,i=.55;let n;if(o<=100)n=i;else if(o>=200)n=.25;else{n=i+(.25-i)*((o-100)/100)}const s=Math.min(e,1.6*t),a=.5*(t+s)*n,r=.6*e,l=.6*t,c=r*Math.min(1,e/(2*r)),d=l*Math.min(1,t/(2*l)),u=e-c,p=.5*t,h=Math.max(0,c-a/2-1),b=Math.max(0,d-a/2-1),m=e=>Math.PI*e/180,g=m(30),f=m(85),_=.75*a,v=.75*a,y=[{x:a/2+1,y:a/2+1},{x:u+h*Math.cos(-f),y:p+b*Math.sin(-f)},{x:u+h*Math.cos(-g),y:p+b*Math.sin(-g)},{x:u+h*Math.cos(+g),y:p+b*Math.sin(+g)},{x:u+h*Math.cos(+f),y:p+b*Math.sin(+f)}];let x=0;return q`
      ${this.entities.map(o=>{const i="camera"===o?.kind,n="climate"===o?.kind,s=i?_:n?v:a,r=.95*s;let l;i?l={x:e-s/2,y:s/2}:n?l={x:s/2+1,y:t-s/2-1}:(l=y[Math.min(x,y.length-1)]??{x:u,y:p},x++);const c=i||n?0:o.dx??0,d=i||n?0:o.dy??0,h=l.x+c,b=l.y+d,m=o.entity_id||o.kind||"unknown",g=this._ripplingKeys.has(m),f=o.active?this._getAnimClass(o):"",$="liquid-glass"===this.preset?o.active?`is-active ${f}`:"is-inactive":"";return q`
          ...
          >
            ...
            <ha-icon icon="${o.icon||qe(o.entity_id,this.hass)}" style="--mdc-icon-size:${r}px;"></ha-icon>
          </div>
        `})}
        ...
        <div class="main-area">
          ...
          <div class="row2">
            <div class="icon-mushroom-area">
              <bubble-icon
                .icon="${this.config.icon||qe(this.config.entity,this.hass)}"
                .active=${n}
                .colorActive="${s}"
                .colorInactive="${r}"
                .backgroundActive="${l}"
