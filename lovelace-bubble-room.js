...
var et,it;class st extends m{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const i=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=i.firstChild),i}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{var s,o;const n=null!==(s=null==i?void 0:i.renderBefore)&&void 0!==s?s:e;let a=n._$litPart$;if(void 0===a){const t=null!==(o=null==i?void 0:i.renderBefore)&&void 0!==o?o:null;n._$litPart$=a=new J(e.insertBefore(C(),t),t,void 0,null!=i?i:{})}return a._$AI(t),a})(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!1)}render(){return N}}st.finalized=!0,st._$litElement$=!0,null===(et=globalThis.litElementHydrateSupport)||void 0===et||et.call(globalThis,{LitElement:st});const ot=globalThis.litElementPolyfillSupport;null==ot||ot({LitElement:st}),(null!==(it=globalThis.litElementVersions)&&void 0!==it?it:globalThis.litElementVersions=[]).push("3.3.3");const nt={alarm_control_panel:"Allarmi",binary_sensor:"Sensori Binari",camera:"Telecamere",climate:"Clima",cover:"Tapparelle",fan:"Ventola",light:"Luce",lock:"Serratura",media_player:"Media Player",scene:"Scene",script:"Script",siren:"Sirena",vacuum:"Aspirapolvere",motion:"Movimento",occupancy:"Occupazione",presence:"Presenza",switch:"Pulsante"},at=["alarm_control_panel","binary_sensor","camera","climate","cover","fan","light","lock","media_player","scene","script","siren","switch","vacuum"],rt=(t=[])=>({includeDomains:at,entityFilter:(e,i)=>{if(!t.length)return!1;const[s]=e.split(".");if("binary_sensor"===s){const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}return t.includes(s)}}),ct=(t=[])=>({includeDomains:["sensor"],entityFilter:(e,i)=>{if(!t.length)return!0;const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}}),lt=(t=[])=>({includeDomains:at,entityFilter:(e,i)=>{if(!t.length)return"binary_sensor"===e.split(".")[0];const[s]=e.split(".");if("binary_sensor"===s){const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}return t.includes(s)}}),dt=(t=[])=>({includeDomains:at,entityFilter:(e,i)=>{if(!t.length)return at.includes(e.split(".")[0]);const[s]=e.split(".");if("binary_sensor"===s){const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}return t.includes(s)}}),ht=(t=[])=>({includeDomains:["camera"],entityFilter:(e,i)=>{if(!t.length)return!0;const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}});function ut(t,e,i,s=[]){if(!t?.states)return[];let o;if("presence"===i?o=rt(s):"sensor"===i?o=ct(s):"mushroom"===i?o=lt(s):"subbutton"===i?o=dt(s):"camera"===i&&(o=ht(s)),!o)return[];const n=Object.keys(t.states).filter(t=>o.includeDomains.includes(t.split(".")[0])).filter(e=>o.entityFilter(e,t));if((e?.auto_discovery_sections?.[i]??!1)&&e?.area){const i=function(t,e){if(!t?.states||!e)return[];const i=t.entities??{},s=t.devices??{};return Object.keys(t.states).filter(o=>{const n=i[o];if(n?.area_id===e)return!0;const a=n?.device_id;if(a&&s[a]?.area_id===e)return!0;const r=t.states[o]?.attributes??{};return r.area_id===e||r.area===e})}(t,e.area);return n.filter(t=>i.includes(t))}return n}const pt=!!window.__BUBBLE_DEBUG__;function bt(t,e){const i=Array.isArray(e?.area)?e.area[0]:e?.area,s="string"!=typeof i||i.startsWith("area_")?"":i;let o="string"==typeof i&&i.startsWith("area_")?i:"";const n=Array.isArray(t?.areas)?t.areas:[];if(!o&&n.length&&s){const t=n.find(t=>(t.name||"").toLowerCase()===String(s).toLowerCase());t?.area_id&&(o=t.area_id)}return{areaId:o,areaName:s}}function gt(t,e,i,s){if(!i&&!s)return!0;const o=t?.entities,n=t?.devices,a=o?.[e];if(a?.area_id&&i)return a.area_id===i;if(a?.device_id&&Array.isArray(n)){const t=n.find(t=>t.id===a.device_id||t.device_id===a.device_id);if(t?.area_id&&i)return t.area_id===i}const r=t?.states?.[e];if(r){const t=r.attributes?.area_id,e=r.attributes?.area;if(i&&t)return t===i;if(s&&e)return String(e).toLowerCase()===String(s).toLowerCase()}return!0}function mt(t,e,i){let s=ut(t,e,i)||[];return!s.length&&t?.states&&(s=Object.keys(t.states)),s}function ft(t,e,i,s){const o={...e.entities||{}},n=o[s]||(o[s]={});if(n.entity)return{...e,entities:o};let a=mt(t,e,i);a.length||(a=mt(t,e,"mushroom")),a=(a||[]).filter(t=>t.startsWith(`${i}.`));const r=bt(t,e),c=function(t,e,i,s){const{areaId:o,areaName:n}=i,a=(e||[]).filter(e=>gt(t,e,o,n));return s&&!a.includes(s)&&a.unshift(s),Array.from(new Set(a))}(t,a,r,n.entity),l=c[0]||a[0]||"";return l&&(n.entity=l),pt&&console.info(`[AutoDiscovery][${s}]`,{domain:i,chosen:n.entity,areaRef:r,pool:a.length,filtered:c.length}),{...e,entities:o}}const _t=(t,e)=>t.find(t=>!e.has(t))||null;function vt(t,e){const i={...e.entities||{}},s=i.presence||(i.presence={});if(!s.entity){const i=function(t,e){if(!t||!t.states)return[];const i=new Set(["person","device_tracker","binary_sensor","light","switch","media_player","fan","humidifier","lock","input_boolean","scene"]);let s=Object.keys(t.states).filter(t=>i.has(t.split(".")[0]));s=s.filter(e=>{if("binary_sensor"!==e.split(".")[0])return!0;const i=t.states[e]?.attributes?.device_class;return["motion","occupancy","presence"].includes(i||"")});const{areaId:o,areaName:n}=bt(t,e);if(o||n){const e=s.filter(e=>gt(t,e,o,n));e.length&&(s=e)}const a=e?.entities?.presence?.entity||e?.presence_entity;return a&&!s.includes(a)&&s.unshift(a),pt&&console.info("[AutoDiscovery][presence candidates]",{areaId:o,areaName:n,count:s.length,sample:s.slice(0,8)}),s}(t,e);i.length&&(s.entity=i[0])}return{...e,entities:i}}function xt(t,e,i,s=!1){if(!t||!e)return e;const o=e.auto_discovery_sections||{},n="area"===i,a=i&&String(i).startsWith("auto_discovery_sections.");if(!n&&!a)return e;let r=e;return o.sensor&&(r=function(t,e){const i=["sensor1","sensor2","sensor3","sensor4","sensor5","sensor6","sensor7","sensor8"],s={...e.entities||{}},o=new Set(i.map(t=>s[t]?.entity||s[t]?.entity_id).filter(Boolean));for(const n of i){const i=s[n]||(s[n]={});if(i.entity||i.entity_id)continue;const a=ut(t,e,{section:"sensor",type:i.type||""})||[],r=_t(a,o);r&&(i.entity=r,delete i.entity_id,o.add(r))}return{...e,entities:s}}(t,r)),o.mushroom&&(r=function(t,e){const i={...e.entities||{}},s=new Set(["climate","camera","mushroom1","mushroom2","mushroom3","mushroom4","mushroom5"].map(t=>i[t]?.entity).filter(Boolean));let o=mt(t,e,"mushroom");const n=i.climate||(i.climate={});if(!n.entity){const t=o.find(t=>t.startsWith("climate.")&&!s.has(t));t&&(n.entity=t,s.add(t))}const a=i.camera||(i.camera={});if(!a.entity){const t=o.find(t=>t.startsWith("camera.")&&!s.has(t));t&&(a.entity=t,s.add(t))}for(let t=1;t<=5;t++){const e=`mushroom${t}`,n=i[e]||(i[e]={});if(n.entity)continue;const a=_t(o,s);a&&(n.entity=a,s.add(a))}return{...e,entities:i}}(t,r)),o.subbutton&&(r=function(t,e){const i=["sub-button1","sub-button2","sub-button3","sub-button4","sub-button5","sub-button6"],s={...e.entities||{}},o=new Set(i.map(t=>s[t]?.entity).filter(Boolean)),n=ut(t,e,"subbutton")||[];for(const t of i){const e=s[t]||(s[t]={});if(e.entity)continue;const i=_t(n,o);i&&(e.entity=i,o.add(i))}return{...e,entities:s}}(t,r)),o.presence&&(r=vt(t,r)),o.climate&&(r=function(t,e){return ft(t,e,"climate","climate")}(t,r)),o.camera&&(r=function(t,e){return ft(t,e,"camera","camera")}(t,r)),(s||pt)&&"undefined"!=typeof window&&console.info("[AutoDiscovery] applied after",i,{sections:o}),r}const yt={door:{on:"mdi:door-open",off:"mdi:door-closed"},window:{on:"mdi:window-open",off:"mdi:window-closed"},motion:{on:"mdi:motion-sensor",off:"mdi:motion-sensor-off"},moisture:{on:"mdi:water-alert",off:"mdi:water-off"},smoke:{on:"mdi:smoke",off:"mdi:smoke-detector-off"},gas:{on:"mdi:gas-cylinder",off:"mdi:gas-off"},lock:{on:"mdi:lock-open-variant",off:"mdi:lock"},garage:{on:"mdi:garage-open",off:"mdi:garage"},light:{on:"mdi:lightbulb-on",off:"mdi:lightbulb-off"},plug:{on:"mdi:power-plug",off:"mdi:power-plug-off"},presence:{on:"mdi:account",off:"mdi:account-off"},vibration:{on:"mdi:vibrate",off:"mdi:vibrate-off"},opening:{on:"mdi:door-open",off:"mdi:door-closed"},battery:{on:"mdi:battery",off:"mdi:battery-outline"},connectivity:{on:"mdi:wifi",off:"mdi:wifi-off"},safety:{on:"mdi:shield-check",off:"mdi:shield-off"},cold:{on:"mdi:snowflake",off:"mdi:snowflake-off"}},$t={light:"mdi:lightbulb",switch:"mdi:toggle-switch",fan:"mdi:fan",climate:"mdi:thermostat",cover:"mdi:window-shutter",media_player:"mdi:play-circle",script:"mdi:script-text",scene:"mdi:palette",lock:"mdi:lock",camera:"mdi:video",binary_sensor:"mdi:checkbox-marked-circle-outline",sensor:"mdi:eye",alarm_control_panel:"mdi:shield-home",vacuum:"mdi:robot-vacuum",siren:"mdi:bullhorn"};function wt(t,e){const i=e.states?.[t],s=i?.attributes||{},o=s.device_class,n=t?.split(".")?.[0]??"",a=i?.state,r=o&&yt[o]?yt[o]["on"===a?"on":"off"]:null;return s.icon||r||$t[n]||"mdi:bookmark"}const kt=["presence","motion","occupancy","light","switch","fan"];class At extends st{static properties={hass:{type:Object},config:{type:Object},_expanded:{type:Boolean,state:!0},activeFilters:{type:Array,state:!0},layout:{type:String}};static styles=n`
  ...
  `;render(){const t=this.config.auto_discovery_sections?.sensor??!1,e=Object.entries(Ct).filter(([t])=>"_fallback"!==t).map(([t,e])=>{const i=e.label||t.replace(/_/g," ").replace(/\b\w/g,t=>t.toUpperCase());return{value:t,label:`${e.emoji||""} ${i}`.trim()}});return F`
      <ha-expansion-panel
        class="glass-panel"
    ...
    `}_renderSensor(t,e,i){const s=this._filters[t],o=this._entities[t],n=ut(this.hass,this.config,"sensor",s);return F`
      <div class="mini-pill ${e?"expanded":""}">
        ...
        ${e?F`
          <div class="mini-pill-content">
            ...
            ${o?(()=>{const t=this.hass.states[o],e=t?.attributes?.device_class,i=Ct[e]||{},s=i.emoji||"❓",n=t?.attributes?.unit_of_measurement||(i.units?.[0]??"");return F`
                <div class="preview">
  ...
  `;render(){const t=this.config.auto_discovery_sections?.mushroom??!1,e=at.map(t=>({value:t,label:nt[t]||t.charAt(0).toUpperCase()+t.slice(1)}));return F`
    ...
    `}_renderMushroom(t,e,i){const s=`mushroom${t+1}`,o=this._filters[t],n=this._entities[t],a=this._icons[t],r=this.config.entities&&this.config.entities[s]?this.config.entities[s]:{},c=ut(this.hass,this.config,"mushroom",o),l=["toggle","more-info","navigate","call-service","none"];return F`
      <div class="mini-pill ${e?"expanded":""}">
        <div class="mini-pill-header" @click=${()=>this._togglePill(t)}>
          Mushroom ${t+1}
          <span class="chevron">${e?"▼":"▶"}</span>
  ...
  `;render(){const t=this.config.auto_discovery_sections?.subbutton??!1,e=at.map(t=>({value:t,label:nt[t]||t.charAt(0).toUpperCase()+t.slice(1)}));return F`
    ...
    `}_renderSubButton(t,e,i){const s=this._filters[t],o=this._entities[t],n=ut(this.hass,this.config,"subbutton",s),a=this.config.subbuttons?.[t]||{},r=["toggle","more-info","navigate","call-service","none"];return F`
      <div class="mini-pill ${e?"expanded":""}">
        <div class="mini-pill-header" @click=${()=>this._togglePill(t)}>
    ...
    `}_extraFields(t,e,i){const s=i[`${e}_action`]?.action;return"navigate"===s?F`
      ...
      `:"call-service"===s?F`
        ...
        <input type="text" placeholder='Service Data (JSON)'
          ...
          @input=${i=>this._onAction(t,e,"service_data",this._safeJson(i.target.value))}
        />
      `:""}_safeJson(t){try{return JSON.parse(t)}catch{return{}}}_toggleAuto(t){this._emit("auto_discovery_sections.subbutton",t)}_togglePill(t){this._expanded=this._expanded.map((e,i)=>i===t&&!e)}_onFilter(t,e){this._filters[t]=[...e],this._emit("subbutton_filters",this._filters)}_onEntity(t,e){if(this._entities[t]=e,this.config.subbuttons[t]||(this.config.subbuttons[t]={}),this.config.subbuttons[t].entity_id=e,!this.config.subbuttons[t].icon&&this.hass){const i=this.hass.states?.[e],s=i?.attributes?.icon,o=s||wt(e,this.hass);o&&(this.config.subbuttons[t].icon=o)}this._emit("subbuttons",this.config.subbuttons)}_onIcon(t,e){this.config.subbuttons[t]||(this.config.subbuttons[t]={}),this.config.subbuttons[t].icon=e,this._emit("subbuttons",this.config.subbuttons)}_onAction(t,e,i,s){this.config.subbuttons[t]||(this.config.subbuttons[t]={}),this.config.subbuttons[t][`${e}_action`]={...this.config.subbuttons[t][`${e}_action`],[i]:s},this._emit("subbuttons",this.config.subbuttons)}_reset(){this._expanded=Array(4).fill(!1),this._filters=Array(4).fill().map(()=>[...at]),this._entities=Array(4).fill(""),this.config.subbuttons=Array(4).fill().map(()=>({})),this._emit("subbutton_filters",this._filters),this._emit("subbuttons",this.config.subbuttons)}_emit(t,e){this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:t,val:e},bubbles:!0,composed:!0}))}}customElements.define("sub-button-panel",Pt);class zt extends st{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_room:{type:Object,state:!0},_subbutton:{type:Object,state:!0},_mushroom:{type:Object,state:!0},_sensor:{type:Object,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._room={},this._subbutton={},this._mushroom={},this._sensor={}}updated(t){if(t.has("config")){const t=this.config?.colors||{};this._room={icon_active:t.room?.icon_active??"",icon_inactive:t.room?.icon_inactive??"",background_active:t.room?.background_active??"",background_inactive:t.room?.background_inactive??"",text_active:t.room?.text_active??"",text_inactive:t.room?.text_inactive??""},this._subbutton={background_on:t.subbutton?.background_on??"",background_off:t.subbutton?.background_off??"",icon_on:t.subbutton?.icon_on??"",icon_off:t.subbutton?.icon_off??""},this._mushroom={active:t.mushroom?.active??"",inactive:t.mushroom?.inactive??""},this._sensor={sensor_active:t.sensor?.sensor_active??"",sensor_inactive:t.sensor?.sensor_inactive??""}}}get _presets(){return[{key:"green",name:"Green",preview:{active:"#21df73",inactive:"#173c16"},map:{"colors.room.icon_active":"#21df73","colors.room.icon_inactive":"#173c16","colors.room.background_active":"rgba(33,223,115,0.12)","colors.room.background_inactive":"rgba(23,60,22,0.12)","colors.room.text_active":"#ffffff","colors.room.text_inactive":"rgba(255,255,255,0.55)","colors.subbutton.background_on":"rgba(33,223,115,1)","colors.subbutton.background_off":"rgba(33,223,115,0.28)","colors.subbutton.icon_on":"#fff","colors.subbutton.icon_off":"#667a6a","colors.mushroom.active":"#00e676","colors.mushroom.inactive":"#7a8b7a","colors.sensor.sensor_active":"#21df73","colors.sensor.sensor_inactive":"#173c16"}},{key:"blue",name:"Blue",preview:{active:"#55afff",inactive:"#0f2a4a"},map:{"colors.room.icon_active":"#55afff","colors.room.icon_inactive":"#0f2a4a","colors.room.background_active":"rgba(85,175,255,0.14)","colors.room.background_inactive":"rgba(15,42,74,0.14)","colors.room.text_active":"#ffffff","colors.room.text_inactive":"rgba(255,255,255,0.55)","colors.subbutton.background_on":"rgba(85,175,255,1)","colors.subbutton.background_off":"rgba(85,175,255,0.28)","colors.subbutton.icon_on":"#fff","colors.subbutton.icon_off":"#5c6b7a","colors.mushroom.active":"#59c3ff","colors.mushroom.inactive":"#7a8793","colors.sensor.sensor_active":"#55afff","colors.sensor.sensor_inactive":"#0f2a4a"}},{key:"orange",name:"Orange",preview:{active:"#ff9b3d",inactive:"#4a2a0f"},map:{"colors.room.icon_active":"#ff9b3d","colors.room.icon_inactive":"#4a2a0f","colors.room.background_active":"rgba(255,155,61,0.16)","colors.room.background_inactive":"rgba(74,42,15,0.12)","colors.room.text_active":"#ffffff","colors.room.text_inactive":"rgba(255,255,255,0.55)","colors.subbutton.background_on":"rgba(255,155,61,1)","colors.subbutton.background_off":"rgba(255,155,61,0.28)","colors.subbutton.icon_on":"#1f140a","colors.subbutton.icon_off":"#6b5c52","colors.mushroom.active":"#ffb067","colors.mushroom.inactive":"#8b7a6e","colors.sensor.sensor_active":"#ff9b3d","colors.sensor.sensor_inactive":"#4a2a0f"}},{key:"purple",name:"Purple",preview:{active:"#bd64ff",inactive:"#2c0f4a"},map:{"colors.room.icon_active":"#bd64ff","colors.room.icon_inactive":"#2c0f4a","colors.room.background_active":"rgba(189,100,255,0.16)","colors.room.background_inactive":"rgba(44,15,74,0.12)","colors.room.text_active":"#ffffff","colors.room.text_inactive":"rgba(255,255,255,0.55)","colors.subbutton.background_on":"rgba(189,100,255,1)","colors.subbutton.background_off":"rgba(189,100,255,0.28)","colors.subbutton.icon_on":"#160a1f","colors.subbutton.icon_off":"#6b5c7a","colors.mushroom.active":"#c785ff","colors.mushroom.inactive":"#837a8b","colors.sensor.sensor_active":"#bd64ff","colors.sensor.sensor_inactive":"#2c0f4a"}},{key:"red",name:"Red",preview:{active:"#ff5c6a",inactive:"#4a0f1a"},map:{"colors.room.icon_active":"#ff5c6a","colors.room.icon_inactive":"#4a0f1a","colors.room.background_active":"rgba(255,92,106,0.16)","colors.room.background_inactive":"rgba(74,15,26,0.12)","colors.room.text_active":"#ffffff","colors.room.text_inactive":"rgba(255,255,255,0.55)","colors.subbutton.background_on":"rgba(255,92,106,1)","colors.subbutton.background_off":"rgba(255,92,106,0.28)","colors.subbutton.icon_on":"#1f0a10","colors.subbutton.icon_off":"#7a5c65","colors.mushroom.active":"#ff7884","colors.mushroom.inactive":"#8b7a7f","colors.sensor.sensor_active":"#ff5c6a","colors.sensor.sensor_inactive":"#4a0f1a"}},{key:"gray",name:"Gray",preview:{active:"#c5c8ce",inactive:"#3b4048"},map:{"colors.room.icon_active":"#c5c8ce","colors.room.icon_inactive":"#3b4048","colors.room.background_active":"rgba(197,200,206,0.14)","colors.room.background_inactive":"rgba(59,64,72,0.12)","colors.room.text_active":"#ffffff","colors.room.text_inactive":"rgba(255,255,255,0.55)","colors.subbutton.background_on":"rgba(197,200,206,1)","colors.subbutton.background_off":"rgba(197,200,206,0.28)","colors.subbutton.icon_on":"#1a1b1d","colors.subbutton.icon_off":"#6b707a","colors.mushroom.active":"#d7d9de","colors.mushroom.inactive":"#83878f","colors.sensor.sensor_active":"#c5c8ce","colors.sensor.sensor_inactive":"#3b4048"}}]}_applyPreset(t){Object.entries(t).forEach(([t,e])=>{this._fire(t,e)})}_fire(t,e){this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:t,val:e},bubbles:!0,composed:!0}))}_onColorInput(t,e,i){const s={...this[`_${t}`]||{}};s[e]=i,this[`_${t}`]=s,this._fire(`colors.${t}.${e}`,i)}_resetAll(){Object.entries({room:["icon_active","icon_inactive","background_active","background_inactive","text_active","text_inactive"],subbutton:["background_on","background_off","icon_on","icon_off"],mushroom:["active","inactive"],sensor:["sensor_active","sensor_inactive"]}).forEach(([t,e])=>{e.forEach(e=>this._fire(`colors.${t}.${e}`,""))})}static styles=n`
    :host { display: block; }
    .glass-panel {
  ...
  `;render(){return F`
    ...
    `}_renderSectionRoom(){const t=this._room;return F`
      <div class="section">
        <h3>Room</h3>
        ${this._colorRow("Icon (active)","room","icon_active",t.icon_active)}
        ${this._colorRow("Icon (inactive)","room","icon_inactive",t.icon_inactive)}
        ${this._colorRow("Background (active)","room","background_active",t.background_active)}
        ${this._colorRow("Background (inactive)","room","background_inactive",t.background_inactive)}
        ${this._colorRow("Text (active)","room","text_active",t.text_active)}
        ${this._colorRow("Text (inactive)","room","text_inactive",t.text_inactive)}
      </div>
    `}_renderSectionSubButtons(){const t=this._subbutton;return F`
      <div class="section">
        <h3>Subbutton</h3>
        ${this._colorRow("Background ON","subbutton","background_on",t.background_on)}
        ${this._colorRow("Background OFF","subbutton","background_off",t.background_off)}
        ${this._colorRow("Icon ON","subbutton","icon_on",t.icon_on)}
        ${this._colorRow("Icon OFF","subbutton","icon_off",t.icon_off)}
      </div>
    `}_renderSectionMushroom(){const t=this._mushroom;return F`
      <div class="section">
        <h3>Mushroom (incl. Camera & Climate)</h3>
        ${this._colorRow("Active","mushroom","active",t.active)}
        ${this._colorRow("Inactive","mushroom","inactive",t.inactive)}
      </div>
    `}_renderSectionSensor(){const t=this._sensor;return F`
      <div class="section">
        <h3>Sensori</h3>
        ${this._colorRow("Sensor Active","sensor","sensor_active",t.sensor_active)}
        ${this._colorRow("Sensor Inactive","sensor","sensor_inactive",t.sensor_inactive)}
      </div>
    `}_colorRow(t,e,i,s){const o=this._guessHex(s);return F`
      <div class="row">
        <label>${t}</label>
  ...
  `;render(){const t=this.config||{};return F`
    ...
    `}}customElements.define("bubble-room-editor",Rt);var Mt=Object.freeze({__proto__:null,BubbleRoomEditor:Rt});class It extends st{static properties={subbuttons:{type:Array}};constructor(){super(),this.subbuttons=[],this._holdThreshold=500,this._holdTimer=null,this._holdFired=!1,this._currentIndex=-1}static styles=n`
    :host {
      display: block;
      height: 100%;
      width: 100%;
  ...
  `;render(){const t=(this.sensors||[]).map(t=>{const e=t.device_class,i=Ct[e]||{},s=i.emoji||"❓",o=t.unit||i.units?.[0]||"";return{...t,label:s,unit:o}});return F`
      <div
        class="sensor-grid"
        style="
        ...
        "
      >
        ${t.map(t=>{const e=t.entity||t.entity_id||"",i=e?`Mostra grafico storico: ${e}`:"Mostra grafico storico";return F`
            <div
              class="sensor-pill"
  ...
  `;render(){const{width:t,height:e}=this._containerSize;if(!t||!e)return F``;const i=window.innerWidth||t,s=.55;let o;if(i<=100)o=s;else if(i>=200)o=.25;else{o=s+(.25-s)*((i-100)/100)}const n=Math.min(t,1.6*e),a=.5*(e+n)*o,r=.6*t,c=.6*e,l=r*Math.min(1,t/(2*r)),d=c*Math.min(1,e/(2*c)),h=t-l,u=.5*e,p=Math.max(0,l-a/2-1),b=Math.max(0,d-a/2-1),g=t=>Math.PI*t/180,m=g(30),f=g(85),_=.75*a,v=.75*a,x=[{x:a/2+1,y:a/2+1},{x:h+p*Math.cos(-f),y:u+b*Math.sin(-f)},{x:h+p*Math.cos(-m),y:u+b*Math.sin(-m)},{x:h+p*Math.cos(+m),y:u+b*Math.sin(+m)},{x:h+p*Math.cos(+f),y:u+b*Math.sin(+f)}];let y=0;return F`
      ${this.entities.map(i=>{const s="camera"===i?.kind,o="climate"===i?.kind,n=s?_:o?v:a,r=.95*n;let c;s?c={x:t-n/2,y:n/2}:o?c={x:n/2+1,y:e-n/2-1}:(c=x[Math.min(y,x.length-1)]??{x:h,y:u},y++);const l=s||o?0:i.dx??0,d=s||o?0:i.dy??0,p=c.x+l,b=c.y+d;return F`
          <div
        ...
        `})}
    `}}customElements.define("bubble-mushroom",Nt);class Ut extends st{static properties={icon:{type:String},active:{type:Boolean},colorActive:{type:String},colorInactive:{type:String},backgroundActive:{type:String},backgroundInactive:{type:String}};constructor(){super(),this.icon="",this.active=!1,this.colorActive="#21df73",this.colorInactive="#173c16",this.backgroundActive="rgba(33,223,115,0.12)",this.backgroundInactive="rgba(23,60,22,0.08)"}static styles=n`
    :host {
  ...
  `}customElements.define("bubble-room",Bt),window.customCards.push({type:"bubble-room",name:"Bubble Room",description:"A stylish room control card with environmental sensors",preview:!0,documentationURL:"https://github.com/mon3y78/Lovelace-Bubble-room"});export{Bt as BubbleRoom};
