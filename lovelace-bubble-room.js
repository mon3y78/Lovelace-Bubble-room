      ...
      <div class="card">
        <div class="grid-container">
          ...
          <div class="bubble-sub-button-container">
            ${u.map((t=>{if(!t)return F``;const i=o.states[t.entity]?.state||"off",n="on"===i?e.active:e.inactive,s=this._getFallbackIcon(t.entity),a=t.icon?t.icon:s,r="on"===i?t.icon_color&&t.icon_color.on?t.icon_color.on:"orange":t.icon_color&&t.icon_color.off?t.icon_color.off:"#80808055";return F`
