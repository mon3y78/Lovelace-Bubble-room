 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
var m;f[b]=!0,f.elementProperties=new Map,f.elementStyles=[],f.shadowRootOptions={mode:"open"},null==h||h({ReactiveElement:f}),(null!==(r=c.reactiveElementVersions)&&void 0!==r?r:c.reactiveElementVersions=[]).push("1.6.3");const _=window,v=_.trustedTypes,x=v?v.createPolicy("lit-html",{createHTML:t=>t}):void 0,y="$lit$",$=`lit$${(Math.random()+"").slice(9)}$`,w="?"+$,k=`<${w}>`,A=document,C=()=>A.createComment(""),S=t=>null===t||"object"!=typeof t&&"function"!=typeof t,E=Array.isArray,P="[ \t\n\f\r]",z=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,O=/-->/g,j=/>/g,F=RegExp(`>|${P}(?:([^\\s"'>=/]+)(${P}*=${P}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),M=/'/g,I=/"/g,T=/^(?:script|style|textarea|title)$/i,R=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),B=Symbol.for("lit-noChange"),U=Symbol.for("lit-nothing"),N=new WeakMap,H=A.createTreeWalker(A,129,null,!1);function W(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==x?x.createHTML(e):e}const L=(t,e)=>{const i=t.length-1,s=[];let n,o=2===e?"<svg>":"",a=z;for(let e=0;e<i;e++){const i=t[e];let r,c,l=-1,d=0;for(;d<i.length&&(a.lastIndex=d,c=a.exec(i),null!==c);)d=a.lastIndex,a===z?"!--"===c[1]?a=O:void 0!==c[1]?a=j:void 0!==c[2]?(T.test(c[2])&&(n=RegExp("</"+c[2],"g")),a=F):void 0!==c[3]&&(a=F):a===F?">"===c[0]?(a=null!=n?n:z,l=-1):void 0===c[1]?l=-2:(l=a.lastIndex-c[2].length,r=c[1],a=void 0===c[3]?F:'"'===c[3]?I:M):a===I||a===M?a=F:a===O||a===j?a=z:(a=F,n=void 0);const h=a===F&&t[e+1].startsWith("/>")?" ":"";o+=a===z?i+k:l>=0?(s.push(r),i.slice(0,l)+y+i.slice(l)+$+h):i+$+(-2===l?(s.push(void 0),e):h)}return[W(t,o+(t[i]||"<?>")+(2===e?"</svg>":"")),s]};class D{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let n=0,o=0;const a=t.length-1,r=this.parts,[c,l]=L(t,e);if(this.el=D.createElement(c,i),H.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(s=H.nextNode())&&r.length<a;){if(1===s.nodeType){if(s.hasAttributes()){const t=[];for(const e of s.getAttributeNames())if(e.endsWith(y)||e.startsWith($)){const i=l[o++];if(t.push(e),void 0!==i){const t=s.getAttribute(i.toLowerCase()+y).split($),e=/([.?@])?(.*)/.exec(i);r.push({type:1,index:n,name:e[2],strings:t,ctor:"."===e[1]?Y:"?"===e[1]?Z:"@"===e[1]?X:G})}else r.push({type:6,index:n})}for(const e of t)s.removeAttribute(e)}if(T.test(s.tagName)){const t=s.textContent.split($),e=t.length-1;if(e>0){s.textContent=v?v.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],C()),H.nextNode(),r.push({type:2,index:++n});s.append(t[e],C())}}}else if(8===s.nodeType)if(s.data===w)r.push({type:2,index:n});else{let t=-1;for(;-1!==(t=s.data.indexOf($,t+1));)r.push({type:7,index:n}),t+=$.length-1}n++}}static createElement(t,e){const i=A.createElement("template");return i.innerHTML=t,i}}function V(t,e,i=t,s){var n,o,a,r;if(e===B)return e;let c=void 0!==s?null===(n=i._$Co)||void 0===n?void 0:n[s]:i._$Cl;const l=S(e)?void 0:e._$litDirective$;return(null==c?void 0:c.constructor)!==l&&(null===(o=null==c?void 0:c._$AO)||void 0===o||o.call(c,!1),void 0===l?c=void 0:(c=new l(t),c._$AT(t,i,s)),void 0!==s?(null!==(a=(r=i)._$Co)&&void 0!==a?a:r._$Co=[])[s]=c:i._$Cl=c),void 0!==c&&(e=V(t,c._$AS(t,e.values),c,s)),e}class q{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:i},parts:s}=this._$AD,n=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:A).importNode(i,!0);H.currentNode=n;let o=H.nextNode(),a=0,r=0,c=s[0];for(;void 0!==c;){if(a===c.index){let e;2===c.type?e=new J(o,o.nextSibling,this,t):1===c.type?e=new c.ctor(o,c.name,c.strings,this,t):6===c.type&&(e=new Q(o,this,t)),this._$AV.push(e),c=s[++r]}a!==(null==c?void 0:c.index)&&(o=H.nextNode(),a++)}return H.currentNode=A,n}v(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class J{constructor(t,e,i,s){var n;this.type=2,this._$AH=U,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cp=null===(n=null==s?void 0:s.isConnected)||void 0===n||n}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===(null==t?void 0:t.nodeType)&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=V(this,t,e),S(t)?t===U||null==t||""===t?(this._$AH!==U&&this._$AR(),this._$AH=U):t!==this._$AH&&t!==B&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):(t=>E(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]))(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==U&&S(this._$AH)?this._$AA.nextSibling.data=t:this.$(A.createTextNode(t)),this._$AH=t}g(t){var e;const{values:i,_$litType$:s}=t,n="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=D.createElement(W(s.h,s.h[0]),this.options)),s);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===n)this._$AH.v(i);else{const t=new q(n,this),e=t.u(this.options);t.v(i),this.$(e),this._$AH=t}}_$AC(t){let e=N.get(t.strings);return void 0===e&&N.set(t.strings,e=new D(t)),e}T(t){E(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const n of t)s===e.length?e.push(i=new J(this.k(C()),this.k(C()),this,this.options)):i=e[s],i._$AI(n),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){var i;for(null===(i=this._$AP)||void 0===i||i.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cp=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class G{constructor(t,e,i,s,n){this.type=1,this._$AH=U,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=n,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=U}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,i,s){const n=this.strings;let o=!1;if(void 0===n)t=V(this,t,e,0),o=!S(t)||t!==this._$AH&&t!==B,o&&(this._$AH=t);else{const s=t;let a,r;for(t=n[0],a=0;a<n.length-1;a++)r=V(this,s[i+a],e,a),r===B&&(r=this._$AH[a]),o||(o=!S(r)||r!==this._$AH[a]),r===U?t=U:t!==U&&(t+=(null!=r?r:"")+n[a+1]),this._$AH[a]=r}o&&!s&&this.j(t)}j(t){t===U?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class Y extends G{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===U?void 0:t}}const K=v?v.emptyScript:"";class Z extends G{constructor(){super(...arguments),this.type=4}j(t){t&&t!==U?this.element.setAttribute(this.name,K):this.element.removeAttribute(this.name)}}class X extends G{constructor(t,e,i,s,n){super(t,e,i,s,n),this.type=5}_$AI(t,e=this){var i;if((t=null!==(i=V(this,t,e,0))&&void 0!==i?i:U)===B)return;const s=this._$AH,n=t===U&&s!==U||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==U&&(s===U||n);n&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,i;"function"==typeof this._$AH?this._$AH.call(null!==(i=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==i?i:this.element,t):this._$AH.handleEvent(t)}}class Q{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){V(this,t)}}const tt=_.litHtmlPolyfillSupport;null==tt||tt(D,J),(null!==(m=_.litHtmlVersions)&&void 0!==m?m:_.litHtmlVersions=[]).push("2.8.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var et,it;class st extends f{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const i=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=i.firstChild),i}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{var s,n;const o=null!==(s=null==i?void 0:i.renderBefore)&&void 0!==s?s:e;let a=o._$litPart$;if(void 0===a){const t=null!==(n=null==i?void 0:i.renderBefore)&&void 0!==n?n:null;o._$litPart$=a=new J(e.insertBefore(C(),t),t,void 0,null!=i?i:{})}return a._$AI(t),a})(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!1)}render(){return B}}st.finalized=!0,st._$litElement$=!0,null===(et=globalThis.litElementHydrateSupport)||void 0===et||et.call(globalThis,{LitElement:st});const nt=globalThis.litElementPolyfillSupport;null==nt||nt({LitElement:st}),(null!==(it=globalThis.litElementVersions)&&void 0!==it?it:globalThis.litElementVersions=[]).push("3.3.3");const ot={alarm_control_panel:"Allarmi",binary_sensor:"Sensori Binari",camera:"Telecamere",climate:"Clima",cover:"Tapparelle",fan:"Ventola",light:"Luce",lock:"Serratura",media_player:"Media Player",scene:"Scene",script:"Script",siren:"Sirena",vacuum:"Aspirapolvere",motion:"Movimento",occupancy:"Occupazione",presence:"Presenza",switch:"Pulsante"},at=["alarm_control_panel","binary_sensor","camera","climate","cover","fan","light","lock","media_player","scene","script","siren","switch","vacuum"],rt=(t=[])=>({includeDomains:at,entityFilter:(e,i)=>{if(!t.length)return!1;const[s]=e.split(".");if("binary_sensor"===s){const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}return t.includes(s)}}),ct=(t=[])=>({includeDomains:["sensor"],entityFilter:(e,i)=>{if(!t.length)return!0;const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}}),lt=(t=[])=>({includeDomains:at,entityFilter:(e,i)=>{if(!t.length)return"binary_sensor"===e.split(".")[0];const[s]=e.split(".");if("binary_sensor"===s){const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}return t.includes(s)}}),dt=(t=[])=>({includeDomains:at,entityFilter:(e,i)=>{if(!t.length)return at.includes(e.split(".")[0]);const[s]=e.split(".");if("binary_sensor"===s){const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}return at.includes(s)}}),ht=(t=[])=>({includeDomains:["camera"],entityFilter:(e,i)=>{if(!t.length)return!0;const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}}),pt=(t=[])=>({includeDomains:["climate"],entityFilter:(t,e)=>!0});function ut(t){return"string"==typeof t&&t.trim().length>0}function gt(t,e,i){if(!ut(i))return!0;const s=function(t){if(!t)return{};if(!Array.isArray(t))return t;const e={};for(const i of t){const t=i?.entity_id||i?.id;t&&(e[t]=i)}return e}(t?.entities),n=function(t){if(!t)return{};if(!Array.isArray(t))return t;const e={};for(const i of t){const t=i?.id||i?.device_id;t&&(e[t]=i)}return e}(t?.devices),o=s[e];if(o?.area_id===i)return!0;const a=o?.device_id||o?.deviceId;if(a&&n[a]?.area_id===i)return!0;const r=t?.states?.[e]?.attributes?.area_id;return r===i}function bt(t,e,i,s=[]){if(!t?.states)return[];let n;if("presence"===i?n=rt(s):"sensor"===i?n=ct(s):"mushroom"===i?n=lt(s):"subbutton"===i?n=dt(s):"camera"===i?n=ht(s):"climate"===i&&(n=pt(s)),!n)return[];const o=Object.keys(t.states).filter(t=>n.includeDomains.includes(t.split(".")[0])).filter(e=>n.entityFilter(e,t));let a=o;const r="string"==typeof e?.area_id?e.area_id:e?.area;if(ut(r)){const e=function(t,e){return t?.states&&ut(e)?Object.keys(t.states).filter(i=>gt(t,i,e)):[]}(t,r),i=o.filter(t=>e.includes(t));i.length&&(a=i)}const c=e?.entities?.[i],l=function(t){const e=new Set,i=t=>{t&&("string"==typeof t&&t.includes(".")?e.add(t):Array.isArray(t)?t.forEach(i):"object"==typeof t&&Object.values(t).forEach(i))};return i(t),Array.from(e)}(c);return function(t,e){const i=Array.from(new Set(t)),s=Array.isArray(e)?e:e?[e]:[];for(let t=s.length-1;t>=0;t--){const e=s[t];e&&!i.includes(e)&&i.unshift(e)}return i}(a,l)}const ft=!!window.__BUBBLE_DEBUG__;function mt(t,e){const i=Array.isArray(e?.area)?e.area[0]:e?.area,s="string"!=typeof i||i.startsWith("area_")?"":i;let n="string"==typeof i&&i.startsWith("area_")?i:"";const o=Array.isArray(t?.areas)?t.areas:[];if(!n&&o.length&&s){const t=o.find(t=>(t.name||"").toLowerCase()===String(s).toLowerCase());t?.area_id&&(n=t.area_id)}return{areaId:n,areaName:s}}function _t(t,e,i,s){if(!i&&!s)return!0;const n=t?.entities,o=t?.devices,a=n?.[e];if(a?.area_id&&i)return a.area_id===i;if(a?.device_id&&Array.isArray(o)){const t=o.find(t=>t.id===a.device_id||t.device_id===a.device_id);if(t?.area_id&&i)return t.area_id===i}const r=t?.states?.[e];if(r){const t=r.attributes?.area_id,e=r.attributes?.area;if(i&&t)return t===i;if(s&&e)return String(e).toLowerCase()===String(s).toLowerCase()}return!0}function vt(t,e,i){let s=bt(t,e,i)||[];return!s.length&&t?.states&&(s=Object.keys(t.states)),s}function xt(t,e,i,s){const n={...e.entities||{}},o=n[s]||(n[s]={});if(o.entity)return{...e,entities:n};let a=vt(t,e,i);a.length||(a=vt(t,e,"mushroom")),a=(a||[]).filter(t=>t.startsWith(`${i}.`));const r=mt(t,e),c=function(t,e,i,s){const{areaId:n,areaName:o}=i,a=(e||[]).filter(e=>_t(t,e,n,o));return s&&!a.includes(s)&&a.unshift(s),Array.from(new Set(a))}(t,a,r,o.entity),l=c[0]||a[0]||"";return l&&(o.entity=l),ft&&console.info(`[AutoDiscovery][${s}]`,{domain:i,chosen:o.entity,areaRef:r,pool:a.length,filtered:c.length}),{...e,entities:n}}const yt=(t,e)=>t.find(t=>!e.has(t))||null;function $t(t,e){const i={...e.entities||{}},s=i.presence||(i.presence={});if(!s.entity){const i=function(t,e){if(!t||!t.states)return[];const i=new Set(["person","device_tracker","binary_sensor","light","switch","media_player","fan","humidifier","lock","input_boolean","scene"]);let s=Object.keys(t.states).filter(t=>i.has(t.split(".")[0]));s=s.filter(e=>{if("binary_sensor"!==e.split(".")[0])return!0;const i=t.states[e]?.attributes?.device_class;return["motion","occupancy","presence"].includes(i||"")});const{areaId:n,areaName:o}=mt(t,e);if(n||o){const e=s.filter(e=>_t(t,e,n,o));e.length&&(s=e)}const a=e?.entities?.presence?.entity||e?.presence_entity;return a&&!s.includes(a)&&s.unshift(a),ft&&console.info("[AutoDiscovery][presence candidates]",{areaId:n,areaName:o,count:s.length,sample:s.slice(0,8)}),s}(t,e);i.length&&(s.entity=i[0])}return{...e,entities:i}}function wt(t,e,i,s=!1){if(!t||!e)return e;const n=e.auto_discovery_sections||{},o="area"===i,a=i&&String(i).startsWith("auto_discovery_sections.");if(!o&&!a)return e;let r=e;return n.sensor&&(r=function(t,e){const i=["sensor1","sensor2","sensor3","sensor4","sensor5","sensor6","sensor7","sensor8"],s={...e.entities||{}},n=new Set(i.map(t=>s[t]?.entity||s[t]?.entity_id).filter(Boolean));for(const o of i){const i=s[o]||(s[o]={});if(i.entity||i.entity_id)continue;const a=bt(t,e,{section:"sensor",type:i.type||""})||[],r=yt(a,n);r&&(i.entity=r,delete i.entity_id,n.add(r))}return{...e,entities:s}}(t,r)),n.mushroom&&(r=function(t,e){const i={...e.entities||{}},s=new Set(["climate","camera","mushroom1","mushroom2","mushroom3","mushroom4","mushroom5"].map(t=>i[t]?.entity).filter(Boolean));let n=vt(t,e,"mushroom");const o=i.climate||(i.climate={});if(!o.entity){const t=n.find(t=>t.startsWith("climate.")&&!s.has(t));t&&(o.entity=t,s.add(t))}const a=i.camera||(i.camera={});if(!a.entity){const t=n.find(t=>t.startsWith("camera.")&&!s.has(t));t&&(a.entity=t,s.add(t))}for(let t=1;t<=5;t++){const e=`mushroom${t}`,o=i[e]||(i[e]={});if(o.entity)continue;const a=yt(n,s);a&&(o.entity=a,s.add(a))}return{...e,entities:i}}(t,r)),n.subbutton&&(r=function(t,e){const i=["sub-button1","sub-button2","sub-button3","sub-button4","sub-button5","sub-button6"],s={...e.entities||{}},n=new Set(i.map(t=>s[t]?.entity).filter(Boolean)),o=bt(t,e,"subbutton")||[];for(const t of i){const e=s[t]||(s[t]={});if(e.entity)continue;const i=yt(o,n);i&&(e.entity=i,n.add(i))}return{...e,entities:s}}(t,r)),n.presence&&(r=$t(t,r)),n.climate&&(r=function(t,e){return xt(t,e,"climate","climate")}(t,r)),n.camera&&(r=function(t,e){return xt(t,e,"camera","camera")}(t,r)),(s||ft)&&"undefined"!=typeof window&&console.info("[AutoDiscovery] applied after",i,{sections:n}),r}let kt;try{const{IconCache:t}=await Promise.resolve().then(function(){return zt});kt=t}catch(t){kt={_m:new Map,get(t){return this._m.get(t)},set(t,e){this._m.set(t,e)}}}const At="mdi:bookmark",Ct={light:"mdi:lightbulb",switch:"mdi:toggle-switch",fan:"mdi:fan",climate:"mdi:thermostat",cover:"mdi:window-shutter",media_player:"mdi:play-circle",script:"mdi:script-text",scene:"mdi:palette",lock:"mdi:lock",camera:"mdi:video",binary_sensor:"mdi:checkbox-marked-circle-outline",sensor:"mdi:eye",alarm_control_panel:"mdi:shield-home",vacuum:"mdi:robot-vacuum",siren:"mdi:bullhorn"},St={door:{on:"mdi:door-open",off:"mdi:door-closed"},window:{on:"mdi:window-open",off:"mdi:window-closed"},motion:{on:"mdi:motion-sensor",off:"mdi:motion-sensor-off"},moisture:{on:"mdi:water-alert",off:"mdi:water-off"},smoke:{on:"mdi:smoke",off:"mdi:smoke-detector-off"},gas:{on:"mdi:gas-cylinder",off:"mdi:gas-off"},lock:{on:"mdi:lock-open-variant",off:"mdi:lock"},garage:{on:"mdi:garage-open",off:"mdi:garage"},light:{on:"mdi:lightbulb-on",off:"mdi:lightbulb-off"},plug:{on:"mdi:power-plug",off:"mdi:power-plug-off"},presence:{on:"mdi:account",off:"mdi:account-off"},vibration:{on:"mdi:vibrate",off:"mdi:vibrate-off"},opening:{on:"mdi:door-open",off:"mdi:door-closed"},battery:{on:"mdi:battery",off:"mdi:battery-outline"},connectivity:{on:"mdi:wifi",off:"mdi:wifi-off"},safety:{on:"mdi:shield-check",off:"mdi:shield-off"},cold:{on:"mdi:snowflake",off:"mdi:snowflake-off"}};function Et(t,e){const{entityId:i,hass:s}=function(t,e){return t&&"object"==typeof t&&t.states&&"string"==typeof e?{entityId:e,hass:t}:{entityId:t,hass:e}}(t,e);if(!i)return At;const n=kt?.get?.(i);if(n)return n;const o=s?.states?.[i],a=o?.attributes||{},r=function(t){return(t||"").split(".")[0]||""}(i),c=a.icon;if(c)return kt?.set?.(i,c),c;const l=a.device_class?function(t,e){const i=St[t];return i?function(t){return"on"===t||"open"===t||"unlocked"===t||"playing"===t||"active"===t}(e)?i.on:i.off:null}(a.device_class,o?.state):null;if(l)return kt?.set?.(i,l),l;const d=Ct[r]||At;return kt?.set?.(i,d),d}const Pt={_list:null,get(t){if(this._list)return this._list;const e=t?.mdiIcons||null;return this._list=e?Object.keys(e).sort():[],this._list},warm(t){return this.get(t)}};var zt=Object.freeze({__proto__:null,IconCache:Pt});const Ot=["presence","motion","occupancy","light","switch","fan"];class jt extends st{static properties={hass:{type:Object},config:{type:Object},_expanded:{type:Boolean,state:!0},activeFilters:{type:Array,state:!0},layout:{type:String}};static styles=o`
    :host { display: block; }
  ...
  `;constructor(){super(),this.hass={},this.config={},this._expanded=!1,this.activeFilters=[],this.layout="wide",this._syncingFromConfig=!1}updated(t){if(!t.has("config")&&!t.has("hass"))return;if(this._syncingFromConfig=!0,(this.config?.area||this.config?.area_id)&&wt(this.hass,this.config,"area",!1),Pt.warm(this.hass),t.has("config")){Array.isArray(this.config?.presence_filters)&&(this.activeFilters=[...this.config.presence_filters]);const t=this.config?.layout;t&&t!==this.layout&&(this.layout=t)}this._syncingFromConfig=!1;const e=this.config?.entities?.presence?.entity,i=this.config?.icon||"";if(e&&!i){const t=this.hass?.states?.[e],i=t?.attributes?.icon||Et(e,this.hass);i&&this._fire("icon",i)}}_onLayoutClick(t){this.layout=t,this._fire("layout",t);const e="tall"===t?{columns:6,rows:4}:{columns:12,rows:4};this._fire("grid_options",e)}_fire(t,e){this._syncingFromConfig||this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:t,val:e},bubbles:!0,composed:!0}))}_onPresenceEntityChange=t=>{this._fire("entities.presence.entity",t);const e=this.config?.icon||"";if(t&&!e){const e=this.hass?.states?.[t],i=e?.attributes?.icon||Et(t,this.hass);i&&this._fire("icon",i)}};_onAreaChange(t){const e=this.config||{},i={...e.auto_discovery_sections||{}};t&&!e.area&&(i.camera=!0,i.climate=!0,i.sensor=!0,i.mushroom=!0,i.subbutton=!0,i.presence=!0);const s={...e,area:t,area_id:t,auto_discovery_sections:i};t&&(s.name=t.toUpperCase()),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:s},bubbles:!0,composed:!0}))}render(){const t=this.config,e=t.auto_discovery_sections?.presence??!1,i=t.area??"",s=t.name??"",n=t.icon??"",o=t.entities?.presence?.entity??"",a=this.activeFilters.length?this.activeFilters:t.presence_filters??[...Ot],r=Ot.map(t=>({value:t,label:t.charAt(0).toUpperCase()+t.slice(1)})),c=bt(this.hass,this.config,"presence",a),l=["toggle","more-info","navigate","call-service","none"],d=this.config?.tap_action||{},h=this.config?.hold_action||{};return R`
      <ha-expansion-panel
        class="glass-panel"
  ...
  `;render(){const t=this.config.auto_discovery_sections?.sensor??!1,e=Object.entries(Ft).filter(([t])=>"_fallback"!==t).map(([t,e])=>{const i=e.label||t.replace(/_/g," ").replace(/\b\w/g,t=>t.toUpperCase());return{value:t,label:`${e.emoji||""} ${i}`.trim()}});return R`
      <ha-expansion-panel
        class="glass-panel"
    ...
    `}_renderSensor(t,e,i){const s=this._filters[t],n=this._entities[t],o=bt(this.hass,this.config,"sensor",s);return R`
      <div class="mini-pill ${e?"expanded":""}">
        ...
        ${e?R`
          <div class="mini-pill-content">
            ...
            ${n?(()=>{const t=this.hass.states[n],e=t?.attributes?.device_class,i=Ft[e]||{},s=i.emoji||"❓",o=t?.attributes?.unit_of_measurement||(i.units?.[0]??"");return R`
                <div class="preview">
    ...
    `}_toggleAuto(t){this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"auto_discovery_sections.sensor",val:t},bubbles:!0,composed:!0}))}_togglePill(t){this._expanded=this._expanded.map((e,i)=>i===t&&!e),this.requestUpdate()}_onFilter(t,e){this._filters[t]=[...e],this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"sensor_filters",val:this._filters},bubbles:!0,composed:!0}))}_onEntity(t,e){this._entities[t]=e,this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.sensor${t+1}.entity`,val:e},bubbles:!0,composed:!0}))}_reset(){this._expanded=Array(8).fill(!1);const t=Object.keys(Ft);this._filters=Array(8).fill().map(()=>[...t]),this._entities=Array(8).fill(""),this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"sensor_filters",val:this._filters},bubbles:!0,composed:!0}));for(let t=1;t<=8;t++)this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.sensor${t}.entity`,val:""},bubbles:!0,composed:!0}))}}customElements.define("sensor-panel",Mt);class It extends st{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_expanded:{type:Array,state:!0},_filters:{type:Array,state:!0},_entities:{type:Array,state:!0},_icons:{type:Array,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._expanded=Array(5).fill(!1),this._filters=Array(5).fill().map(()=>[...at]),this._entities=Array(5).fill(""),this._icons=Array(5).fill(""),this._syncingFromConfig=!1}updated(t){if(!t.has("config")&&!t.has("hass"))return;this._syncingFromConfig=!0,(this.config?.area||this.config?.area_id)&&wt(this.hass,this.config,"area",!1);const e=this.config?.mushroom_filters;Array.isArray(e)&&5===e.length&&(this._filters=e.map(t=>Array.isArray(t)?[...t]:[...at]));const i=this.config?.entities||{};for(let t=0;t<5;t++){const e=i[`mushroom${t+1}`]||{};e.entity&&(this._entities[t]=e.entity),"string"==typeof e.icon&&(this._icons[t]=e.icon)}this._syncingFromConfig=!1;const s=[];for(let t=0;t<5;t++){const e=`mushroom${t+1}`,i=this._entities[t],n=this.config?.entities?.[e]?.icon;if(i&&!n){const n=this.hass?.states?.[i],o=n?.attributes?.icon,a=o||Et(i,this.hass);a&&s.push({i:t,key:e,icon:a})}}if(s.length)for(const{i:t,key:e,icon:i}of s)this._icons[t]=i,this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.${e}.icon`,val:i},bubbles:!0,composed:!0}))}static styles=o`
    :host { display: block; }
    .glass-panel {
      margin: 0 !important;
      width: 100%;
  ...
  `;render(){const t=this.config?.auto_discovery_sections?.mushroom??!1,e=at.map(t=>({value:t,label:ot[t]||t.charAt(0).toUpperCase()+t.slice(1)}));return R`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
    ...
    `}_renderMushroom(t,e,i){const s=`mushroom${t+1}`,n=this._filters[t],o=this._entities[t],a=this._icons[t],r=this.config.entities&&this.config.entities[s]?this.config.entities[s]:{},c=bt(this.hass,this.config,"mushroom",n),l=["toggle","more-info","navigate","call-service","none"];return R`
      <div class="mini-pill ${e?"expanded":""}">
        <div class="mini-pill-header" @click=${()=>this._togglePill(t)}>
          Mushroom ${t+1}
          <span class="chevron">${e?"▼":"▶"}</span>
    ...
    `}_extraFields(t,e,i){const s=i?.[`${e}_action`]?.action;return"navigate"===s?R`
        <input type="text" placeholder="Path"
      ...
      `:"call-service"===s?R`
        ...
        />
      `:""}_safeJson(t){try{return JSON.parse(t)}catch{return{}}}_toggleAuto(t){this._syncingFromConfig||this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"auto_discovery_sections.mushroom",val:t},bubbles:!0,composed:!0}))}_togglePill(t){this._expanded=this._expanded.map((e,i)=>i===t&&!e),this.requestUpdate()}_onFilter(t,e){this._filters[t]=[...e],this._syncingFromConfig||this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"mushroom_filters",val:this._filters},bubbles:!0,composed:!0}))}_onEntity(t,e){if(this._entities[t]=e,!this._syncingFromConfig){this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.mushroom${t+1}.entity`,val:e},bubbles:!0,composed:!0}));if(!(this.config?.entities?.[`mushroom${t+1}`]?.icon||"")){const i=this.hass?.states?.[e],s=i?.attributes?.icon,n=s||Et(e,this.hass);n&&(this._icons[t]=n,this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.mushroom${t+1}.icon`,val:n},bubbles:!0,composed:!0})))}}}_onIcon(t,e){this._icons[t]=e||"",this._syncingFromConfig||this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.mushroom${t+1}.icon`,val:this._icons[t]},bubbles:!0,composed:!0}))}_onAction(t,e,i,s){if(this._syncingFromConfig)return;const n=`mushroom${t+1}`,o={...this.config?.entities?.[n]?.[`${e}_action`]||{},[i]:s};this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.${n}.${e}_action`,val:o},bubbles:!0,composed:!0}))}_reset(){this._expanded=Array(5).fill(!1),this._filters=Array(5).fill().map(()=>[...at]),this._entities=Array(5).fill(""),this._icons=Array(5).fill(""),this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"mushroom_filters",val:this._filters},bubbles:!0,composed:!0}));for(let t=1;t<=5;t++)this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.mushroom${t}.entity`,val:""},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.mushroom${t}.icon`,val:""},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.mushroom${t}.tap_action`,val:{action:"none"}},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:`entities.mushroom${t}.hold_action`,val:{action:"none"}},bubbles:!0,composed:!0}))}_autoIconFor(t){if(!t)return"";const e=this.hass?.states?.[t];return e?.attributes?.icon||Et(t,this.hass)}}customElements.define("mushroom-panel",It);class Tt extends st{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_expanded:{type:Array,state:!0},_filters:{type:Array,state:!0},_entities:{type:Array,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._expanded=Array(4).fill(!1),this._filters=Array(4).fill().map(()=>[...at]),this._entities=Array(4).fill(""),this._syncingFromConfig=!1}updated(t){if(!t.has("config")&&!t.has("hass"))return;this._syncingFromConfig=!0,(this.config?.area||this.config?.area_id)&&wt(this.hass,this.config,"area",!1);const e=Array.isArray(this.config?.subbuttons)?this.config.subbuttons:[],i=Array.from({length:4},(t,i)=>e[i]||{}),s=this.config?.subbutton_filters;Array.isArray(s)&&4===s.length&&(this._filters=s.map(t=>Array.isArray(t)?[...t]:[...at]));for(let t=0;t<4;t++)this._entities[t]=i[t]?.entity_id||"";this._syncingFromConfig=!1;const n=i.map(t=>{const e=t?.entity_id||"";if(e&&!(t?.icon||"")){const i=this.hass?.states?.[e],s=i?.attributes?.icon,n=s||Et(e,this.hass);return n?{...t||{},icon:n}:t||{}}return t||{}});JSON.stringify(n)!==JSON.stringify(e.slice(0,4))&&this._emit("subbuttons",n)}static styles=o`
    :host { display: block; }
    .glass-panel {
    ...
    .mini-pill-header {
      ...
      cursor: pointer; user-select: none; font-weight: 700; color: #b28fff;
    }
    .mini-pill-header .chevron { margin-left:auto; transition:transform .2s; }
    ...
    .reset-row { display:flex; gap:10px; justify-content:center; margin:20px 0; }
    .reset-button, .add-button {
      ...
      font-size:1rem; font-weight:700; box-shadow: 0 2px 24px #ff4c6a44;
    }
    .add-button { border-color:#2ecc71; color:#2ecc71; box-shadow: 0 2px 24px #2ecc7144; }
  `;render(){const t=this.config?.auto_discovery_sections?.subbutton??!1,e=at.map(t=>({value:t,label:ot[t]||t.charAt(0).toUpperCase()+t.slice(1)})),i=[];for(let t=0;t<4;t++)(this._expanded[t]||this._hasContent(t))&&i.push(t);return R`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
      ...
      >
        ...
        <div class="input-group autodiscover">
          <input type="checkbox" .checked=${t} @change=${t=>this._toggleAuto(t.target.checked)} />
          <label>🪄 Auto-discover Subbuttons</label>
        </div>

        ${i.map(t=>this._renderSubButton(t,e))}

        <div class="reset-row">
          <button class="add-button" @click=${this._addSlot}>＋ Add sub-button</button>
          <button class="reset-button" @click=${()=>this._reset()}>🧹 Reset Sub-buttons</button>
        </div>
      </ha-expansion-panel>
    `}_renderSubButton(t,e){const i=this._filters[t],s=this._entities[t],n=bt(this.hass,this.config,"subbutton",i),o=Array.isArray(this.config?.subbuttons)&&this.config.subbuttons[t]||{},a=["toggle","more-info","navigate","call-service","none"],r=!!this._expanded[t];return R`
      <div class="mini-pill ${r?"expanded":""}">
        <div class="mini-pill-header" @click=${()=>this._togglePill(t)}>
          Sub-button ${t+1} <span class="chevron">${r?"▼":"▶"}</span>
        </div>
          ...
          <div class="mini-pill-content">
            <div class="input-group">
              ...
              <ha-selector
                .hass=${this.hass}
                .value=${i}
                .selector=${{select:{multiple:!0,mode:"box",options:e}}}
                @value-changed=${e=>this._onFilter(t,e.detail.value)}
              ></ha-selector>
            </div>
            ...
            ${["tap","hold"].map(e=>R`
              <div class="input-group">
                ...
                <div class="pill-group">
                  ${a.map(i=>R`
                    <button
                      class="pill-button ${o[`${e}_action`]?.action===i?"active":""}"
                      @click=${()=>this._onAction(t,e,"action",i)}
                    >${i}</button>
                  `)}
                </div>
                ${this._extraFields(t,e,o)}
              </div>
            `)}
          </div>
        `:""}
  ...
  `;render(){return R`
    ...
    `}_renderPresetChooser(){const t=Object.keys(this.PRESETS);return R`
    ...
    `}_renderPresetCard(t,e){const i=this._selectedPreset===t?"selected":"",s=e.room.background_active,n=e.room.background_inactive,o=e.room.icon_active,a=e.room.icon_inactive;return R`
    ...
    `}_toggleColor(t){this._expandedColors=this._expandedColors.map((e,i)=>i===t&&!e)}_renderColorField(t,e,i){const s=this.config?.colors?.[t]?.[e]||"",[n,o,a,r]=this._parseRGBA(s),c=`#${[n,o,a].map(t=>t.toString(16).padStart(2,"0")).join("")}`;return R`
      <div class="input-group">
        <label>${i}</label>
        <input
          type="color"
  ...
  `;render(){const t=this.config?.auto_discovery_sections?.camera??!1;return R`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
        @expanded-changed=${t=>this.expanded=t.detail.expanded}
    ...
    `}_toggleAuto(t){this._syncingFromConfig||this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"auto_discovery_sections.camera",val:t},bubbles:!0,composed:!0}))}_onEntity(t){if(this._entity=t||"",this._syncingFromConfig)return;this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"entities.camera.entity",val:this._entity},bubbles:!0,composed:!0}));if(!(this.config?.entities?.camera?.icon||"")&&this._entity){const t=this.hass?.states?.[this._entity],e=t?.attributes?.icon,i=e||Et(this._entity,this.hass);i&&(this._icon=i,this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"entities.camera.icon",val:i},bubbles:!0,composed:!0})))}}_onIcon(t){this._icon=t||"",this._syncingFromConfig||this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"entities.camera.icon",val:this._icon},bubbles:!0,composed:!0}))}}customElements.define("camera-panel",Bt);class Ut extends st{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_entity:{type:String,state:!0},_icon:{type:String,state:!0},_candidates:{type:Array,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._entity="",this._icon="",this._candidates=[],this._syncingFromConfig=!1}updated(t){if(!t.has("config")&&!t.has("hass"))return;this._syncingFromConfig=!0,(this.config?.area||this.config?.area_id)&&wt(this.hass,this.config,"area",!1);const e=this.config?.entities?.climate?.entity||"",i=this.config?.entities?.climate?.icon||"";this._entity=e,this._icon=i;const s=bt(this.hass,this.config,"climate")||[];if(this._candidates=Array.isArray(s)?s:[],this._entity&&!this._icon){const t=this.hass?.states?.[this._entity],e=t?.attributes?.icon,i=e||Et(this._entity,this.hass);i&&(this._icon=i,this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:"entities.climate.icon",val:i},bubbles:!0,composed:!0})))}this._syncingFromConfig=!1}static styles=o`
    :host { display: block; }
    .glass-panel {
      margin: 0 !important; width: 100%; box-sizing: border-box;
      border-radius: 40px; position: relative;
  ...
  `;render(){const t=this.config?.auto_discovery_sections?.climate??!1;return R`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
        @expanded-changed=${t=>this.expanded=t.detail.expanded}
  ...
  `;render(){const t=this.config||{};return R`
    ...
    `}}customElements.define("bubble-room-editor",Nt);var Ht=Object.freeze({__proto__:null,BubbleRoomEditor:Nt});class Wt extends st{static properties={subbuttons:{type:Array}};constructor(){super(),this.subbuttons=[],this._holdThreshold=500,this._holdTimer=null,this._holdFired=!1,this._currentIndex=-1}static styles=o`
    :host {
      display: block;
      height: 100%;
      width: 100%;
  ...
  `;render(){return R`
      <div class="container">
        ${this.subbuttons.map((t,e)=>{const i=t.active?t.colorOn:t.colorOff,s=t.active?t.iconOn:t.iconOff;return R`
            <div
              class="sub-button"
  ...
  `;render(){const t=(this.sensors||[]).map(t=>{const e=t.device_class,i=Ft[e]||{},s=i.emoji||"❓",n=t.unit||i.units?.[0]||"";return{...t,label:s,unit:n}});return R`
      <div
        class="sensor-grid"
        style="
        ...
        "
      >
        ${t.map(t=>{const e=t.entity||t.entity_id||"",i=e?`Mostra grafico storico: ${e}`:"Mostra grafico storico";return R`
            <div
              class="sensor-pill"
  ...
  `;render(){const{width:t,height:e}=this._containerSize;if(!t||!e)return R``;const i=window.innerWidth||t,s=.55;let n;if(i<=100)n=s;else if(i>=200)n=.25;else{n=s+(.25-s)*((i-100)/100)}const o=Math.min(t,1.6*e),a=.5*(e+o)*n,r=.6*t,c=.6*e,l=r*Math.min(1,t/(2*r)),d=c*Math.min(1,e/(2*c)),h=t-l,p=.5*e,u=Math.max(0,l-a/2-1),g=Math.max(0,d-a/2-1),b=t=>Math.PI*t/180,f=b(30),m=b(85),_=.75*a,v=.75*a,x=[{x:a/2+1,y:a/2+1},{x:h+u*Math.cos(-m),y:p+g*Math.sin(-m)},{x:h+u*Math.cos(-f),y:p+g*Math.sin(-f)},{x:h+u*Math.cos(+f),y:p+g*Math.sin(+f)},{x:h+u*Math.cos(+m),y:p+g*Math.sin(+m)}];let y=0;return R`
      ${this.entities.map(i=>{const s="camera"===i?.kind,n="climate"===i?.kind,o=s?_:n?v:a,r=.95*o;let c;s?c={x:t-o/2,y:o/2}:n?c={x:o/2+1,y:e-o/2-1}:(c=x[Math.min(y,x.length-1)]??{x:h,y:p},y++);const l=s||n?0:i.dx??0,d=s||n?0:i.dy??0,u=c.x+l,g=c.y+d;return R`
          <div
        ...
        `})}
    `}}customElements.define("bubble-mushroom",Vt);class qt extends st{static properties={icon:{type:String},active:{type:Boolean},colorActive:{type:String},colorInactive:{type:String},backgroundActive:{type:String},backgroundInactive:{type:String}};constructor(){super(),this.icon="",this.active=!1,this.colorActive="#21df73",this.colorInactive="#173c16",this.backgroundActive="rgba(33,223,115,0.12)",this.backgroundInactive="rgba(23,60,22,0.08)"}static styles=o`
    :host {
  ...
  `;render(){const t=this.active?this.colorActive:this.colorInactive,e=this.active?this.backgroundActive:this.backgroundInactive;return R`
  ...
  `}customElements.define("bubble-room",Jt),window.customCards.push({type:"bubble-room",name:"Bubble Room",description:"A stylish room control card with environmental sensors",preview:!0,documentationURL:"https://github.com/mon3y78/Lovelace-Bubble-room"});export{Jt as BubbleRoom};
