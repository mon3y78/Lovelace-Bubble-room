...
`;class Pt extends st{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_expanded:{type:Array,state:!0},_filters:{type:Array,state:!0},_entities:{type:Array,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._expanded=Array(5).fill(!1);const t=Object.keys(zt);this._filters=Array(5).fill().map(()=>[...t]),this._entities=Array(5).fill(""),this._ignoreNextFilterChange=new Set}updated(t){if(t.has("config")||t.has("hass")){const t=_t(this.hass,this.config,"auto_discovery_sections.sensor");t&&t!==this.config&&this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}));for(let t=0;t<5;t++){const e=`sensor${t+1}`,i=this.config?.sensor_filters?.[t],s=this.config?.entities?.[e]?.entity;Array.isArray(i)&&(this._filters[t]=[...i]),s&&(this._entities[t]=s)}}}static styles=[Mt,n`
  ...
  `;render(){return"standard"===this.preset?this._renderStandard():this._renderLiquidGlass()}_renderStandard(){return I`
    ...
    `}_renderLiquidGlass(){return I`
      <div class="container">
        ${this.subbuttons.map((t,e)=>{const i=t.active?t.colorOn:t.colorOff,s=t.active?t.iconOn:t.iconOff,o=this._computeGlassColors(i,t.active),n=[];if(s&&n.push(`--bubble-subbutton-color:${s}`),o)n.push(`--bubble-subbutton-bg:${o.surface}`),n.push(`--bubble-subbutton-glass-base:${o.base}`),n.push(`--bubble-subbutton-glass-highlight:${o.highlight}`),n.push(`--bubble-subbutton-glass-soft:${o.soft}`),n.push(`--bubble-subbutton-glass-sheen:${o.sheen}`),n.push(`--bubble-subbutton-glass-accent:${o.accent}`),n.push(`--bubble-subbutton-tint:${o.rgb}`),n.push(`--bubble-subbutton-glass-shadow:${o.shadow}`),n.push(`--bubble-subbutton-glass-shadow-hover:${o.shadowHover}`),n.push(`--bubble-subbutton-glass-shadow-active:${o.shadowActive}`),n.push(`--bubble-subbutton-glass-shadow-rgb:${o.shadowRgb}`);else if(i){const e=t.active?this._lightenColor(i,.35):null;n.push(`--bubble-subbutton-bg:${e||i}`)}const a=this._computeBorderColors(s,t.active);a?(n.push(`--bubble-subbutton-border:${a.base}`),n.push(`--bubble-subbutton-border-hover:${a.hover}`),n.push(`--bubble-subbutton-border-active:${a.active}`)):s&&(n.push(`--bubble-subbutton-border:${s}`),n.push(`--bubble-subbutton-border-hover:${s}`),n.push(`--bubble-subbutton-border-active:${s}`));const r=this._computeGlowPalette(s,t.active);r?(n.push(`--bubble-subbutton-glass-glow:${r.glow}`),n.push(`--bubble-subbutton-glass-rim:${r.rim}`),n.push(`--bubble-subbutton-glass-rim-soft:${r.rimSoft}`),n.push(`--bubble-subbutton-glass-rim-shadow:${r.rimShadow}`)):s&&(n.push(`--bubble-subbutton-glass-glow:${s}`),n.push(`--bubble-subbutton-glass-rim:${s}`),n.push(`--bubble-subbutton-glass-rim-soft:${s}`),n.push(`--bubble-subbutton-glass-rim-shadow:${s}`));const l=n.join(";");return I`
            <div
              class="sub-button"
              style="${l}"
              @pointerdown=${()=>this._onDown(e)}
