          ...
          <div class="grid-container">
            ...
            <div class="icon-area">
              ...
              <div class="mushroom-container">
                ${S.map(((t,e)=>{if(!t)return L;if(t.temperature_sensor||t.humidity_sensor){const i=this._buildTemperatureText(t);return i?D`
                    ...
                    `:L}const i="on"===(a.states[t.entity]?.state||"off")?t.icon_color?.on||c:t.icon_color?.off||r,n=this._getFallbackIcon(t.entity,t.icon),o=t.icon?.trim()?t.icon:n;return D`
                    <div class="mushroom-item"
                         style="${t.style??this._defaultMushroomStyle(e)}"
                         @pointerdown=${e=>this._startHold(e,t)}
                         @pointerup=${e=>this._endHold(e,t,(()=>this._handleMushroomTap(t)))}
                         @pointerleave=${t=>this._cancelHold(t)}>
                      ${o?D`<ha-icon icon="${o}" style="color: ${i};"></ha-icon>`:L}
                    </div>
                  `}))}
              </div>
            </div>
            ...
            <div class="bubble-sub-button-container">
              ${$.map((t=>{if(!t?.entity)return L;const e=a.states[t.entity]?.state||"off",i="on"===e?"default"!==s.active?s.active:g:"default"!==s.inactive?s.inactive:"var(--secondary-text-color)",n=this._getFallbackIcon(t.entity,t.icon),o=t.icon?.trim()?t.icon:n,l="on"===e?t.icon_color?.on||c:t.icon_color?.off||r;return D`
                  <div
                    ...
                    @pointerleave=${t=>this._cancelHold(t)}
                  >
                    ${o?D`<ha-icon icon="${o}" style="color: ${l};"></ha-icon>`:L}
                  </div>
                `}))}
            </div>
