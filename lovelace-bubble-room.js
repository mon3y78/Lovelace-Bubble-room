...
var et,it;class st extends f{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const i=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=i.firstChild),i}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{var s,o;const n=null!==(s=null==i?void 0:i.renderBefore)&&void 0!==s?s:e;let a=n._$litPart$;if(void 0===a){const t=null!==(o=null==i?void 0:i.renderBefore)&&void 0!==o?o:null;n._$litPart$=a=new Y(e.insertBefore(A(),t),t,void 0,null!=i?i:{})}return a._$AI(t),a})(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!1)}render(){return I}}st.finalized=!0,st._$litElement$=!0,null===(et=globalThis.litElementHydrateSupport)||void 0===et||et.call(globalThis,{LitElement:st});const ot=globalThis.litElementPolyfillSupport;null==ot||ot({LitElement:st}),(null!==(it=globalThis.litElementVersions)&&void 0!==it?it:globalThis.litElementVersions=[]).push("3.3.3");const nt={alarm_control_panel:"Allarmi",binary_sensor:"Sensori Binari",camera:"Telecamere",climate:"Clima",cover:"Tapparelle",fan:"Ventola",light:"Luce",lock:"Serratura",media_player:"Media Player",scene:"Scene",script:"Script",siren:"Sirena",vacuum:"Aspirapolvere",motion:"Movimento",occupancy:"Occupazione",presence:"Presenza",moving:"In movimento",door:"Porta",window:"Finestra",opening:"Apertura",garage_door:"Basculante",vibration:"Vibrazione",sound:"Suono",moisture:"Umidità/Perdita",water:"Acqua/Perdita",smoke:"Fumo",gas:"Gas",carbon_monoxide:"Monossido",cold:"Freddo",heat:"Caldo",light_level:"Luce (livello)",connectivity:"Connettività",plug:"Presa",power:"Alimentazione",problem:"Problema",running:"In esecuzione",safety:"Sicurezza",tamper:"Manomissione",update:"Aggiornamento",switch:"Pulsante",input_boolean:"Interruttore"},at=["alarm_control_panel","binary_sensor","camera","climate","cover","fan","input_boolean","light","lock","media_player","scene","script","siren","switch","vacuum"],rt=["motion","occupancy","presence","moving","door","window","opening","garage_door","vibration","sound","moisture","water","smoke","gas","carbon_monoxide","cold","heat","light_level","connectivity","plug","power","problem","running","safety","tamper","update"],lt={presence:(t=[])=>({includeDomains:at,entityFilter:(e,i)=>{if(!t.length)return!1;const[s]=e.split(".");if("binary_sensor"===s){const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}return t.includes(s)}}),sensor:(t=[])=>({includeDomains:["sensor"],entityFilter:(e,i)=>{if(!t.length)return!0;const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}}),mushroom:(t=[])=>({includeDomains:at,entityFilter:(e,i)=>{if(!t.length)return"binary_sensor"===e.split(".")[0];const[s]=e.split(".");if("binary_sensor"===s){const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}return t.includes(s)}}),subbutton:(t=[])=>({includeDomains:at,entityFilter:(e,i)=>{const[s]=e.split(".");if(!t.length)return at.includes(s);if("binary_sensor"===s){const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}return t.includes(s)}}),camera:(t=[])=>({includeDomains:["camera"],entityFilter:(t,e)=>!0}),climate:(t=[])=>({includeDomains:["climate"],entityFilter:(t,e)=>!0})};function ct(t){return"string"==typeof t&&t.trim().length>0}function dt(t,e,i){if(!ct(i))return!0;const s=function(t){if(!t)return{};if(!Array.isArray(t))return t;const e={};for(const i of t){const t=i?.entity_id||i?.id;t&&(e[t]=i)}return e}(t?.entities),o=function(t){if(!t)return{};if(!Array.isArray(t))return t;const e={};for(const i of t){const t=i?.id||i?.device_id;t&&(e[t]=i)}return e}(t?.devices),n=s[e];if(n?.area_id===i)return!0;const a=n?.device_id||n?.deviceId;if(a&&o[a]?.area_id===i)return!0;const r=t?.states?.[e]?.attributes?.area_id;return r===i}function ht(t,e,i,s=[]){if(!t?.states)return[];const o=lt[i]?.(s);if(!o)return[];const n=Object.keys(t.states).filter(t=>o.includeDomains.includes(t.split(".")[0])).filter(e=>o.entityFilter(e,t));let a=n;const r="string"==typeof e?.area_id?e.area_id:e?.area;if(ct(r)){const s=function(t,e){return t?.states&&ct(e)?Object.keys(t.states).filter(i=>dt(t,i,e)):[]}(t,r),o=n.filter(t=>s.includes(t));a=!!e?.auto_discovery_sections?.[i]||o.length?o:n}const l=function(t){const e=new Set,i=t=>{t&&("string"==typeof t&&t.includes(".")?e.add(t):Array.isArray(t)?t.forEach(i):"object"==typeof t&&Object.values(t).forEach(i))};return i(t),Array.from(e)}("subbutton"===i?e?.subbuttons:e?.entities?.[i]);return function(t,e){const i=Array.from(new Set(t)),s=Array.isArray(e)?e:e?[e]:[];for(let t=s.length-1;t>=0;t--){const e=s[t];e&&!i.includes(e)&&i.unshift(e)}return i}(a,l)}const pt=!!window.__BUBBLE_DEBUG__;function ut(t,e,i,s=!1){if(!t||!e)return e;const o=e.auto_discovery_sections||{};return i&&String(i).startsWith("auto_discovery_sections."),(s||pt)&&"undefined"!=typeof window&&console.info("[AutoDiscovery] (no-op) after",i,{sections:o}),e}let gt;try{const{IconCache:t}=await Promise.resolve().then(function(){return xt});gt=t}catch(t){gt={_m:new Map,get(t){return this._m.get(t)},set(t,e){this._m.set(t,e)}}}const bt="mdi:bookmark",ft={light:"mdi:lightbulb",switch:"mdi:toggle-switch",fan:"mdi:fan",climate:"mdi:thermostat",cover:"mdi:window-shutter",media_player:"mdi:play-circle",script:"mdi:script-text",scene:"mdi:palette",lock:"mdi:lock",camera:"mdi:video",binary_sensor:"mdi:checkbox-marked-circle-outline",sensor:"mdi:eye",alarm_control_panel:"mdi:shield-home",vacuum:"mdi:robot-vacuum",siren:"mdi:bullhorn"},mt={door:{on:"mdi:door-open",off:"mdi:door-closed"},window:{on:"mdi:window-open",off:"mdi:window-closed"},motion:{on:"mdi:motion-sensor",off:"mdi:motion-sensor-off"},moisture:{on:"mdi:water-alert",off:"mdi:water-off"},smoke:{on:"mdi:smoke",off:"mdi:smoke-detector-off"},gas:{on:"mdi:gas-cylinder",off:"mdi:gas-off"},lock:{on:"mdi:lock-open-variant",off:"mdi:lock"},garage:{on:"mdi:garage-open",off:"mdi:garage"},light:{on:"mdi:lightbulb-on",off:"mdi:lightbulb-off"},plug:{on:"mdi:power-plug",off:"mdi:power-plug-off"},presence:{on:"mdi:account",off:"mdi:account-off"},vibration:{on:"mdi:vibrate",off:"mdi:vibrate-off"},opening:{on:"mdi:door-open",off:"mdi:door-closed"},battery:{on:"mdi:battery",off:"mdi:battery-outline"},connectivity:{on:"mdi:wifi",off:"mdi:wifi-off"},safety:{on:"mdi:shield-check",off:"mdi:shield-off"},cold:{on:"mdi:snowflake",off:"mdi:snowflake-off"}};function _t(t,e){const{entityId:i,hass:s}=function(t,e){return t&&"object"==typeof t&&t.states&&"string"==typeof e?{entityId:e,hass:t}:{entityId:t,hass:e}}(t,e);if(!i)return bt;const o=gt?.get?.(i);if(o)return o;const n=s?.states?.[i],a=n?.attributes||{},r=function(t){return(t||"").split(".")[0]||""}(i),l=a.icon;if(l)return gt?.set?.(i,l),l;const c=a.device_class?function(t,e){const i=mt[t];return i?function(t){return"on"===t||"open"===t||"unlocked"===t||"playing"===t||"active"===t}(e)?i.on:i.off:null}(a.device_class,n?.state):null;if(c)return gt?.set?.(i,c),c;const d=ft[r]||bt;return gt?.set?.(i,d),d}const vt={_list:null,get(t){if(this._list)return this._list;const e=t?.mdiIcons||null;return this._list=e?Object.keys(e).sort():[],this._list},warm(t){return this.get(t)}};var xt=Object.freeze({__proto__:null,IconCache:vt});const yt=["presence","motion","occupancy","light","switch","fan"];class $t extends st{static properties={hass:{type:Object},config:{type:Object},_expanded:{type:Boolean,state:!0},activeFilters:{type:Array,state:!0},layout:{type:String}};static styles=n`
  ...
  `;render(){const t=this.config.auto_discovery_sections?.subbutton??!1,e=at.map(t=>({value:t,label:nt[t]||t.charAt(0).toUpperCase()+t.slice(1)}));return N`
    ...
    `}_renderSubButton(t,e,i){const s=this._filters[t],o=this._entities[t];let n;if(this.config?.auto_discovery_sections?.subbutton??!1)n=ht(this.hass,this.config,"subbutton",s)||[];else{const t={...this.config,area:void 0,area_id:void 0};n=ht(this.hass,t,"subbutton",s)||[]}o&&!n.includes(o)&&(n=[o,...n]);const a=this.config.subbuttons?.[t]||{},r=["toggle","more-info","navigate","call-service","none"];return N`
      <div class="mini-pill ${e?"expanded":""}">
        <div class="mini-pill-header" @click=${()=>this._togglePill(t)}>
  ...
  `;render(){const t=this.config||{};return N`
    ...
    `}}customElements.define("bubble-room-editor",Pt);var Mt=Object.freeze({__proto__:null,BubbleRoomEditor:Pt});class Ft extends st{static properties={subbuttons:{type:Array}};constructor(){super(),this.subbuttons=[],this._holdThreshold=500,this._holdTimer=null,this._holdFired=!1,this._currentIndex=-1}static styles=n`
    :host {
      display: block;
      height: 100%;
      width: 100%;
  ...
  `;render(){const{width:t,height:e}=this._containerSize;if(!t||!e)return N``;const i=window.innerWidth||t,s=.55;let o;if(i<=100)o=s;else if(i>=200)o=.25;else{o=s+(.25-s)*((i-100)/100)}const n=Math.min(t,1.6*e),a=.5*(e+n)*o,r=.6*t,l=.6*e,c=r*Math.min(1,t/(2*r)),d=l*Math.min(1,e/(2*l)),h=t-c,p=.5*e,u=Math.max(0,c-a/2-1),g=Math.max(0,d-a/2-1),b=t=>Math.PI*t/180,f=b(30),m=b(85),_=.75*a,v=.75*a,x=[{x:a/2+1,y:a/2+1},{x:h+u*Math.cos(-m),y:p+g*Math.sin(-m)},{x:h+u*Math.cos(-f),y:p+g*Math.sin(-f)},{x:h+u*Math.cos(+f),y:p+g*Math.sin(+f)},{x:h+u*Math.cos(+m),y:p+g*Math.sin(+m)}];let y=0;return N`
      ${this.entities.map(i=>{const s="camera"===i?.kind,o="climate"===i?.kind,n=s?_:o?v:a,r=.95*n;let l;s?l={x:t-n/2,y:n/2}:o?l={x:n/2+1,y:e-n/2-1}:(l=x[Math.min(y,x.length-1)]??{x:h,y:p},y++);const c=s||o?0:i.dx??0,d=s||o?0:i.dy??0,u=l.x+c,g=l.y+d;return N`
        ...
        `})}
    `}}customElements.define("bubble-mushroom",Tt);class Rt extends st{static properties={icon:{type:String},active:{type:Boolean},colorActive:{type:String},colorInactive:{type:String},backgroundActive:{type:String},backgroundInactive:{type:String}};constructor(){super(),this.icon="",this.active=!1,this.colorActive="#21df73",this.colorInactive="#173c16",this.backgroundActive="rgba(33,223,115,0.12)",this.backgroundInactive="rgba(23,60,22,0.08)"}static styles=n`
    :host {
