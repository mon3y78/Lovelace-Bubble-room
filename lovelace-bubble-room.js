...
var et,it;class st extends f{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const i=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=i.firstChild),i}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{var s,n;const o=null!==(s=null==i?void 0:i.renderBefore)&&void 0!==s?s:e;let a=o._$litPart$;if(void 0===a){const t=null!==(n=null==i?void 0:i.renderBefore)&&void 0!==n?n:null;o._$litPart$=a=new Y(e.insertBefore(A(),t),t,void 0,null!=i?i:{})}return a._$AI(t),a})(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!1)}render(){return N}}st.finalized=!0,st._$litElement$=!0,null===(et=globalThis.litElementHydrateSupport)||void 0===et||et.call(globalThis,{LitElement:st});const nt=globalThis.litElementPolyfillSupport;null==nt||nt({LitElement:st}),(null!==(it=globalThis.litElementVersions)&&void 0!==it?it:globalThis.litElementVersions=[]).push("3.3.3");const ot={alarm_control_panel:"Allarmi",binary_sensor:"Sensori Binari",camera:"Telecamere",climate:"Clima",cover:"Tapparelle",fan:"Ventola",light:"Luce",lock:"Serratura",media_player:"Media Player",scene:"Scene",script:"Script",siren:"Sirena",vacuum:"Aspirapolvere",motion:"Movimento",occupancy:"Occupazione",presence:"Presenza",switch:"Pulsante"},at=["alarm_control_panel","binary_sensor","camera","climate","cover","fan","light","lock","media_player","scene","script","siren","switch","vacuum"],rt=(t=[])=>({includeDomains:at,entityFilter:(e,i)=>{if(!t.length)return!1;const[s]=e.split(".");if("binary_sensor"===s){const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}return t.includes(s)}}),ct=(t=[])=>({includeDomains:["sensor"],entityFilter:(e,i)=>{if(!t.length)return!0;const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}}),lt=(t=[])=>({includeDomains:at,entityFilter:(e,i)=>{if(!t.length)return"binary_sensor"===e.split(".")[0];const[s]=e.split(".");if("binary_sensor"===s){const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}return t.includes(s)}}),dt=(t=[])=>({includeDomains:at,entityFilter:(e,i)=>{if(!t.length)return at.includes(e.split(".")[0]);const[s]=e.split(".");if("binary_sensor"===s){const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}return at.includes(s)}}),ht=(t=[])=>({includeDomains:["camera"],entityFilter:(e,i)=>{if(!t.length)return!0;const s=i.states[e]?.attributes?.device_class??"";return t.includes(s)}}),ut=(t=[])=>({includeDomains:["climate"],entityFilter:(t,e)=>!0});function pt(t){return"string"==typeof t&&t.trim().length>0}function bt(t,e,i){if(!pt(i))return!0;const s=function(t){if(!t)return{};if(!Array.isArray(t))return t;const e={};for(const i of t){const t=i?.entity_id||i?.id;t&&(e[t]=i)}return e}(t?.entities),n=function(t){if(!t)return{};if(!Array.isArray(t))return t;const e={};for(const i of t){const t=i?.id||i?.device_id;t&&(e[t]=i)}return e}(t?.devices),o=s[e];if(o?.area_id===i)return!0;const a=o?.device_id||o?.deviceId;if(a&&n[a]?.area_id===i)return!0;const r=t?.states?.[e]?.attributes?.area_id;return r===i}function gt(t,e,i,s=[]){if(!t?.states)return[];let n;if("presence"===i?n=rt(s):"sensor"===i?n=ct(s):"mushroom"===i?n=lt(s):"subbutton"===i?n=dt(s):"camera"===i?n=ht(s):"climate"===i&&(n=ut(s)),!n)return[];const o=Object.keys(t.states).filter(t=>n.includeDomains.includes(t.split(".")[0])).filter(e=>n.entityFilter(e,t));let a=o;const r="string"==typeof e?.area_id?e.area_id:e?.area;if(pt(r)){const e=function(t,e){return t?.states&&pt(e)?Object.keys(t.states).filter(i=>bt(t,i,e)):[]}(t,r),i=o.filter(t=>e.includes(t));i.length&&(a=i)}const c=e?.entities?.[i],l=function(t){const e=new Set,i=t=>{t&&("string"==typeof t&&t.includes(".")?e.add(t):Array.isArray(t)?t.forEach(i):"object"==typeof t&&Object.values(t).forEach(i))};return i(t),Array.from(e)}(c);return function(t,e){const i=Array.from(new Set(t)),s=Array.isArray(e)?e:e?[e]:[];for(let t=s.length-1;t>=0;t--){const e=s[t];e&&!i.includes(e)&&i.unshift(e)}return i}(a,l)}const ft=!!window.__BUBBLE_DEBUG__;function mt(t,e){const i=Array.isArray(e?.area)?e.area[0]:e?.area,s="string"!=typeof i||i.startsWith("area_")?"":i;let n="string"==typeof i&&i.startsWith("area_")?i:"";const o=Array.isArray(t?.areas)?t.areas:[];if(!n&&o.length&&s){const t=o.find(t=>(t.name||"").toLowerCase()===String(s).toLowerCase());t?.area_id&&(n=t.area_id)}return{areaId:n,areaName:s}}function _t(t,e,i,s){if(!i&&!s)return!0;const n=t?.entities,o=t?.devices,a=n?.[e];if(a?.area_id&&i)return a.area_id===i;if(a?.device_id&&Array.isArray(o)){const t=o.find(t=>t.id===a.device_id||t.device_id===a.device_id);if(t?.area_id&&i)return t.area_id===i}const r=t?.states?.[e];if(r){const t=r.attributes?.area_id,e=r.attributes?.area;if(i&&t)return t===i;if(s&&e)return String(e).toLowerCase()===String(s).toLowerCase()}return!0}function vt(t,e,i){let s=gt(t,e,i)||[];return!s.length&&t?.states&&(s=Object.keys(t.states)),s}function xt(t,e,i,s){const n={...e.entities||{}},o=n[s]||(n[s]={});if(o.entity)return{...e,entities:n};let a=vt(t,e,i);a.length||(a=vt(t,e,"mushroom")),a=(a||[]).filter(t=>t.startsWith(`${i}.`));const r=mt(t,e),c=function(t,e,i,s){const{areaId:n,areaName:o}=i;let a=(e||[]).filter(e=>_t(t,e,n,o));return(n||o)&&0===a.length&&(a=[]),s&&!a.includes(s)&&a.unshift(s),Array.from(new Set(a))}(t,a,r,o.entity),l=c[0]||"";return l&&(o.entity=l),ft&&console.info(`[AutoDiscovery][${s}]`,{domain:i,chosen:o.entity,areaRef:r,pool:a.length,filtered:c.length}),{...e,entities:n}}const yt=(t,e)=>t.find(t=>!e.has(t))||null;function $t(t,e){const i={...e.entities||{}},s=i.presence||(i.presence={});if(!s.entity){const i=function(t,e){if(!t||!t.states)return[];const i=new Set(["person","device_tracker","binary_sensor","light","switch","media_player","fan","humidifier","lock","input_boolean","scene"]);let s=Object.keys(t.states).filter(t=>i.has(t.split(".")[0]));s=s.filter(e=>{if("binary_sensor"!==e.split(".")[0])return!0;const i=t.states[e]?.attributes?.device_class;return["motion","occupancy","presence"].includes(i||"")});const n=e?.auto_discovery_sections?.presence??!1,{areaId:o,areaName:a}=mt(t,e);if(n&&(o||a)){const e=s.filter(e=>_t(t,e,o,a));e.length&&(s=e)}const r=e?.entities?.presence?.entity||e?.presence_entity;return r&&!s.includes(r)&&s.unshift(r),ft&&console.info("[AutoDiscovery][presence candidates]",{areaId:o,areaName:a,count:s.length,sample:s.slice(0,8)}),s}(t,e);i.length&&(s.entity=i[0])}return{...e,entities:i}}function wt(t,e,i,s=!1){if(!t||!e)return e;const n=e.auto_discovery_sections||{},o="area"===i,a=i&&String(i).startsWith("auto_discovery_sections.");if(!o&&!a)return e;let r=e;return n.sensor&&(r=function(t,e){const i=["sensor1","sensor2","sensor3","sensor4","sensor5","sensor6","sensor7","sensor8"],s={...e.entities||{}},n=new Set(i.map(t=>s[t]?.entity||s[t]?.entity_id).filter(Boolean));for(const o of i){const i=s[o]||(s[o]={});if(i.entity||i.entity_id)continue;const a=gt(t,e,{section:"sensor",type:i.type||""})||[],r=yt(a,n);r&&(i.entity=r,delete i.entity_id,n.add(r))}return{...e,entities:s}}(t,r)),n.mushroom&&(r=function(t,e){const i={...e.entities||{}},s=new Set(["climate","camera","mushroom1","mushroom2","mushroom3","mushroom4","mushroom5"].map(t=>i[t]?.entity).filter(Boolean));let n=vt(t,e,"mushroom");const o=i.climate||(i.climate={});if(!o.entity){const t=n.find(t=>t.startsWith("climate.")&&!s.has(t));t&&(o.entity=t,s.add(t))}const a=i.camera||(i.camera={});if(!a.entity){const t=n.find(t=>t.startsWith("camera.")&&!s.has(t));t&&(a.entity=t,s.add(t))}for(let t=1;t<=5;t++){const e=`mushroom${t}`,o=i[e]||(i[e]={});if(o.entity)continue;const a=yt(n,s);a&&(o.entity=a,s.add(a))}return{...e,entities:i}}(t,r)),n.subbutton&&(r=function(t,e){const i=["sub-button1","sub-button2","sub-button3","sub-button4","sub-button5","sub-button6"],s={...e.entities||{}},n=new Set(i.map(t=>s[t]?.entity).filter(Boolean)),o=gt(t,e,"subbutton")||[];for(const t of i){const e=s[t]||(s[t]={});if(e.entity)continue;const i=yt(o,n);i&&(e.entity=i,n.add(i))}return{...e,entities:s}}(t,r)),n.presence&&(r=$t(t,r)),n.climate&&(r=function(t,e){return xt(t,e,"climate","climate")}(t,r)),n.camera&&(r=function(t,e){return xt(t,e,"camera","camera")}(t,r)),(s||ft)&&"undefined"!=typeof window&&console.info("[AutoDiscovery] applied after",i,{sections:n}),r}let kt;try{const{IconCache:t}=await Promise.resolve().then(function(){return Pt});kt=t}catch(t){kt={_m:new Map,get(t){return this._m.get(t)},set(t,e){this._m.set(t,e)}}}const Ct="mdi:bookmark",At={light:"mdi:lightbulb",switch:"mdi:toggle-switch",fan:"mdi:fan",climate:"mdi:thermostat",cover:"mdi:window-shutter",media_player:"mdi:play-circle",script:"mdi:script-text",scene:"mdi:palette",lock:"mdi:lock",camera:"mdi:video",binary_sensor:"mdi:checkbox-marked-circle-outline",sensor:"mdi:eye",alarm_control_panel:"mdi:shield-home",vacuum:"mdi:robot-vacuum",siren:"mdi:bullhorn"},St={door:{on:"mdi:door-open",off:"mdi:door-closed"},window:{on:"mdi:window-open",off:"mdi:window-closed"},motion:{on:"mdi:motion-sensor",off:"mdi:motion-sensor-off"},moisture:{on:"mdi:water-alert",off:"mdi:water-off"},smoke:{on:"mdi:smoke",off:"mdi:smoke-detector-off"},gas:{on:"mdi:gas-cylinder",off:"mdi:gas-off"},lock:{on:"mdi:lock-open-variant",off:"mdi:lock"},garage:{on:"mdi:garage-open",off:"mdi:garage"},light:{on:"mdi:lightbulb-on",off:"mdi:lightbulb-off"},plug:{on:"mdi:power-plug",off:"mdi:power-plug-off"},presence:{on:"mdi:account",off:"mdi:account-off"},vibration:{on:"mdi:vibrate",off:"mdi:vibrate-off"},opening:{on:"mdi:door-open",off:"mdi:door-closed"},battery:{on:"mdi:battery",off:"mdi:battery-outline"},connectivity:{on:"mdi:wifi",off:"mdi:wifi-off"},safety:{on:"mdi:shield-check",off:"mdi:shield-off"},cold:{on:"mdi:snowflake",off:"mdi:snowflake-off"}};function Et(t,e){const{entityId:i,hass:s}=function(t,e){return t&&"object"==typeof t&&t.states&&"string"==typeof e?{entityId:e,hass:t}:{entityId:t,hass:e}}(t,e);if(!i)return Ct;const n=kt?.get?.(i);if(n)return n;const o=s?.states?.[i],a=o?.attributes||{},r=function(t){return(t||"").split(".")[0]||""}(i),c=a.icon;if(c)return kt?.set?.(i,c),c;const l=a.device_class?function(t,e){const i=St[t];return i?function(t){return"on"===t||"open"===t||"unlocked"===t||"playing"===t||"active"===t}(e)?i.on:i.off:null}(a.device_class,o?.state):null;if(l)return kt?.set?.(i,l),l;const d=At[r]||Ct;return kt?.set?.(i,d),d}const zt={_list:null,get(t){if(this._list)return this._list;const e=t?.mdiIcons||null;return this._list=e?Object.keys(e).sort():[],this._list},warm(t){return this.get(t)}};var Pt=Object.freeze({__proto__:null,IconCache:zt});const Ot=["presence","motion","occupancy","light","switch","fan"];class Mt extends st{static properties={hass:{type:Object},config:{type:Object},_expanded:{type:Boolean,state:!0},activeFilters:{type:Array,state:!0},layout:{type:String}};static styles=o`
  ...
  `;render(){const{width:t,height:e}=this._containerSize;if(!t||!e)return I``;const i=window.innerWidth||t,s=.55;let n;if(i<=100)n=s;else if(i>=200)n=.25;else{n=s+(.25-s)*((i-100)/100)}const o=Math.min(t,1.6*e),a=.5*(e+o)*n,r=.6*t,c=.6*e,l=r*Math.min(1,t/(2*r)),d=c*Math.min(1,e/(2*c)),h=t-l,u=.5*e,p=Math.max(0,l-a/2-1),b=Math.max(0,d-a/2-1),g=t=>Math.PI*t/180,f=g(30),m=g(85),_=.75*a,v=.75*a,x=[{x:a/2+1,y:a/2+1},{x:h+p*Math.cos(-m),y:u+b*Math.sin(-m)},{x:h+p*Math.cos(-f),y:u+b*Math.sin(-f)},{x:h+p*Math.cos(+f),y:u+b*Math.sin(+f)},{x:h+p*Math.cos(+m),y:u+b*Math.sin(+m)}];let y=0;return I`
      ${this.entities.map(i=>{const s="camera"===i?.kind,n="climate"===i?.kind,o=s?_:n?v:a,r=.95*o;let c;s?c={x:t-o/2,y:o/2}:n?c={x:o/2+1,y:e-o/2-1}:(c=x[Math.min(y,x.length-1)]??{x:h,y:u},y++);const l=s||n?0:i.dx??0,d=s||n?0:i.dy??0,p=c.x+l,b=c.y+d;return I`
          <div
