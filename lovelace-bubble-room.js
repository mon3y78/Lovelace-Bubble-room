          ...
          <div class="icon-area">
            <div class="bubble-icon-container"
              ...
              <ha-icon class="bubble-icon"
                       icon="${s}"
                       style="color: ${l}; --mdc-icon-size: ${t.iconSize}; width: ${t.iconSize}; height: ${t.iconSize};">
              </ha-icon>
            </div>
  
            <!-- Mushroom templates -->
            <div class="mushroom-container">
              ${d.map(((e,n)=>{if(!e)return i``;const o=t.mushroomPositions[n]||this._defaultMushroomStyle(n);if(e.sensore_temperatura&&e.sensore_umitidà){const n=a.states[e.sensore_temperatura]?.state||"N/A",s=a.states[e.sensore_umitidà]?.state||"N/A";return i`
                    <div class="mushroom-item"
                         style="${o}; font-size: ${t.mushroomSize};"
                  ...
                  `}{const n="on"===(a.states[e.entity]?.state||"off")?e.icon_color?.on||"orange":e.icon_color?.off||"#80808055";return i`
                    <div class="mushroom-item"
                         style="${o}"
                         @pointerdown="${t=>this._startHold(t,e)}"
                         @pointerup="${t=>this._endHold(t,e,(()=>this._handleMushroomTap(e)))}"
                         @pointerleave="${t=>this._cancelHold(t)}">
                      <ha-icon icon="${e.icon}"
                               style="color: ${n}; --mdc-icon-size: ${t.mushroomSize}; width: ${t.mushroomSize}; height: ${t.mushroomSize};">
                      </ha-icon>
                    </div>
                  `}}))}
            </div>
