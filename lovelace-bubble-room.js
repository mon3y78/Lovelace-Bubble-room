      ...
      <div class="card">
        <div class="grid-container">
          ...
          <div class="icon-area">
            ...
            <div class="mushroom-container">
              ${p.map(((t,e)=>{if(!t)return D``;if(t.temperature_sensor||t.humidity_sensor){const i=this._buildTemperatureText(t);return i?D`
                  ...
                  `:D``}{const i="on"===(n.states[t.entity]?.state||"off")?t.icon_color&&t.icon_color.on?t.icon_color.on:"orange":t.icon_color&&t.icon_color.off?t.icon_color.off:"#80808055",o=this._getFallbackIcon(t.entity),s=t.icon&&""!==t.icon.trim()?t.icon:o,a=t.style?t.style:this._defaultMushroomStyle(e);return D`
                    <div class="mushroom-item"
                         style="${a}"
                         @pointerdown="${e=>this._startHold(e,t)}"
                         @pointerup="${e=>this._endHold(e,t,(()=>this._handleMushroomTap(t)))}"
          ...
          <div class="bubble-sub-button-container">
            ${u.map((t=>{if(!t||!t.entity||""===t.entity.trim())return D``;const e=n.states[t.entity]?.state||"off",i="on"===e?l.active:l.inactive,o=this._getFallbackIcon(t.entity),s=t.icon&&""!==t.icon.trim()?t.icon:o,a="on"===e?t.icon_color&&t.icon_color.on?t.icon_color.on:"orange":t.icon_color&&t.icon_color.off?t.icon_color.off:"#80808055";return D`
