...
`;class Pt extends st{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_expanded:{type:Array,state:!0},_filters:{type:Array,state:!0},_entities:{type:Array,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._expanded=Array(5).fill(!1);const t=Object.keys(zt);this._filters=Array(5).fill().map(()=>[...t]),this._entities=Array(5).fill(""),this._ignoreNextFilterChange=new Set}updated(t){if(t.has("config")||t.has("hass")){const t=_t(this.hass,this.config,"auto_discovery_sections.sensor");t&&t!==this.config&&this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}));for(let t=0;t<5;t++){const e=`sensor${t+1}`,i=this.config?.sensor_filters?.[t],s=this.config?.entities?.[e]?.entity;Array.isArray(i)&&(this._filters[t]=[...i]),s&&(this._entities[t]=s)}}}static styles=[Mt,n`
    ...
    `];render(){const t=this.config?.auto_discovery_sections?.subbutton??!1,e=this.config?.subbutton_style||"standard",i=at.map(t=>({value:t,label:nt[t]||t.charAt(0).toUpperCase()+t.slice(1)}));return I`
      <ha-expansion-panel
        class="glass-panel"
        .expanded=${this.expanded}
      ...
      >
        ...
        <div class="input-group">
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .value=${e}
            .selector=${{select:{options:[{value:"standard",label:"Standard (v5.0.6)"},{value:"liquid-glass",label:"Liquid Glass"}]}}}
            @value-changed=${t=>this._onStylePreset(t.detail.value)}
          ></ha-selector>
        </div>

        ${this._expanded.map((t,e)=>this._renderSubButton(e,t,i))}

        <button class="reset-button" @click=${()=>this._reset()}>🧹 Reset Sub-buttons</button>
      </ha-expansion-panel>
    `}_onStylePreset(t){if(this._syncingFromConfig)return;const e=t||"standard";this._emit("subbutton_style",e)}_renderSubButton(t,e,i){const s=this._filters[t],o=this._entities[t];let n;if(this.config?.auto_discovery_sections?.subbutton??!1)n=ft(this.hass,this.config,"subbutton",s)||[];else{const t={...this.config,area:void 0,area_id:void 0};n=ft(this.hass,t,"subbutton",s)||[]}o&&!n.includes(o)&&(n=[o,...n]);const a=Array.isArray(this.config?.subbuttons)&&this.config.subbuttons[t]||{},r=["toggle","more-info","navigate","call-service","none"];return I`
      <div class="mini-pill ${e?"expanded":""}">
        <div class="mini-pill-header" @click=${()=>this._togglePill(t)}>
