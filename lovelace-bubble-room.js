          ...
          <div class="grid-container">
            ...
            <div class="icon-area">
              ...
              <div class="mushroom-container">
                ${f.map(((t,e)=>{if(!t)return D``;if(t.temperature_sensor||t.humidity_sensor){const e=this._buildTemperatureText(t);return e?D`
                      <div class="mushroom-item"
                          style="${t.style?t.style:this._defaultMushroomStyle(index)}"
                    ...
                    `:D``}{const e="on"===(a.states[t.entity]?.state||"off")?t.icon_color&&t.icon_color.on?t.icon_color.on:"orange":t.icon_color&&t.icon_color.off?t.icon_color.off:"#80808055",i=this._getFallbackIcon(t.entity),n=t.icon&&""!==t.icon.trim()?t.icon:i,o=t.style?t.style:this._defaultMushroomStyle(index);return D`
                      <div class="mushroom-item"
                          style="${o}"
                          @pointerdown="${e=>this._startHold(e,t)}"
                          @pointerup="${e=>this._endHold(e,t,(()=>this._handleMushroomTap(t)))}"
                          @pointerleave="${t=>this._cancelHold(t)}">
                        ${n?D`
                          <ha-icon icon="${n}" style="color: ${e};"></ha-icon>
                        `:L}
                      </div>
                    `}}))}
              </div>
            ...
            <div class="bubble-sub-button-container">
              ${m.map((t=>{if(!t?.entity)return L;const e=a.states[t.entity]?.state||"off",i="on"===e?s.active:s.inactive,n=this._getFallbackIcon(t.entity),o=t.icon&&""!==t.icon.trim()?t.icon:n,r="on"===e?t.icon_color&&t.icon_color.on?t.icon_color.on:"orange":t.icon_color&&t.icon_color.off?t.icon_color.off:"#80808055";return D`
