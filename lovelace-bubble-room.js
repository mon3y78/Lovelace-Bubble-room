        ...
        <div class="card">
          <div class="grid-container">
            ...
            <div class="bubble-sub-button-container">
              ${["sub-button1","sub-button2","sub-button3","sub-button4"].map((e=>t[e])).map((t=>{if(!t?.entity)return D``;const e="on"===a.states[t.entity]?.state,i=e?h:d,n=e?l:c,o=t.icon?.trim()||this._getFallbackIcon(t.entity);return D`
