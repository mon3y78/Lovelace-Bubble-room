        ...
        <div class="card">
          <div class="grid-container">
            ...
            <div class="icon-area">
              ...
              <div class="mushroom-container">
                ${f.map(((t,e)=>{if(!t)return D``;if(t.temperature_sensor||t.humidity_sensor){const i=this._buildTemperatureText(t);return i?D`
                    ...
                    `:D``}{const i="on"===(a.states[t.entity]?.state||"off")?t.icon_color&&t.icon_color.on?t.icon_color.on:"orange":t.icon_color&&t.icon_color.off?t.icon_color.off:"#80808055",n=this._getFallbackIcon(t.entity),o=t.icon&&""!==t.icon.trim()?t.icon:n;return t.style?t.style:this._defaultMushroomStyle(e),D`
                      <div class="mushroom-item"
            ...
            <div class="bubble-sub-button-container">
              ${v.map((t=>{if(!t?.entity)return L;const e=a.states[t.entity]?.state||"off",i="on"===e?s.active:s.inactive,n=this._getFallbackIcon(t.entity),o=t.icon&&""!==t.icon.trim()?t.icon:n,r="on"===e?t.icon_color&&t.icon_color.on?t.icon_color.on:"orange":t.icon_color&&t.icon_color.off?t.icon_color.off:"#80808055";return D`
