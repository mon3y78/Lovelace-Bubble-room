        ...
        <div class="card">
          <div class="grid-container">
            ...
            <div class="bubble-sub-button-container">
              ${g.map((t=>{if(!t?.entity)return L;const e=a.states[t.entity]?.state||"off",i="on"===e?s.active:s.inactive,n=this._getFallbackIcon(t.entity),o=t.icon&&""!==t.icon.trim()?t.icon:n,r="on"===e?t.icon_color&&t.icon_color.on?t.icon_color.on:"orange":t.icon_color&&t.icon_color.off?t.icon_color.off:"#80808055";return D`
