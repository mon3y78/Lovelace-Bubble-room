          ...
          <div class="icon-area">
            <div class="bubble-icon-container"
              ...
              <ha-icon class="bubble-icon"
                      ...
                      style="color: ${m}; --mdc-icon-size: ${t.iconSize}; width: ${t.iconSize}; height: ${t.iconSize};">
              </ha-icon>
    ...
    `}_renderEntityInput(t,e,i="entity"){const o=this._config.entities&&this._config.entities[e]&&this._config.entities[e][i]||"",n=customElements.get("ha-entity-picker");return q`
      ...
      `:q`
        <input
          ...
          @focus="${t=>{t.target.value===o&&(t.target.value="")}}"
          @blur="${t=>{!t.target.value&&o&&(t.target.value=o)}}"
          @change="${this._updateEntity(e,i)}"
        />
      `}
