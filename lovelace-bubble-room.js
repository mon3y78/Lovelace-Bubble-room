          ...
          <div class="grid-container">
            ...
            <div class="icon-area">
              ...
              <div class="mushroom-container">
                ${m.map((({item:t,idx:e,color:i})=>t?this._renderMushroom(t,e,i):D`<div class="mushroom-item"
            ...
            <div class="bubble-sub-button-container">
              ${g.map((t=>{const e="on"===this.hass.states[t.entity]?.state,i=e?r:c;return D`
                    <div class="bubble-sub-button"
                        style="background-color: ${u};">
                      <ha-icon
                        icon="${this._getFallbackIcon(t.entity)}"
                        style="color: ${i};"
                      ></ha-icon>
                    </div>
                  `}))}
