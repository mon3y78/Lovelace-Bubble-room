    ...
    `}_extraFields(t,e,i){const s=i?.[`${e}_action`]?.action;return"navigate"===s?N`
      ...
      `:"call-service"===s?N`
        ...
        <input type="text" placeholder='Service Data (JSON)'
          ...
          @input=${i=>this._onAction(t,e,"service_data",this._safeJson(i.target.value))}
        />
      `:""}_safeJson(t){try{return JSON.parse(t)}catch{return{}}}_toggleAuto(t){this._syncingFromConfig||this._emit("auto_discovery_sections.subbutton",t)}_togglePill(t){this._expanded=this._expanded.map((e,i)=>i===t&&!e)}_onFilter(t,e){let i;this._ignoreNextFilterChange.has(t)?(this._ignoreNextFilterChange.delete(t),i=[]):i=Array.isArray(e)?e.filter(Boolean):[],this._filters=this._filters.map((e,s)=>s===t?[...i]:e),this.requestUpdate("_filters"),this._emit("subbutton_filters",this._filters)}_clearFilter(t){this._ignoreNextFilterChange.add(t),this._filters=this._filters.map((e,i)=>i===t?[]:e),this.requestUpdate("_filters"),this._emit("subbutton_filters",this._filters)}_onEntity(t,e){if(this._entities[t]=e||"",!this._syncingFromConfig&&(this._emit(`subbuttons.${t}.entity_id`,this._entities[t]),this._entities[t])){const e=this.hass?.states?.[this._entities[t]],i=e?.attributes?.icon,s=i||wt(this._entities[t],this.hass);s&&this._emit(`subbuttons.${t}.icon`,s)}}_onIcon(t,e){this._syncingFromConfig||this._emit(`subbuttons.${t}.icon`,e||"")}_onAction(t,e,i,s){if(this._syncingFromConfig)return;const n={...(this.config?.subbuttons?.[t]||{})[`${e}_action`]||{},[i]:s};this._emit(`subbuttons.${t}.${e}_action`,n)}_reset(){this._expanded=Array(4).fill(!1),this._filters=Array(4).fill().map(()=>[...at]),this._entities=Array(4).fill(""),this._emit("subbutton_filters",this._filters);for(let t=0;t<4;t++)this._emit(`subbuttons.${t}`,{})}_emit(t,e){this.dispatchEvent(new CustomEvent("panel-changed",{detail:{prop:t,val:e},bubbles:!0,composed:!0}))}}customElements.define("sub-button-panel",Ft);class Mt extends st{static properties={hass:{type:Object},config:{type:Object},expanded:{type:Boolean},_room:{type:Object,state:!0},_subbutton:{type:Object,state:!0},_mushroom:{type:Object,state:!0},_sensor:{type:Object,state:!0},_selectedPreset:{type:String,state:!0},_expandedColors:{type:Array,state:!0}};constructor(){super(),this.hass={},this.config={},this.expanded=!1,this._room={},this._subbutton={},this._mushroom={},this._sensor={},this._selectedPreset="green",this._expandedColors=[!1,!1,!1]}updated(t){if(t.has("config")){const t=this.config?.colors||{};this._room={icon_active:t.room?.icon_active??"",icon_inactive:t.room?.icon_inactive??"",background_active:t.room?.background_active??"",background_inactive:t.room?.background_inactive??"",text_active:t.room?.text_active??"",text_inactive:t.room?.text_inactive??""},this._subbutton={background_on:t.subbutton?.background_on??"",background_off:t.subbutton?.background_off??"",icon_on:t.subbutton?.icon_on??"",icon_off:t.subbutton?.icon_off??""},this._mushroom={active:t.mushroom?.active??"",inactive:t.mushroom?.inactive??""},this._sensor={sensor_active:t.sensor?.sensor_active??"",sensor_inactive:t.sensor?.sensor_inactive??""}}}get PRESETS(){return{green:{label:"Green",room:{icon_active:"#21df73",icon_inactive:"#9aa0a6",background_active:"rgba(33,223,115,0.50)",background_inactive:"rgba(33,223,115,0.35)",text_active:"#21df73",text_inactive:"#9aa0a6"},sub:{background_on:"rgba(33,223,115,0.50)",background_off:"rgba(33,223,115,0.35)",icon_on:"#21df73",icon_off:"#9aa0a6"},mushroom:{active:"#21df73",inactive:"#9aa0a6"},sensor:{sensor_active:"#21df73",sensor_inactive:"#9aa0a6"}},blue:{label:"Blue",room:{icon_active:"#55afff",icon_inactive:"#9aa0a6",background_active:"rgba(85,175,255,0.50)",background_inactive:"rgba(85,175,255,0.35)",text_active:"#55afff",text_inactive:"#9aa0a6"},sub:{background_on:"rgba(85,175,255,0.50)",background_off:"rgba(85,175,255,0.35)",icon_on:"#55afff",icon_off:"#9aa0a6"},mushroom:{active:"#55afff",inactive:"#9aa0a6"},sensor:{sensor_active:"#55afff",sensor_inactive:"#9aa0a6"}},amber:{label:"Amber",room:{icon_active:"#ff9b3d",icon_inactive:"#9aa0a6",background_active:"rgba(255,155,61,0.50)",background_inactive:"rgba(255,155,61,0.35)",text_active:"#ff9b3d",text_inactive:"#9aa0a6"},sub:{background_on:"rgba(255,155,61,0.50)",background_off:"rgba(255,155,61,0.35)",icon_on:"#ff9b3d",icon_off:"#9aa0a6"},mushroom:{active:"#ff9b3d",inactive:"#9aa0a6"},sensor:{sensor_active:"#ff9b3d",sensor_inactive:"#9aa0a6"}},purple:{label:"Purple",room:{icon_active:"#bd64ff",icon_inactive:"#9aa0a6",background_active:"rgba(189,100,255,0.50)",background_inactive:"rgba(189,100,255,0.35)",text_active:"#bd64ff",text_inactive:"#9aa0a6"},sub:{background_on:"rgba(189,100,255,0.50)",background_off:"rgba(189,100,255,0.35)",icon_on:"#bd64ff",icon_off:"#9aa0a6"},mushroom:{active:"#bd64ff",inactive:"#9aa0a6"},sensor:{sensor_active:"#bd64ff",sensor_inactive:"#9aa0a6"}},red:{label:"Red",room:{icon_active:"#ff5c6a",icon_inactive:"#9aa0a6",background_active:"rgba(255,92,106,0.50)",background_inactive:"rgba(255,92,106,0.35)",text_active:"#ff5c6a",text_inactive:"#9aa0a6"},sub:{background_on:"rgba(255,92,106,0.50)",background_off:"rgba(255,92,106,0.35)",icon_on:"#ff5c6a",icon_off:"#9aa0a6"},mushroom:{active:"#ff5c6a",inactive:"#9aa0a6"},sensor:{sensor_active:"#ff5c6a",sensor_inactive:"#9aa0a6"}},gray:{label:"Gray",room:{icon_active:"#c5c8ce",icon_inactive:"#9aa0a6",background_active:"rgba(197,200,206,0.50)",background_inactive:"rgba(197,200,206,0.35)",text_active:"#c5c8ce",text_inactive:"#9aa0a6"},sub:{background_on:"rgba(197,200,206,0.50)",background_off:"rgba(197,200,206,0.35)",icon_on:"#c5c8ce",icon_off:"#9aa0a6"},mushroom:{active:"#c5c8ce",inactive:"#9aa0a6"},sensor:{sensor_active:"#c5c8ce",sensor_inactive:"#9aa0a6"}},yellow:{label:"Yellow",room:{icon_active:"#ffd633",icon_inactive:"#9aa0a6",background_active:"rgba(255,214,51,0.50)",background_inactive:"rgba(255,214,51,0.35)",text_active:"#ffd633",text_inactive:"#9aa0a6"},sub:{background_on:"rgba(255,214,51,0.50)",background_off:"rgba(255,214,51,0.35)",icon_on:"#ffd633",icon_off:"#9aa0a6"},mushroom:{active:"#ffd633",inactive:"#9aa0a6"},sensor:{sensor_active:"#ffd633",sensor_inactive:"#9aa0a6"}},teal:{label:"Teal",room:{icon_active:"#00bfa5",icon_inactive:"#9aa0a6",background_active:"rgba(0,191,165,0.50)",background_inactive:"rgba(0,191,165,0.35)",text_active:"#00bfa5",text_inactive:"#9aa0a6"},sub:{background_on:"rgba(0,191,165,0.50)",background_off:"rgba(0,191,165,0.35)",icon_on:"#00bfa5",icon_off:"#9aa0a6"},mushroom:{active:"#00bfa5",inactive:"#9aa0a6"},sensor:{sensor_active:"#00bfa5",sensor_inactive:"#9aa0a6"}}}}static styles=o`
    :host { display:block; }
    .glass-panel {
      margin: 0 !important;
      width: 100%;
