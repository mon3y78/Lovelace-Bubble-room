          ...
          <div class="grid-container">
            ...
            <div class="icon-area">
              ...
              <div class="mushroom-container">
                ${v.map(((t,e)=>{if(!t)return B``;if(t.temperature_sensor||t.humidity_sensor){const i=this._buildTemperatureText(t);return i?B`
            ...
            <div class="bubble-sub-button-container">
              ${["sub-button1","sub-button2","sub-button3","sub-button4"].map((e=>t[e])).map((t=>{if(!t?.entity)return B``;const e="on"===a.states[t.entity]?.state,i=e?d:h,n=e?c:l,o=t.icon?.trim()||this._getFallbackIcon(t.entity);return B`
