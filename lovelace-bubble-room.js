      ...
      <div class="card">
        <div class="grid-container">
          ...
          <div class="icon-area">
            ...
            <div class="mushroom-container">
              ${d.map(((t,i)=>{if(!t)return D``;if(t.temperature_sensor||t.humidity_sensor){const e=this._buildTemperatureText(t);return e?D`
                  ...
                  `:D``}{const n="on"===(e.states[t.entity]?.state||"off")?t.icon_color&&t.icon_color.on?t.icon_color.on:"orange":t.icon_color&&t.icon_color.off?t.icon_color.off:"#80808055",o=this._getFallbackIcon(t.entity),s=t.icon&&""!==t.icon.trim()?t.icon:o,a=t.style?t.style:this._defaultMushroomStyle(i);return D`
                    <div class="mushroom-item"
                         style="${a}"
                         @pointerdown="${e=>this._startHold(e,t)}"
                         @pointerup="${e=>this._endHold(e,t,(()=>this._handleMushroomTap(t)))}"
          ...
          <div class="bubble-sub-button-container">
            ${h.map((t=>{if(!t||!t.entity||""===t.entity.trim())return D``;const i=e.states[t.entity]?.state||"off",n="on"===i?r.active:r.inactive,o=this._getFallbackIcon(t.entity),s=t.icon&&""!==t.icon.trim()?t.icon:o,a="on"===i?t.icon_color&&t.icon_color.on?t.icon_color.on:"orange":t.icon_color&&t.icon_color.off?t.icon_color.off:"#80808055";return D`
