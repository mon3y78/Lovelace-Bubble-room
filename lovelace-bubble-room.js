        ...
        <div class="grid-container">
          ...
          <div class="icon-area">
            ...
            <div class="mushroom-container">
              ${p.map(((t,e)=>{if(!t)return D``;if(t.temperature_sensor||t.humidity_sensor)return D`
                  ...
                  `;if(t.entity){const i=o.states[t.entity]?.state||"off",n=this._getFallbackIcon(t.entity),s="on"===i?t.icon_color&&t.icon_color.on?t.icon_color.on:"orange":t.icon_color&&t.icon_color.off?t.icon_color.off:"#80808055",a=t.style?t.style:this._defaultMushroomStyle(e);return D`
                    <div class="mushroom-item"
                        style="${a}"
                        @pointerdown="${e=>this._startHold(e,t)}"
                        @pointerup="${e=>this._endHold(e,t,(()=>this._handleMushroomTap(t)))}"
          ...
          <div class="bubble-sub-button-container">
            ${u.map((t=>{if(!t)return D``;const i=o.states[t.entity]?.state||"off",n="on"===i?e.active:e.inactive,s=this._getFallbackIcon(t.entity),a=t.icon?t.icon:s,r="on"===i?t.icon_color&&t.icon_color.on?t.icon_color.on:"orange":t.icon_color&&t.icon_color.off?t.icon_color.off:"#80808055";return D`
