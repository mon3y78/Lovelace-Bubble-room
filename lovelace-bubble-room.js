...
.swatch {
  ...
  `;render(){const t=this.config||{};return M`
    ...
    `}}customElements.define("bubble-room-editor",Rt);var Ft=Object.freeze({__proto__:null,BubbleRoomEditor:Rt});class Tt extends st{static properties={subbuttons:{type:Array}};constructor(){super(),this.subbuttons=[],this._holdThreshold=500,this._holdTimer=null,this._holdFired=!1,this._currentIndex=-1}static styles=n`
    :host {
      display: block;
      height: 100%;
      width: 100%;
