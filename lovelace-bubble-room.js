          ...
          <div class="grid-container">
            ...
            <div class="icon-area">
              <div class="bubble-icon-container"
                   ...
                   @pointerleave=${()=>this._cancelHold()}>
                ${m?B`<ha-icon class="bubble-icon" icon="${m}" style="color: ${u};"></ha-icon>`:L}
              </div>
              <div class="mushroom-container">
                ${v.map((({item:t,idx:e,color:i})=>t?this._renderMushroom(t,e,i):B`<div class="mushroom-item" style="${this._defaultMushroomStyle(e)}"></div>`))}
              </div>
            </div>
