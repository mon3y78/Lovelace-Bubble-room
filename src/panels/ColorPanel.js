  ...
  get PRESETS() {
    return {
      green: {
        ...
        room: {
          icon_active: '#21df73',
          icon_inactive: '#9aa0a6',
          background_active: 'rgba(33,223,115,0.50)',
          background_inactive: 'rgba(33,223,115,0.35)',
          text_active: '#21df73',
          text_inactive: '#9aa0a6',
        },
        sub: {
          background_on: 'rgba(33,223,115,0.50)',
          background_off: 'rgba(33,223,115,0.35)',
          icon_on: '#21df73',
          icon_off: '#9aa0a6',
        },
        mushroom: { active: '#21df73', inactive: '#9aa0a6' },
        sensor: { sensor_active: '#21df73', sensor_inactive: '#9aa0a6' },
      },
      blue: {
        label: 'Blue',
        room: {
          ...
          background_inactive: 'rgba(85,175,255,0.35)',
          text_active: '#55afff',
          text_inactive: '#9aa0a6',
        },
        sub: {
          background_on: 'rgba(85,175,255,0.50)',
          background_off: 'rgba(85,175,255,0.35)',
          icon_on: '#55afff',
          icon_off: '#9aa0a6',
        },
        mushroom: { active: '#55afff', inactive: '#9aa0a6' },
        sensor: { sensor_active: '#55afff', sensor_inactive: '#9aa0a6' },
      },
      amber: {
        label: 'Amber',
        room: {
          ...
          background_inactive: 'rgba(255,155,61,0.35)',
          text_active: '#ff9b3d',
          text_inactive: '#9aa0a6',
        },
        sub: {
          background_on: 'rgba(255,155,61,0.50)',
          background_off: 'rgba(255,155,61,0.35)',
          icon_on: '#ff9b3d',
          icon_off: '#9aa0a6',
        },
        mushroom: { active: '#ff9b3d', inactive: '#9aa0a6' },
        sensor: { sensor_active: '#ff9b3d', sensor_inactive: '#9aa0a6' },
      },
      purple: {
        label: 'Purple',
        room: {
          ...
          background_inactive: 'rgba(189,100,255,0.35)',
          text_active: '#bd64ff',
          text_inactive: '#9aa0a6',
        },
        sub: {
          background_on: 'rgba(189,100,255,0.50)',
          background_off: 'rgba(189,100,255,0.35)',
          icon_on: '#bd64ff',
          icon_off: '#9aa0a6',
        },
        mushroom: { active: '#bd64ff', inactive: '#9aa0a6' },
        sensor: { sensor_active: '#bd64ff', sensor_inactive: '#9aa0a6' },
      },
      red: {
        label: 'Red',
        room: {
          ...
          background_inactive: 'rgba(255,92,106,0.35)',
          text_active: '#ff5c6a',
          text_inactive: '#9aa0a6',
        },
        sub: {
          background_on: 'rgba(255,92,106,0.50)',
          background_off: 'rgba(255,92,106,0.35)',
          icon_on: '#ff5c6a',
          icon_off: '#9aa0a6',
        },
        mushroom: { active: '#ff5c6a', inactive: '#9aa0a6' },
        sensor: { sensor_active: '#ff5c6a', sensor_inactive: '#9aa0a6' },
      },
      gray: {
        label: 'Gray',
        room: {
          ...
          background_inactive: 'rgba(197,200,206,0.35)',
          text_active: '#c5c8ce',
          text_inactive: '#9aa0a6',
        },
        sub: {
          background_on: 'rgba(197,200,206,0.50)',
          background_off: 'rgba(197,200,206,0.35)',
          icon_on: '#c5c8ce',
          icon_off: '#9aa0a6',
        },
        mushroom: { active: '#c5c8ce', inactive: '#9aa0a6' },
        sensor: { sensor_active: '#c5c8ce', sensor_inactive: '#9aa0a6' },
      },
      yellow: {
        label: 'Yellow',
        room: {
          ...
          background_inactive: 'rgba(255,214,51,0.35)',
          text_active: '#ffd633',
          text_inactive: '#9aa0a6',
        },
        sub: {
          background_on: 'rgba(255,214,51,0.50)',
          background_off: 'rgba(255,214,51,0.35)',
          icon_on: '#ffd633',
          icon_off: '#9aa0a6',
        },
        mushroom: { active: '#ffd633', inactive: '#9aa0a6' },
        sensor: { sensor_active: '#ffd633', sensor_inactive: '#9aa0a6' },
      },
      teal: {
        label: 'Teal',
        room: {
          ...
          background_inactive: 'rgba(0,191,165,0.35)',
          text_active: '#00bfa5',
          text_inactive: '#9aa0a6',
        },
        sub: {
          background_on: 'rgba(0,191,165,0.50)',
          background_off: 'rgba(0,191,165,0.35)',
          icon_on: '#00bfa5',
          icon_off: '#9aa0a6',
        },
        mushroom: { active: '#00bfa5', inactive: '#9aa0a6' },
        sensor: { sensor_active: '#00bfa5', sensor_inactive: '#9aa0a6' },
      },
    };
  }
  // ─────────────────── STILI ───────────────────
