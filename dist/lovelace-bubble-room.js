        ...
        <div class="grid-container">
          ...
          <div class="icon-area">
            <div class="bubble-icon-container"
              ...
              <ha-icon class="bubble-icon" icon="${n}" style="color: ${a};"></ha-icon>
            </div>
            <div class="mushroom-container">
              ${l.map(((t,e)=>{if(!t)return D``;if(t.sensore_temperatura&&t.sensore_umitidà){const i=o.states[t.sensore_temperatura]?.state||"N/A",n=o.states[t.sensore_umitidà]?.state||"N/A";return D`
                  ...
                  `}{const i="on"===(o.states[t.entity]?.state||"off")?t.icon_color&&t.icon_color.on?t.icon_color.on:"orange":t.icon_color&&t.icon_color.off?t.icon_color.off:"#80808055",n=t.style?t.style:this._defaultMushroomStyle(e);return D`
                    <div class="mushroom-item"
                         style="${n}"
                         @pointerdown="${e=>this._startHold(e,t)}"
                         @pointerup="${e=>this._endHold(e,t,(()=>this._handleMushroomTap(t)))}"
          ...
          <div class="bubble-sub-button-container">
            ${c.map((t=>{if(!t)return D``;const i="on"===(o.states[t.entity]?.state||"off")?e.active:e.inactive;return D`
