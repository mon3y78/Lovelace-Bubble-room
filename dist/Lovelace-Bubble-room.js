      ...
      <div class="card">
        <div class="grid-container">
          ...
          <div class="bubble-sub-button-container">
            ${h.map((t=>{if(!t)return D``;const i="on"===(o.states[t.entity]?.state||"off")?e.active:e.inactive,n=o.states[t.entity]?.attributes?.icon||"",s=t.icon?t.icon:n;return console.log(`Sub-button ${t.entity} - iconToUse:`,s),D`
