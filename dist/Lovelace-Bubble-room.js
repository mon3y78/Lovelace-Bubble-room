      ...
      <div class="card">
        <div class="grid-container">
          ...
          <div class="bubble-sub-button-container">
            ${h.map((t=>{if(!t)return D``;const i="on"===(o.states[t.entity]?.state||"off")?e.active:e.inactive,n=t.entity,s=o.states[n]?.attributes?.icon||"",a=t.icon?t.icon:s;return D`
                <div class="bubble-sub-button"
                    style="background-color: ${i};"
                    @pointerdown="${e=>this._startHold(e,t)}"
                    @pointerup="${e=>this._endHold(e,t,(()=>this._handleSubButtonTap(t)))}"
                    @pointerleave="${t=>this._cancelHold(t)}">
                  <ha-icon key="${n}-${s}" icon="${a}"></ha-icon>
                </div>
              `}))}
