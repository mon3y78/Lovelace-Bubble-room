      ...
      <div class="card">
        <div class="grid-container">
          ...
          <div class="icon-area">
            ...
            <div class="mushroom-container">
              ${h.map(((t,e)=>{if(!t)return L``;if(t.sensore_temperatura&&t.sensore_umitidà){const i=o.states[t.sensore_temperatura]?.state||"N/A",n=o.states[t.sensore_umitidà]?.state||"N/A";return L`
                  ...
                  `}{const i="on"===(o.states[t.entity]?.state||"off")?t.icon_color&&t.icon_color.on?t.icon_color.on:"orange":t.icon_color&&t.icon_color.off?t.icon_color.off:"#80808055",n=o.states[t.entity]?.attributes?.icon,s=t.icon?t.icon:n,a=t.style?t.style:this._defaultMushroomStyle(e);return L`
                    <div class="mushroom-item"
                        style="${a}"
                        @pointerdown="${e=>this._startHold(e,t)}"
                        @pointerup="${e=>this._endHold(e,t,(()=>this._handleMushroomTap(t)))}"
          ...
          <div class="bubble-sub-button-container">
            ${l.map((t=>{if(!t)return L``;const i="on"===(o.states[t.entity]?.state||"off")?e.active:e.inactive,n=o.states[t.entity]?.attributes?.icon,s=t.icon?t.icon:n;return L`
